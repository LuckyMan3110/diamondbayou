...
class Collection extends CI_Controller {
    ...
    function hear_cate_link($c_id=0) {
        ...
        if( !empty($cates3['cate_name']) ) {
            $cate_link .= '<li><a href="'.SITE_URL.'collection/heart_collection_cate/'.$cates3['id'].'">'.$cates3['cate_name'].'</a></li> > ';
        }
        if( !empty($cates2['cate_name']) ) {
            $cate_link .= '<li><a href="'.SITE_URL.'collection/heart_collection_cate/'.$cates2['id'].'">'.$cates2['cate_name'].'</a></li> > ';
        }
        if( !empty($cates1['cate_name']) ) {
            $cate_link .= '<li><a href="'.SITE_URL.'collection/heart_collection_cate/'.$cates1['id'].'">'.$cates1['cate_name'].'</a></li>';
        }
    ...
    function get_cate_list($gender='M') {
        ...
        foreach($men_cate as $rowmen) {
            ...
            if( !empty($cate_name) ) {
                $collection_cate .= '<li><a href="'.SITE_URL.'collection/collection-listing/'.$rowmen['category'].'/">'.$cate_name.'</a>';
            ...
            if( count($get_subcate) > 0 ) {
                ...
                foreach( $get_subcate as $rowm_scate ) {
                    ...
                    $collection_cate .= '<li><a href="'.SITE_URL.'collection/collection-listing/'.$rowm_scate['subcategory'].'/">'.$scate_name.'</a>';
                }
                $collection_cate .= '</ul>';
            }
            $collection_cate .= '</li>';        
    ...
    function get_watch_list($gender='M') {
        $watch_cate         = $this->Davidsternmodel->get_watch_category( $gender ); // print_ar($watch_cate); exit();
        $collection_cate    = '';
        foreach($watch_cate as $watch) {
            $watch_brand = base64_encode($watch['brand']); 
            $collection_cate .= '<li><a href="'.SITE_URL.'collection/watch-collection-listing/'.$watch_brand.'/"> '.$watch['brand'].' </a></li>';
    ...
    function get_collection_cate() {
        $collection_cate = '<ul>
			<li><i>Filter By:</i></li>';
			$main_listing_category   = $this->Davidsternmodel->get_main_listing_category();  
			foreach ($main_listing_category as $value) {
				if($value['gender'] == 'F'){
				$main_cat_name = 'Women';
				}else if($value['gender'] == 'M'){
				$main_cat_name = 'Men';
				}else if($value['gender'] == 'U'){
				$main_cat_name = 'Unisex';
				}else if($value['gender'] == 'C'){
				$main_cat_name = 'Children';
				}else if($value['gender'] == 'E'){
				$main_cat_name = 'Estate';
				}else if($value['gender'] == 'D'){
				$main_cat_name = 'Designers';
				}else if($value['gender'] == 'R'){
				$main_cat_name = 'Religious';
				}else if($value['gender'] == 'CH'){
				$main_cat_name = 'Charms';
				}else if($value['gender'] == 'CL'){
				$main_cat_name = 'Clearance';
				}else if($value['gender'] == 'S'){
				$main_cat_name = 'Services';
				}else if($value['gender'] == 'CG'){
				$main_cat_name = 'Colored Gemstones';
				}
			}
			$get_all_cats = array(740520120, 740520129, 740520271, 740520211, 740520259, 740520272);  
			foreach($get_all_cats as $get_all_cats_val){ 
				...
				foreach($dev_ring_cat_data as $ring_cat_data){
                    ...
                    if($id == 740520120 OR $id == 740520121 OR $id == 740520122 OR $id == 740520123 OR $id == 740520124 OR $id == 740520125 OR $id == 740520126 OR $id == 740520127 OR $id == 740520128){
                        $ring_cat_list .= '<li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/'.$ring_cat_data->category_id .'/"> '.$ring_cat_data->category_name.' </a></li>';
                    }else{
                        $ring_cat_list .= '<li><a href="'.SITE_URL.'collection/collection-listing/'.$ring_cat_data->category_id .'/"> '.$ring_cat_data->category_name.' </a></li>';
                    }    
                    
                }
            }
            
            if($get_all_cats_val == 740520120){
                $collection_cate .= '
                  <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/'.$get_all_cats_val.'">'.$dev_main_cat_data['0']->category_name.'</a>
                    <ul>
                      '.$ring_cat_list.'
                    </ul>
                  </li>'; 
                ...
                $collection_cate .= '
                  <li><a href="'.SITE_URL.'collection/collection-listing/'.$get_all_cats_val.'">'.$dev_main_cat_data['0']->category_name.'</a>
                    <ul>
                      '.$ring_cat_list.'
                    </ul>
                  </li>'; 
            ...
            //collection-engagement-rings-listing
        }
        

       /* $collection_cate .= '
                  <li><a href="'.SITE_URL.'collection/watch-collection-listing/R3VjY2k=/">Watches</a>
                    <ul>
                      '.$this->get_watch_list('F').'
                    </ul>
                  </li>';  */   
        ...
        $collection_cate .= '
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520121&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Round</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520122&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Oval</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520123&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Emeraid</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520124&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Princess</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520125&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Pear</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520126&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Marquise</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520127&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Blank</a></li>
                    <li><a href="'.SITE_URL.'collection/collection-engagement-rings-listing/740520120?style=740520128&metal_type=&quality=&carat_item=&engagement_rings_filter_submit=Submit+Query">Others</a></li>
...
';
        ...
        if( $data['ring_categoies'] != 'false' ) {
            $output = $this->load->view('engagementringstrial/heart_collectoin_rings_cate' , $data , true);
            $this->output($output, $data);
        } else {
            header('Location:' . SITE_URL . 'collection/ringlisting/' . $cates_id);
        }
    }
	...
	$data['cate_links'] = $this->hear_cate_link($category_id);
        ...
        $base_link = SITE_URL.'collection/ringlisting/'.$category_id.'/?sort='.$sort_option;
	$config["base_url"]   = $base_link.'&pagelist='.$config["per_page"];
        ...
        $sort_option_link = SITE_URL . 'collection/ringlisting/'.$category_id.'/?pagelist='.$config["per_page"].'&per_page='.$startFrom.'&sort=';
        ...
        $output = $this->load->view('engagementringstrial/heart_rings_listing_view' , $data , true);
        $this->output($output, $data);
    }
    ...
    function heart_bread_links($cid=0, $main='') {
        ...
        if( $cid > 0 ) {            
            ...
            if( empty($main) ) {
                $cate_link = ' > <li><a href="'.SITE_URL.'collection/collection-listing/'.$cid.'">'.$cate_name.'</a></li>';
            } else {
	...
	$data['content_title'] = check_empty($row_content['description'], 'Coming Soon'); 
        ...
        $data['meta_tags'] = '<meta name="description" content="site map">';
    ...
    function collection() {
        ...
        //$this->load->library('pagination');
	    $data['title'] = 'The Collection';
    	$data['collection_cate_links'] = $this->get_collection_cate();
    	
    	$data_get_jewelry_new_count     = $this->Davidsternmodel->get_jewelry_new_count('3292598018', 0, 100000, 6); 
        $data['get_jewelry_new_count']  = count($data_get_jewelry_new_count['results']);
        
        if( isset($_GET['limit']) AND isset($_GET['offset']) ){
           $data['rings_listing_3'] = $this->heart_diamond_collection_list( '', $_GET['offset'], $_GET['limit'], 6 );     
        }else{
           $data['rings_listing_3'] = $this->heart_diamond_collection_list( '', 0, 50, 6 ); 
        }
        
           //// rings  Note: 4th-parameter tells the col-sm-6, etc
        $data['rings_listing_5'] = $this->heart_diamond_collection_list( 3292598018, 3, 9, 6 );   //// rings
        $data['necklaces_6_listing'] = $this->heart_diamond_collection_list( 740520028, 0, 3, 6, 'necklace' );  /// rings bands
        $data['necklaces_5_listing'] = $this->heart_diamond_collection_list( 740520028, 3, 9, 6, 'necklace' );   //// rings bands
        $data['bracelet_6_listing'] = $this->heart_diamond_collection_list( 3292607018, 0, 3, 6 );        /// wedding bands
        $data['bracelet_5_listing'] = $this->heart_diamond_collection_list( 3292607018, 3, 9, 6 );       /// wedding bands
        $data['earings_6_listing'] = $this->heart_diamond_collection_list( 3292601018, 0, 3, 6 );  // earings
        $data['earings_5_listing'] = $this->heart_diamond_collection_list( 3292601018, 3, 9, 6 );  // earings
...
';
        ...
        $output = $this->load->view('engagementringstrial/heartdiamond_collection' , $data , true);
        $this->output($output, $data);
    }
    ...
    function heart_diamond_main_listing($start=0, $limit=4, $cols=2) {
        ...
        if( count($results['results']) > 0 ) {
            foreach( $results['results'] as $rowrings ) {
                $ringDetail = SITE_URL . 'collection/jewelry_ring_detail/' . $rowrings['id'];
    ...
    function collection_sort_options($id=0, $sort_value='') {
        ...
        $option_link = SITE_URL.'collection/collection-listing/'.$id.'/?sort_value=';
        $view_sort_option = '';
    ...
    function heart_page_title($cate_id=0) {
        switch ($cate_id) {
            case 'newarrivals' :
        ...
        $row_cate = $this->Davidsternmodel->getEbayCateRow( $cate_id );
        
        if( !empty($page_title) ) {
            $pageTitle = $page_title;
        } else {
            $pageTitle = $row_cate['category_name'];
        }
        //echo $pageTitle; exit;
        return $pageTitle;
    }
    ...
    ///// stern collection page
    function collection_engagement_rings_listing($id='', $recent='') {
        
        $data = $this->getCommonData();
        $this->session->unset_userdata('center_stone');
        //$this->load->library('pagination');
        $data['collection_cate_id'] = $id;
        $data['analytic_code'] = ''; // this variable is define in site.php file
        $data['collection_cate_links'] = $this->get_collection_cate();
        $rowcate = $this->Davidsternmodel->getEbayCateRow( $id );
        //echo '<pre>'; print_r($rowcate); exit();
        ...
        $base_link = SITE_URL.'collection/collection-engagement-rings-listing/'.$id.'/?sort_value='.$sort_field;
	    $config["base_url"]   = $base_link.'&pagelist='.$config["per_page"];
        $config['num_tag_open'] = '<li>';
        $config['num_tag_close'] = '</li>';
        $config['cur_tag_open'] = '<li><a class="active" href="#">';
        ...
        if( isset($_GET['metal_type']) ){ $metal_type = $_GET['metal_type']; }
        if( isset($_GET['quality']) ){ $quality = $_GET['quality']; }
        if( isset($_GET['carat_item']) ){ $carat_item = $_GET['carat_item']; }
    
        $rowrings = $this->Davidsternmodel->get_jewelry_categorywise_360_item_list( $id, $start_from, $config["per_page"], $necklace, '', $sort_field, $recent, $style, $metal_type, $quality, $carat_item );
        
        //echo '<pre>'; print_r($rowrings); exit();
        $data['total_rows'] = $rowrings['total'];
        $config["total_rows"] = $data['total_rows'];
        $data['title'] = $this->heart_page_title( $id );
        ...
        $data['extraheader'] = '<link type="text/css" href="'.SITE_URL.'css/heart_filters_style.css" rel="stylesheet" />';
        $data['extraheader'] .= '<script src="'.SITE_URL.'js/heart_filters_script.js" type="text/javascript"></script>';
        ...
        if( !empty($rowcate['meta_description']) ) {
            $data['meta_tags'] = '<meta name="description" content="'.$rowcate['meta_description'].'">';
        } else {
            $data['meta_tags'] = '<meta name="description" content="Offers Loose Diamonds,Design Your Own Ring,Ideal Scope, Loose Diamond, Engagement Rings, Cheap Diamonds, Customize Rings,Diamond Tutorial, Diamond rings, Cheap Diamonds, Ideal Scope, Diamond district, Diamond Rings, Wholesale Diamonds, Estate Jewelry, Custom Engagement Rings">';
        } 
        
        $data['show_footer_to_bar']        = 1;
        $data['top_inner_banner']          = 'images/collection_img/inner-page-banner1.png';
        $data['top_inner_banner_content']  = '            
        								   <h5>360 Engagement Rings</h5>     
        								   <p>Celebrate forever with a stunning diamond eternity band or anniversary ring.</p>
        								  ';
        
        $output = $this->load->view('engagementringstrial/heartdiamond_collection_listing_360_ring' , $data , true);
        
        $this->output($output, $data);
    }
    
    
     function getIndexDiamondList360Rign($subcategory='', $metal_type='', $quality='', $center_stone_sizes='') {
        $diamond_rows = $this->get_item_index_diamond_lists_360_ring($subcategory, $metal_type, $quality, $center_stone_sizes);
        $page_limit = 500;
        $total_pages = round( $diamond_rows['total'] / $page_limit );
        
        $page_links = '<div><ul class="diamond_page_list">';
        $p = 0;
            for($i=1; $i <= $total_pages; $i++) {
                    $start_from = $page_limit * $p;
                    $starts_from = ( $i > 1 ? ( $start_from + 1 ) : 0 );
                    $load_diamond = 'setHDIndexDiamondList(\''.$ring_id.'\', \''.$shape.'\', \''.$ringColor.'\', \''.$item_metal.'\', \''.$starts_from.'\')';
                    $page_links .= '<li><a href="#javascript" onclick="'.$load_diamond.'">'.$i.'</a></li>';
                $p++;
            }        
        $page_links .= '</ul></div>';
        
        $diamond_list = '<div class="center_stonelist">
                <table class="unique_diamond_table">
                    <tbody>
                    <tr>
                        <th>Shape</th>
                        <th>Carat</th>
        ...
        //$page_links_set = ( $diamond_rows['total'] > $page_limit ? $page_links : '' );
        echo $diamond_list;
        
    }
    
    function get_item_index_diamond_lists_360_ring($subcategory='', $metal_type='', $quality='', $center_stone_sizes=''){
        
        $get_dev_index_info = $this->Davidsternmodel->get_jewelry_categorywise_360_item_list_diamond_finder($subcategory, $metal_type, $quality, $center_stone_sizes );
        
        //print_ar($get_dev_index_info);
        
        $check_show_data = 0;
        if( count($get_dev_index_info['results']) > 0 ) {
            foreach( $get_dev_index_info['results'] as $rows ) {
                
                $where_dev_ebaycategories_cat2    = array('category_id' => $rows['subcategory']);
                $dev_ebaycategories_data2         = $this->Catemodel->getdata_any_table_where($where_dev_ebaycategories_cat2, 'dev_ebaycategories');
                
                $ebay_price     = $rows['ring_price'];// * 1.10;
                $detail_link    = SITE_URL . 'collection/collection-detail/'.$rows['stock_number'].'/';
                $diamond_list .= '<tr>
                            <td>'.$dev_ebaycategories_data2[0]->category_name.'</td>
                            <td>'.$rows['center_stone_sizes'].'</td>
                            <td>'.$rows['metal_type'].'</td>
                            <td>'.$rows['quality'].'</td>
                            <td>$'._nf($ebay_price, 2).'</td>
                            <td><a href="'.$detail_link.'"><img src="'.SITE_URL.'img/david_home/diamond_search/view_detail.jpg" alt="Details"></a></td>
                        </tr>';
                        $check_show_data++;
            }
        }
        
        if($check_show_data == 0){
            
            $diamond_list = '<tr>
                                <td colspan="6">Diamond Not Found! Search Again.</td>
                            </tr>';
        }
        
        $returns['diamond_rows'] = $diamond_list;
        $returns['total']        = count($get_dev_index_info);
    ...
    ///// stern collection page
    function collection_listing($id='', $recent='') {
        $data = $this->getCommonData();
        $this->session->unset_userdata('center_stone');
        //$this->load->library('pagination');
        $data['collection_cate_id'] = $id;
        ...
        //$config["total_rows"] = 272;
        $base_link = SITE_URL.'collection/collection-listing/'.$id.'/?sort_value='.$sort_field;
	    $config["base_url"]   = $base_link.'&pagelist='.$config["per_page"];
        $config['num_tag_open'] = '<li>';
        $config['num_tag_close'] = '</li>';
        $config['cur_tag_open'] = '<li><a class="active" href="#">';
        ...
        $rowrings = $this->Davidsternmodel->get_jewelry_categorywise_list( $id, $start_from, $config["per_page"], $necklace, '', $sort_field, $recent );
        ...
        if($id == 740520120 OR $id == 740520121 OR $id == 740520122 OR $id == 740520123 OR $id == 740520124 OR $id == 740520125 OR $id == 740520126 OR $id == 740520127 OR $id == 740520128){
            ...
            $output = $this->load->view('engagementringstrial/heartdiamond_collection_listing' , $data , true);
        }
    ...
    ///// stern collection page
    function watch_collection_listing($id='', $recent='') {
        
        $data = $this->getCommonData();
        $this->session->unset_userdata('center_stone');
        //$this->load->library('pagination');
	    $data['title'] = 'The Watches Collection';
    	$data['collection_cate_links'] = $this->get_collection_cate();
    	
    	//$data_get_jewelry_new_count     = $this->Davidsternmodel->get_jewelry_new_watch_count($id, 0, 100000, 6); 
        //$data['get_jewelry_new_count']  = count($data_get_jewelry_new_count['results']);
        
        if( isset($_GET['limit']) AND isset($_GET['offset']) ){
           $data['rings_listing_3'] = $this->watch_collection_list( $id, $_GET['offset'], $_GET['limit'], 6 );     
        }else{
           $data['rings_listing_3'] = $this->watch_collection_list( $id, 0, 50, 6 ); 
           //print_ar($data['rings_listing_3']); exit();
        }
        ...
        $output = $this->load->view('engagementringstrial/heartdiamond_watches_collection' , $data , true);
        $this->output($output, $data);
    }
    ...
    function get_metal_color_link($ring_style, $metal='', $carat='') {
        ...
        if( $id > 0 ) {
            $collection_link = SITE_URL . 'collection/collection-detail/'.$id;
        } else {
            $collection_link = '#';
        }
...
//                );
	...
	/* stern collection detail page product detail page :: old product detail page */
    function heart_collection_detail($product_id=0, $metals_type='') {
        $data = $this->getCommonData(); 
        ...
        $metals_link = SITE_URL . 'collection/collection-detail/'.$product_id.'/';
        ...
        $output = $this->load->view('engagementringstrial/collection_detail_viewnew' , $data , true);
        $this->output($output, $data);
    }

    function collection_men_detail($product_id=0, $metals_type=''){
		redirect(base_url(), 'refresh');
		exit;
		$data['title'] = 'Men Diamond Detail';
		$data['rowsring'] = $this->Davidsternmodel->getmenCollectionDetail($product_id,'itshot_products'); 
		if(empty($data['rowsring'])){
		}
		$all_lists = $this->Davidsternmodel->getmen_more($product_id,'itshot_products');
		$listing = '';
		if(!empty($all_lists)){
			foreach($all_lists as $rows){
				$detaiLink = base_url().'collection/collection_men_detail/'.$rows['id'];
				$listing .=  '<div class="col-sm-3 set_bk_height" onmouseover="show_collection_block(\''.$rows['product_sku'].'\')" onmouseout="hide_block(\''.$rows['product_sku'].'\')">'
                        . '<div><div class="item_lable_style"><a href="'.$detaiLink.'">
                           <div class="set_thumb_img similar_collection" id="thumb_'.$rows['product_sku'].'"><img src="'.$rows['product_main_img'].'" alt="Diamond Image" style="margin-left: 15px;border: solid 1px #cccccc;margin-right: 15px;" />
                            </div>'.$rows['product_name'].'
                            </a></div><div>'.$rows['product_price_off'].'</div></div>
							<div class="addtocart_icon"><a href="#javascript" onClick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rows['id'].'\')">Add to Cart</a></div>
                        </div>';
			}
		...
		$output = $this->load->view('engagementringstrial/men_detail_view' , $data , true);
        $this->output($output, $data);
	}

	function collection_watch_detail($product_id=0, $metals_type=''){
		redirect(base_url(), 'refresh');
		exit;
		$data['title'] = 'Watch Diamond Detail';
		$data['rowsring'] = $this->Davidsternmodel->getmenCollectionDetail($product_id,'mall_elady_products'); 
		if(empty($data['rowsring'])){
		}
		$all_lists = $this->Davidsternmodel->getmen_more($product_id,'mall_elady_products');
		$listing = '';
		if(!empty($all_lists)){
			foreach($all_lists as $rows){
				$detaiLink = base_url().'collection/collection_watch_detail/'.$rows['id'];
				$listing .=  '<div class="col-sm-3 set_bk_height" onmouseover="show_collection_block(\''.$rows['sku'].'\')" onmouseout="hide_block(\''.$rows['sku'].'\')">'
                        . '<div><div class="item_lable_style"><a href="'.$detaiLink.'">
                           <div class="set_thumb_img similar_collection" id="thumb_'.$rows['sku'].'"><img src="'.$rows['product_main_img'].'" alt="Diamond Image" style="margin-left: 15px;border: solid 1px #cccccc;margin-right: 15px;" />
                            </div>'.$rows['product_name'].'
                            </a></div><div>'.$rows['product_price'].'</div></div>
							<div class="addtocart_icon"><a href="#javascript" onClick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rows['id'].'\')">Add to Cart</a></div>
                        </div>';
			}
			$data['listings']  = $listing;
        ...
        $data['extraheader'] .= '<link href="'.SITE_URL.'collection_detail/heart_collection_detail_1.css" rel="stylesheet" />';
        $data['extraheader'] .= '<link href="'.SITE_URL.'collection_detail/heart_collection_detail_2.css" rel="stylesheet" />';
		$output = $this->load->view('engagementringstrial/watch_detail_view' , $data , true);
        $this->output($output, $data);
	}

	function collection_bag_detail($product_id=0, $metals_type=''){
		redirect(base_url(), 'refresh');
		exit;
		$data['title'] = 'Bag Diamond Detail';
		$data['rowsring'] = $this->Davidsternmodel->getmenCollectionDetail($product_id,'mall_elady_products'); 
		if(empty($data['rowsring'])){
		}
		$all_lists = $this->Davidsternmodel->getmen_more($product_id,'mall_elady_products');
	...
	function collection_women_detail($product_id=0, $metals_type=''){
		//redirect(base_url(), 'refresh');
	//	exit;
		$data['title'] = 'Women Diamond Detail';
		$data['rowsring'] = $this->Davidsternmodel->getmenCollectionDetail($product_id,'jewelry_unlimited_products'); 
		if(empty($data['rowsring'])){
		}
		$all_lists = $this->Davidsternmodel->getmen_more($product_id,'jewelry_unlimited_products');
		$listing = '';
		if(!empty($all_lists)){
			foreach($all_lists as $rows){
				$detaiLink = base_url().'collection/collection_women_detail/'.$rows['id'];
				$listing .=  '<div class="col-sm-3 set_bk_height" onmouseover="show_collection_block(\''.$rows['product_sku'].'\')" onmouseout="hide_block(\''.$rows['product_sku'].'\')">'
                        . '<div><div class="item_lable_style"><a href="'.$detaiLink.'">
                           <div class="set_thumb_img similar_collection" id="thumb_'.$rows['product_sku'].'"><img src="'.$rows['product_main_img'].'" alt="Diamond Image" style="margin-left: 15px;border: solid 1px #cccccc;margin-right: 15px;" />
                            </div>'.$rows['product_name'].'
                            </a></div></div>
							<div class="priceLable">$'.$rows['product_price'].'</div>
							<div class="addtocart_icon"><a href="#javascript" onClick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rows['id'].'\')">Add to Cart</a></div>
                        </div>';
			}
			$data['listings']  = $listing;
        ...
        $data['extraheader'] .= '<link href="'.SITE_URL.'collection_detail/heart_collection_detail_1.css" rel="stylesheet" />';
        $data['extraheader'] .= '<link href="'.SITE_URL.'collection_detail/heart_collection_detail_2.css" rel="stylesheet" />';
		$output = $this->load->view('engagementringstrial/women_detail_view' , $data , true);
        $this->output($output, $data);
	}
    ...
    function collection_detail($product_id=0, $metals_type='') {
        ...
        if( isset($_GET['style']) AND isset($_GET['metal_type']) AND isset($_GET['quality']) AND isset($_GET['carat_item']) AND isset($_GET['ring_size']) ){ 
            ...
            $get_avail_size = '';
            $rowsring_items = $this->Davidsternmodel->getSternCollectionDetail360Item($_GET['style'], $_GET['metal_type'], $get_quality, $get_carat_item, $get_ring_size, $get_gender, $get_diamond_size, $get_chain_weight, $get_avail_size);
            $product_new_id = $rowsring_items['stock_number'];
            if($product_new_id){
                $rowsring = $this->Davidsternmodel->getSternCollectionDetail($product_new_id);
            }else{
                $rowsring = $this->Davidsternmodel->getSternCollectionDetail($product_id);
            }
        }   
        ...
        $get_carat_item         = $rowsring['center_stone_sizes'];
        $get_quality            = $rowsring['quality'];
        $resultForMetal         = $this->Davidsternmodel->getSternDistinctCollectionDetail360Item($subcategory, $get_carat_item, $get_quality,  $rowsring['gender'], $rowsring['diamond_size'], $rowsring['chain_weight'], $rowsring['ring_size']);
       ...
       // $data['popular_listings']	= $this->collectionSimilarLististing($rowsring['category'], $product_id, 4, 'popular');
        ...
        /* if($id == 740520120 OR $id == 740520121 OR $id == 740520122 OR $id == 740520123 OR $id == 740520124 OR $id == 740520125 OR $id == 740520126 OR $id == 740520127 OR $id == 740520128){
            ...
            $ring_size       = '';
            if( isset($_GET['style']) ){
                $style_item = $_GET['style'];
            }
            if( isset($_GET['metal_type']) ){
                $metal_type_item = $_GET['metal_type'];
            }
            if( isset($_GET['quality']) ){
                $quality_item = $_GET['quality'];
            }
            if( isset($_GET['ring_size']) ){
                $ring_size = $_GET['ring_size'];
            }
            $data['more_collection_listings_new'] = $this->heart_diamond_collection_similler_list_360_items( $rowsring['category'], $rowsring['subcategory'], 0, 8, 6, $type='', $style_item, $metal_type_item, $quality_item, $ring_size ); 
        }else{ */
            $data['more_collection_listings_new'] = $this->heart_diamond_collection_similler_list( $rowsring['category'], $rowsring['subcategory'], 0, 8, 6 ); 
        //} 
		...
		if($rowsring['is_oneil'] == 1){
			$output = $this->load->view('engagementringstrial/oneil_collections_detail_view' , $data , true);
		}else{
			$output = $this->load->view('engagementringstrial/heart_collections_detail_view' , $data , true);
		}
        $this->output($output, $data);
    ...
    function heart_diamond_collection_similler_list_360_items($cid=0, $subcid=0,  $start=0, $limit=4, $cols=2, $type='', $style_item, $metal_type_item, $quality_item, $ring_size ) {
        $rowrings = $this->Davidsternmodel->get_jewelry_new_similler_list_360_items( $cid,$subcid, $start, $limit, $type, '', '', '', $style_item, $metal_type_item, $quality_item, $ring_size );
			...
			foreach( $rowrings['results'] as $rows ) {
				...
				if($rows['is_carol'] == 1){
					...
					if( file_exists(str_replace("THUMBNAIL/","",$rows['image1'])) ) {
						$ringImages   = SITE_URL .str_replace("THUMBNAIL/","",$rows['image1']);
					} else {
						$ringImages   = SITE_URL .str_replace("THUMBNAIL/","",$rows['image2']);
					}
					if (strpos($ringImages, '.jpg') !== false) {
						$ringImage   = $ringImages;
					}else{
    ...
    //// new product detail page
    function watch_collection_detail($product_id=0, $metals_type='') {
        $data = $this->getCommonData(); 
        ...
        $rowsring = $this->Davidsternmodel->getWatchCollectionDetail($product_id); //print_ar($rowsring); exit();
        $data['watch_data'] = $rowsring;
        $jew_metal = set_jew_metal($rowsring['metal'], $rowsring['carat']);
        $metal_type = ( empty($metals_type) ? $jew_metal : $metals_type );
        $priceField = $this->get_price_field($metal_type);
        ...
        $data['global_fields'] = $this->get_global_fields( $globalFields );
        $data['category_name'] = $rowsring['brand'];
        $categoryID = ( !empty($rowsring['subcategory']) ? $rowsring['subcategory'] : $rowsring['brand'] );
        $data['bread_crumb_link'] = $this->heart_bread_crumb_links($categoryID);
        $data['comp_jew_title'] = $rowsring['brand'];
        $metals_link = SITE_URL . 'collection/collection-detail/'.$product_id.'/';
        $data['metal_type_options'] = $this->get_metal_type($metals_link, $metal_type);
        //$data['comp_jew_title'] = $this->complete_jewelry_title($rowsring['category'], $cateTitle);
        $rowsring['price'] = $rowsring['price1'];
        
        $data['rowsring'] = $rowsring;
        $data['heart_title'] = $rowsring['productName'];
        $data['sales_price'] = $rowsring['price1'];
        $data['retail_price'] = $data['sales_price'] * PRICE_PERCENT;
        $data['saving_percent'] = ( 100 - ( ( $data['sales_price'] / $data['retail_price'] ) * 100 ) );
        $data['buynow_link'] = htmlspecialchars(SITE_URL.'jewelleries/addtoshoppingcart/');
        $data['item_desc'] = get_site_title().' Jewelry can be yours for $'._nf($rowsring['price1'], 2).'.';
        $data['our_price'] = ( $rowsring['price1'] > 0 ? '$'._nf($rowsring['price1'], 2) : 'Please Call ' . CONTACT_NO . ' for price' );
        
        //$cate = $this->getCateName( $rowsring['catid'] );  
        $ringBoxDesc = $data['brand'];
        $data['ringtitle'] = $ringBoxDesc. ' Item ID: '. $rowsring['stock_real_number'];
        $data['ringimg']   = SITE_URL.$rowsring['thumb'];
        ...
        $data['more_collection_listings'] = $this->watch_collection_list( $watch_brand, 0, 9, 6 );
        //$this->collectionWatchSimilarLististing($rowsring['brand'], $product_id, 4, 'collection');
        //print_ar($data['more_collection_listings']); exit();
        ////// get user comments
	    $data['view_coments'] = $this->getProductReviews( $product_id );
	    $data['finished_level'] = $this->finishlevel( $product_id, 'gold', 'options' );
        $data['rings_allowed_id'] = array(3292598018);
        ...
        $data['prod_thumbs'] = $this->heart_watch_collection_images( $rowsring, $data['heart_title'], 'detail' );
        
        $data['product_thumbs'] = $data['prod_thumbs']['thumbs'];
        
        $data['rings_thumb'] = $this->getWatchProductThumb( $rowsring );
        $center_stone = $this->collection_diamond_options();
        $data['recently_purchased'] = $this->recently_purchased_product($rowsring['category']);
        $data['stone_count'] = $center_stone['diamond_count'];
        $data['collections_cate'] = $this->Catemodel->getCollectionCateName( $rowsring['category'] );
        ...
        $data['title'] = $rowsring['productName'];
        
        //$output = $this->load->view('engagementringstrial/collection_detail_view' , $data , true);
        $output = $this->load->view('engagementringstrial/watch_collections_detail_view' , $data , true);
        $this->output($output, $data);
    }
	...
	$data['addtoring_link'] = htmlspecialchars(SITE_URL.'engagement/complete_youring/'.$d_id.'/'.$product_id.'/addtoring/');
        ...
        $output = $this->load->view('engagementringstrial/heart_collection_rings_detial' , $data , true);
        $this->output($output, $data);
    }
    ...
    function heart_collection_viewtype_listing($cid=0, $start=0, $limit=4, $cols=2, $type='', $sroting='') {
        ...
        if( count($rowrings['results']) > 0 ) {
            foreach( $rowrings['results'] as $rows ) {
               ...
               $detaiLink = SITE_URL.'collection/collection-detail/'.$rows['stock_number'];
               $popupLink = SITE_URL . 'collection/heart_collection_popup_detail/'.$rows['stock_number'] . '/?keepThis=true&TB_iframe=false&width=900&height=550&modal=true';
               $thumbs = $this->heart_collection_images($rows, ''.SITES_NAME.'');
               ...
               $ring_listing .= '<div class="heart_list_viewbk">
                    ...
                    <div class="col-sm-7 pull-right heart_content_section">
                        ...
                        <div>'. $rows['item_title'].' '.SITES_NAME.'</div><br><br>
                        <div class="col-sm-4 list_view_price">'.$ringPrice.'</div>
                        <div class="col-sm-4 pull-right add_tocart_icon"><a href="#javascript" onclick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rows['stock_number'].'\')">Add to Cart</a></div>
                    </div>
                    <div class="clear"></div>
                </div>';               
               $i++;               
    ...
    function heart_collection_newarrivals_listing( $rowrings=array() ) {
        ...
        if( count($rowrings) > 0 ) {
            foreach( $rowrings as $rows ) {
               ...
               $retailPrice = $ringPrice * PRICE_PERCENT;
               $detaiLink = SITE_URL.'collection/collection-detail/'.$rows['stock_number'];
               $popupLink = SITE_URL . 'collection/heart_collection_popup_detail/'.$rows['stock_number'] . '/?keepThis=true&TB_iframe=false&width=900&height=550&modal=true';
               $ringTitle = $rows['item_title']; //$this->get_heart_title( $rows );
               $rid = $rows['stock_number'];
               $popup_block .= $this->heart_collection_popup_detail($rows['stock_number']);
               $thumbs = $this->heart_collection_images($rows, ''.SITES_NAME.'');          
               $ringImage = $this->set_collection_img($rows['image1'], $rows['item_sku'], $rows['different_imglist']);
               
               $ring_listing .= '<li class="item">'
                       . '<div class="set_bk_height product-grid-quick" onmouseover="show_collection_block(\''.$rows['stock_number'].'\'); showQuickView('.$rows['stock_number'].')" onmouseout="hide_block(\''.$rows['stock_number'].'\'); hideQuickView('.$rows['stock_number'].')">'
                        . '<div><a href="'.$detaiLink.'">
                           <div class="set_thumb_img similar_collection" id="thumb_'.$rows['stock_number'].'">
                               '.$thumbs['thumbs'].'
                            </div>
    ...
    <div class="popup-prices">';
            if( $ringPrice > 0 ) {
               $ring_listing .='<p class="old-price-qv">
                <span class="price-label-qv">Retail Price:</span>
                <span class="new-price-qv set_retail_price" id="product-price-'.$rid.'">
                    $' . _nf($retailPrice, 2) . ' </span>
			  </p>';
            }
     ...
     <li>';
               ...
               $collection_listing_view .= '<div class="heart_list_viewbk" onmouseover="show_collection_block(\''.$rows['stock_number'].'\')" onmouseout="hide_block(\''.$rows['stock_number'].'\')">
                    <div class="col-sm-4 heart_img_view">
                        <div><a href="'.$detaiLink.'">
                           <div class="set_thumb_img similar_collection" id="thumb_'.$rows['stock_number'].'">
                            <img src="'.SITE_URL.'images/'.$rows['image1'].'" width="150" height="125" class="" alt="'.SITES_NAME.'" />
                            </div>
                            </a></div>
                    </div>
                    <div class="col-sm-7 pull-right heart_content_section">
        ...
        $collection_listing_view .= '<div class="col-sm-4 pull-right add_tocart_icon"><a href="#javascript" onclick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rows['stock_number'].'\')">Add to Cart</a></div>
                    </div>
                    <div class="clear"></div>
                </div>';
    ...
    //// Hearts and Arrows Collection jewelry rings
    //$this->heart_diamond_collection_list( 3292598018, 3, 9, 6 ); 
    
    function heart_diamond_collection_list($cid=0, $start=0, $limit=4, $cols=2, $type='') {
        $rowrings = $this->Davidsternmodel->get_jewelry_new_list( $cid, $start, $limit, $type );
    ...
    //// Hearts and Arrows Collection jewelry rings
    //$this->heart_diamond_collection_list( 3292598018, 3, 9, 6 ); 
    function watch_collection_list($cid=0, $start=0, $limit=4, $cols=2, $type='') {
        $rowrings = $this->Davidsternmodel->get_jewelry_new_watch( $cid, $start, $limit, $type );
        ...
        if( count($rowrings['results']) > 0 ) {
            ...
            foreach( $rowrings['results'] as $rows ) {
                ...
                // '<pre>'; print_r($rows); exit();
                
               $ring_price = ( $rows['price1'] > 0 ? $rows['price1'] : $rows['ring_price'] );
               
               $ringPrice = ( $ring_price > 0 ? $ring_price : 'Please Call '.CONTACT_NO.' for price' );
               $detaiLink = SITE_URL.'collection/watch-collection-detail/'.$rows['productID'];
               $popupLink = SITE_URL . 'collection/heart_collection_popup_detail/'.$rows['productID'] . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
               
               $thumbs = $this->heart_watch_collection_images($rows, SITES_NAME);
               
               $popup_block .= $this->watch_collection_popup_detail($rows['productID']);
               
               $ringImage = $this->set_collection_img($rows['image1'], $rows['item_sku'], $rows['different_imglist']);
               
               $ring_listing .= '<div class="'.$block_cols.' set_bk_height" onmouseover="show_collection_block(\''.$rows['productID'].'\'); showQuickViewWatches(\''.$rows['productID'].'\')" onmouseout="hide_block(\''.$rows['productID'].'\'); hideQuickView(\''.$rows['productID'].'\')">'
                        . '<div><a href="'.$detaiLink.'">
                            <!-- <img src="'.$ringImage.'" alt="" />-->
                           <div class="set_thumb_img similar_collection" id="thumb_'.$rows['productID'].'">
                            ' . $thumbs['thumbs'] . '
                            </div>
                            </a></div>
                           ' . $this->collection_watch_hover_block($rows, $ringPrice, $ringImage, $popupLink, $thumbs['total']) . '
                           
                           
                        <div class="box-detail-over " id="box-detail-over-'.$rows['productID'].'" style="display: none;">
                            <div class="column3">
                            ...
                            <div class="popup-prices">';
                                if( $ringPrice > 0 ) {
                                   $ring_listing .='<p class="old-price-qv">
                                    <span class="price-label-qv">Retail Price:</span>
                                    <span class="new-price-qv set_retail_price" id="product-price-'.$rows['productID'].'">
                                        $' . _nf($ringPrice, 2) . ' </span>
                    			  </p>';
                                }
                                
                                    $ring_listing .= '<p class="old-price-qv">
                                    <span class="price-label-qv">Our Price:</span>
                                    <span class="new-price-qv" id="product-price-'.$rows['productID'].'">
                                        ' . $ringPrice . ' </span>
                    			  </p>
                    			  
                    			  <p class="old-price-qv">
                                    <span class="price-label-qv">Brand:</span>
                                    <span class="new-price-qv" id="product-price-'.$rows['productID'].'">
                                        ' . $rows['brand'] . ' </span>
                    			  </p>
                              ...
                              <div id="product_additional_data_'.$rows['productID'].'"><div class="product_additional_data"></div></div>
                            </div>
                          </div>
    ...
    ///// hover block
    function collection_watch_hover_block($rows=array(), $ringPrice=0, $ringImage='', $popupLink='', $total_img = 1, $listing='', $viewtype='') {
        //echo  '<pre>'; print_r($rows); exit();
        $block_id = $rows['productID'];
        $form_name = 'form_'.$block_id;
        $ring_price_view = ( $ringPrice > 0 ? '$' . _nf($ringPrice, 2) : ' Please call' . CONTACT_NO . ' for price' );
        $collection_title = ( empty($listing) ? $this->get_heart_title( $rows ) : $rows['productName'] );
        if( empty($viewtype) ) {
            $hover_block = '<div class="item_info_view">
                               <div class="item_lable_style"><a href="'.SITE_URL.'collection/watch-collection-detail/'.$rows['productID'].'">
                                   '. $collection_title .'<br> '.SITES_NAME.' <br>'.$rows['productName'].' </a> </div>
            ...
            $hover_block .= '<div class="collection_hover_bk" id="'.$rows['productID'].'">
                           <div class="view_count">1/'.$total_img.'</div>
                           <div class="quick_view"><a href="Javascript:;" onclick="view_simple_popup(\''.$rows['productID'].'\')" title="Quick View'.$rows['productID'].'" rel="nofollow">Quick <br> View</a></div>
                          <div class="left_arrow_view"><a href="#javascript" onclick="button_previous(\'thumb_'.$rows['productID'].'\'); show_number_count(\''.$block_id.'\', \''.$total_img.'\', \'back\')"><img src="'.SITE_URL.'img/heart_diamond/left_arrow_icon.jpg"></a></div>
                    <div class="right_arrow_view"><a href="#javascript" onclick="button_next(\'thumb_'.$rows['productID'].'\'); show_number_count(\''.$block_id.'\', \''.$total_img.'\', \'\')"><img src="'.SITE_URL.'img/heart_diamond/right_arrow_icon.jpg" alt=""></a></div>
                    			...
                    			<form name="'.$form_name.'" id="'.$form_name.'" method="post">
					              ...
					              <input type="hidden" name="main_price" id="main_price" value="'.$rows['price1'].'" />
					              <input type="hidden" name="price" value="'.$rows['price1'].'" />
					              <input type="hidden" name="vender" value="unique">
					              <input type="hidden" name="url" value="'.SITE_URL.$rows['thumb'].'">
					              <input type="hidden" name="prodname" value="'.$rows['productName'].'">
					              <input type="hidden" name="diamnd_count" value="'.$rows['supplied_stones'].'">
					              <input type="hidden" name="ring_shape" value="'.$suport_shape.'">
					              <input type="hidden" name="ring_carat" value="'.$rows['metal_weight'].'">
					              <input type="hidden" name="prid" id="prid" value="'.$rows['productID'].'">
					              <input type="hidden" name="txt_ringtype" value="'.$rows['brand'].'">
					              ...
					              <input type="hidden" name="vendors_name" value="diamondbayou" />
                                  <input type="hidden" name="vendor_number" value="713-777-2026" />
                                  <input type="hidden" name="table_name" value="dev_watches" />
                                  <input type="hidden" name="item_title" value="'.$rows['productName'].'" />
                                  <input type="hidden" name="item_url" value="'.SITE_URL.'collection/watch-collection-detail/'.$rows['productID'].'" />
                                  <input type="hidden" name="product_type" value="'.$rows['brand'].'" />
    ...
    function collection_hover_block($rows=array(), $ringPrice=0, $ringImage='', $popupLink='', $total_img = 1, $listing='', $viewtype='') {
        ...
        $dev_ebaycategories_data2         = $this->Catemodel->getdata_any_table_where($where_dev_ebaycategories_cat2, 'dev_ebaycategories');
		 $categoryNamea = isset($dev_ebaycategories_data2['0']->category_name)?$dev_ebaycategories_data2['0']->category_name:'';
        ...
        if( empty($viewtype) ) {
            $hover_block = '<div class="item_info_view">
                               <div class="item_lable_style"><a href="'.SITE_URL.'collection/collection-detail/'.$rows['stock_number'].'">
                                   '. $collection_title .'<br> '.SITES_NAME.' </a></div>
                                   <div class="ring_view_rating"><img src="'.SITE_URL.'img/heart_diamond/rating_icong_view.jpg" style="display:none;"></div>
                                   <div class="priceLable">'.$ring_price_view.'</div>
                                </div>
                                <div class="addtocart_icon"><a href="#javascript" onClick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$block_id.'\')">Add to Cart</a></div>';
            ...
            $hover_block .= '<div class="collection_hover_bk" id="'.$rows['stock_number'].'">
                    ...
                    <div class="right_arrow_view"><a href="#javascript" onclick="button_next(\'thumb_'.$rows['stock_number'].'\'); show_number_count(\''.$block_id.'\', \''.$total_img.'\', \'\')"><img src="'.SITE_URL.'img/heart_diamond/right_arrow_icon.jpg" alt=""></a></div>
								...
								<input type="hidden" name="product_type" value="'.$categoryNamea.'" />
								<input type="hidden" name="center_stone_id" id="center_stone_id" />
								<input type="hidden" name="txt_qty" value="1" />
   ...
   function product_cate_list_link($cname='') {
	...
	$data['finished_level'] = $this->finishlevel( $product_id, 'gold', 'options' );
        ...
        $data['extra_headers'] .= '<script language="javascript" src="'.SITE_URL.'js/jquery.popup.js" type="text/javascript"></script>';
        $ringresults = $this->Catemodel->getFingerSizeResult();
        $base_link = SITE_URL.'collection/jewelry_ring_detail/'.$product_id.'/';
        $finger_size = '<option value="'.$base_link.'?ring_size=">Select Finger Size</option>';
        ...
        $output = $this->load->view('engagementringstrial/heartring_detail_view' , $data , true);
        $this->output($output, $data);
    }
    ...
    function getProductThumb($rowaray=array(), $popup='') {
        $getRingsThumb = '';
		$categoriesName = isset($rowaray['categories_name'])?$rowaray['categories_name']:'';
		$itemId = isset($rowaray['item_id'])?$rowaray['item_id']:'';
        $itemTitle = $categoriesName.' ITEM ID: ' . $itemId;
        //$collections_link = 'http://173.230.130.50:8888/Images/';
        $collections_link = 'http://market.heartsanddiamonds.com/images/';
	...
	$thumb_options = array(
		...
		if(isset($collection_thumb) && !empty($collection_thumb)){
    ...
    /// get product thumb
    function getWatchProductThumb($rowaray=array(), $popup='') {
        //echo '<pre>'; print_r($rowaray); exit();
        $getRingsThumb = '';
    ...
    function get_collection_thumbs($rowaray=array(), $item_title='') {
        ...
        if( count($collection_thumb) > 0 ) {  
            ...
            $set_ring_thumb .= '<div class=""><img src="'.SITE_URL.'img/no_image_found.jpg" class="set_static_position" width="200" height="200" alt="'.SITES_NAME.'"></div>';
        }
    ...
    function ringSimilarItems($ring_cateid=0, $prod_id=0, $limit=5, $listing='') {
        ...
        if( count($rowsring) > 0 ) {
            foreach( $rowsring as $rowring ) {
               $detaiLink = SITE_URL . 'collection/jewelry_ring_detail/' . $rowring['id'];
            ...
            //if( getimagesize( $ringImageLink ) ) {
               ...
               $rid = $rowring['id'];
               $popupLink = SITE_URL . 'collection/heart_popup_detail/'.$rowring['id'] . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
               
            if( empty($listing) ) {
               $similar_rings .= '<div class="prdSection col-sm-3" id="'.$rid.'">
                                    <a href="'.$detaiLink.'" class="alsoviwed-product-img">
                                            <img class="" src="'.$ringImageLink.'" width="200" alt="'.$ring_title.'" title="'.$ring_title.'" class="inline_block" />
                                    </a><br><br>
                                    <a class="prdName" title="'.$ring_title.'" href="'.$detaiLink.'">'.$ring_title.'</a>
                                    <div class="price-box">
                                            <p class="old-price"><span>Retail Price:</span>
                                            <span class="set_text_decorate"> $'._nf($retail_price, 2).'</span></p>
			...
			<div class="product-grid-quick" onmouseover="showTopQuickView('.$rid.');" onmouseout="hideTopQuickView('.$rid.');" class="hide_overflow" />
				<div id="top-quickview'.$rid.'" class="set_block_position">
				...
				<a title="'.$ring_title.'" href="'.$detaiLink.'"><img alt="'.$ring_title.'" class="" src="'.$ringImageLink.'" class="inline_block" width="200"></a>
			...
			<div class="box-detail-over right-box" id="top-box-detail-over-'.$rid.'" class="hide_block">
				<div class="column3">
					<p>'.$ring_title.'</p>
					<div class="hover-price">
						<div class="popup-prices">
    ...
    function recently_purchased_product($category_id=0) {
        ...
        if( count($rowsring) > 0 ) {
            $prod_list .= '<div class="recently_purchased">
                    ...
                    <a href="'.SITE_URL.'collection/collection-listing/newarrivals/'.$category_id.'">View All Products</a></div>
            ...
            foreach( $rowsring as $rowring ) {
                ...
                $prod_list .= '<a href="'.SITE_URL.'collection/collection-detail/'.$rowring['stock_number'].'">'.$thumbs['thumbs'].'</a>';
            }
            $prod_list .= '</div></div>';
        }
    ...
    function collection_detail_hover_block($rowring=array(), $ring_ourprice=0, $ringImageLink='', $popupLink='', $type='', $total_img = 1) {
        ...
        $where_dev_ebaycategories_cat2    = array('category_id' => $rowring['category']);
        $dev_ebaycategories_data2         = $this->Catemodel->getdata_any_table_where($where_dev_ebaycategories_cat2, 'dev_ebaycategories');
        ...
        $collection = '<div class="collection_hover_bk collection_detail_hover" id="'.$block_id.'">
                    ...
                    <div class="item_info_view">
                     ...
                     <div class="addtocart_icon"><a href="#javascript" onClick="submitCartForm(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rowring['stock_number'].'\')">Add to Cart</a></div>
                 <form name="'.$form_name.'" id="'.$form_name.'" method="post">
                     ...
                     <input type="hidden" name="prodname" value="Jewelry Item ID: '.$rowring['stock_real_number'].'" />
                     ...
                     <input type="hidden" name="stock_number" id="stock_number" value="'.$rowring['stock_real_number'].'" />
                     ...
                     <input type="hidden" name="vendors_name" value="'.$rowring['vendor_name'].'" />
                     <input type="hidden" name="vendor_number" value="'.$rowring['vendor_sku'].'" />
                     <input type="hidden" name="table_name" value="dev_jewelries" />
                     <input type="hidden" name="item_title" value="'.$rowring['item_title'].'" />
                     <input type="hidden" name="item_url" value="'.SITE_URL.'collection/collection-detail/'.$rowring['stock_number'].'" />
                     <input type="hidden" name="product_type" value="'.$dev_ebaycategories_data['0']->category_name.'" />
    ...
    /// get Hearts and Diamonds collection images
    function heart_collection_images_details($rows=array(), $ring_title='', $detail='', $recent='') {
        $collection = array();
        $flderPath = COLLECTION_FOLDER;
        //$collections_link = 'http://173.230.130.50:8888/Images/';
        $collections_link = 'http://www.thegoldsourcejewelry.com/images/';
        ...
        if( !empty($rows['image1']) ) {
            ...
            for( $i=1; $i <= 6; $i++ ) {
                if( !empty($rows['image'.$i]) ) {
                    ...
                    $set_ring_thumb .= '<div class="sp active_view set_position" id="video_show_div_'.$i.'"><img src="'.SITE_URL.'images/'.$rows['image'.$i].'" width="200" height="153" alt="'.$ring_title.'" /></div>';
                    
                    $set_ring_small_thumb .= '<a href="#javascript" onclick="show_video_image(\'video_show_div_'.$i.'\')">
                            <img src="'.SITE_URL.'images/'.$rows['image'.$i].'" width="80" height="80" alt="'.$ring_title.'" style="margin-left: 15px;border: solid 1px #cccccc;margin-right: 15px;" />
                            </a>';
    ...
    /// get Hearts and Diamonds collection images
    function heart_watch_collection_images($rows=array(), $ring_title='', $detail='', $recent='') {
        $collection = array();
        $flderPath = COLLECTION_FOLDER;
        //$collections_link = 'http://173.230.130.50:8888/Images/';
        //$collections_link = 'http://www.thegoldsourcejewelry.com/';
        ...
        */
        ...
        if( !empty($rows['thumb']) ) {
            /*for( $i=1; $i <= 6; $i++ ) {
                if( !empty($rows['image'.$i]) ) {
                    //$collection[] = $rows['image'.$i];
                    $set_ring_thumb .= '<div class="sp active_view set_position"><img src="'.SITE_URL.'images/'.$rows['image'.$i].'" width="200" height="153" alt="'.$ring_title.'" /></div>';
                }
            }*/
            $set_ring_thumb = '<div class="sp active_view set_position"><img src="'.SITE_URL.''.$rows['thumb'].'" width="200" height="153" alt="'.$ring_title.'" /></div>';
        }else{
            $set_ring_thumb = '<div class="sp active_view set_position"><img src="'.SITE_URL.'img/no_image_found.jpg" width="200" height="153" alt="'.$ring_title.'" /></div>';
        }
    ...
    function popularListings($ring_cateid=0, $prod_id=0, $limit=5, $listing='') {
        ...
        if( count($rowsring) > 0 ) {
            foreach( $rowsring as $rowring ) {
               ...
               $ring_ourprice = $rowring['gold_polished_1300'];
               //$saving_percent = ( 100 - ( ( $ring_ourprice / $retail_price ) * 100 ) );
               //$popupLink = SITE_URL . 'collection/heart_popup_detail/'.$rowring['id'] . '/?keepThis=true&TB_iframe=true&width=800&height=550&modal=false';
    ...
    //if( getimagesize( $ringsImg ) !== FALSE ) {
        ...
        $popupLink = SITE_URL . 'collection/heart_popup_detail/' . $rid . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';

        $ringlistings = '<li class="item rings_cols '.$class.'" data-url="'.$ringDetail.'">
      <div class="product-grid-quick" onmouseover="showQuickView('.$rid.');" onmouseout="hideQuickView('.$rid.');" class="hide_overflow">
        <div id="quickview'.$rid.'" class="hide_block"> 
    ...
    <div class="price-box">
      ...
      <div class="box-detail-over " id="box-detail-over-'.$rid.'" class="hide_block">
        <div class="column3">
          <p>'.$ringTitle.'</p>
                    <div class="hover-price">
    <div class="popup-prices">
    ...
    function getSubCategoryLink( $cid=0 ) {
        ...
        if( count($ringresults) > 0 ) {
            foreach( $ringresults as $rowcate ) {
                $cateList .= '<li><a href="'.SITE_URL.'collection/heart_collection_cate/'.$rowcate['id'].'" title="'.$rowcate['cate_name'].'">'.$rowcate['cate_name'].'</a></li>';
            }            
        }
    ...
    function category_cols_list_view($cid=0) {
        ...
        if( count($ringresults) > 0 ) {
            foreach( $ringresults as $rowcate ) {
                $detaiLink = SITE_URL.'collection/heart_collection_cate/'.$rowcate['id'];
    ...
    function get_field_value($global_fields, $label='') {
        $field_value = '';
        
        foreach( $global_fields as $fields ) {
            if( trim($fields[0]) === $label ) {
    ...
    function listingdetail($id=0, $popup='') {
        $rowsring = $this->Davidsternmodel->getSternCollectionDetail($id); //print_ar($rowsring);
        $category_name = $this->Davidsternmodel->getCollectionCateName($rowsring['category']);
        $global_fields = unserialize( $rowsring['global_fields'] ); //print_ar($global_fields);
        
        $item_metal = $global_fields[0][1];
        $carat_weight = $this->get_field_value($global_fields, 'Center Size');
        $diamond_color = $this->get_field_value($global_fields, 'Diamond Color');
        $diamond_clarity = $this->get_field_value($global_fields, 'Diamond Clarity');
        $primary_stone = $this->get_field_value($global_fields, 'Primary Stone');
        $numberof_stone = $this->get_field_value($global_fields, 'Number Of Stones');
        $side_stone_shape = $this->get_field_value($global_fields, 'Side Stone Shape');
        $settings = $this->get_field_value($global_fields, 'Settings');
        $setting = $this->get_field_value($global_fields, 'Setting');
        $item_setting = ( !empty($settings) ? $settings : $setting );
        
        //$item_price = ( $rowsring['price_website'] > 0 ? '$' . _nf($rowsring['price_website'], 2) : 'Please Call ' . CONTACT_NO . ' for price' );
        
        $item_detail_list = array(
            'Metal' => $item_metal,
            'Collection Category' => $category_name,
            'Vendor Sku' => $rowsring['vendor_sku'],
            'Carat Weight' => $carat_weight,
            'Diamond Color' => $diamond_color,
            'Diamond Clarity' => $diamond_clarity,
            'Primary Stone' => $primary_stone,
            'Number Of Stones' => $numberof_stone,
            'Side Stone Shape' => $side_stone_shape,
...
<table id="item-tbl" class="data-table2" width="100%" cellspacing="0" cellpadding="0">
  <tbody>';
        $view_iteminfo .= '<tr class="first-row">
                        ...
                        <td style="color:#ff0000;font-weight:bold;">'.$rowsring['item_sku'].'</td>
                      </tr>';
        
        foreach( $item_detail_list as $item_label => $item_value ) {
            if( !empty($item_value) ) {
                $view_iteminfo .= '<tr class="first-row">
                                <th style="width:40%;">'.$item_label.'</th>
                                <td>'.$item_value.'</td>
                              </tr>';
            }
        }
 ...
 $view_iteminfo .= '</tbody></table>';
    ...
    function heart_popup_detail($id=0) {
       ...
       $this->load->view('engagementringstrial/heartjw_popup_detail', $data);
        //$this->output($output, $data);
    ...
    function heart_collection_popup_detail($id=0) {
       ...
       $where_dev_ebaycategories_cat    = array('category_id' => $rowsring['subcategory']);
       $dev_ebaycategories_data         = $this->Catemodel->getdata_any_table_where($where_dev_ebaycategories_cat, 'dev_ebaycategories');
	   $categoryNamea = isset($dev_ebaycategories_data['0']->category_name)?$dev_ebaycategories_data['0']->category_name:'';
       
       $where_dev_ebaycategories_cat2    = array('category_id' => $rowsring['category']);
       $dev_ebaycategories_data2         = $this->Catemodel->getdata_any_table_where($where_dev_ebaycategories_cat2, 'dev_ebaycategories');
	   $categoryNameb = isset($dev_ebaycategories_data2['0']->category_name)?$dev_ebaycategories_data2['0']->category_name:'';
		$data_heart_title = 'Yadegar Diamonds '. $categoryNamea .' '. $categoryNameb .' '.$rowsring['item_title']; 
       ...
       $ring_detail_bk .= '<form id="form_'.$rowsring['stock_number'].'" action="" method="">
          ...
          <div class="price-box">
              ...
              <p class="old-price fb-old-price f-fix"> 
                  <span class="price-label">Category Type:</span> <span>'.$categoryNameb.'</span> 
              </p>
              <p class="old-price fb-old-price f-fix"> 
                  <span class="price-label">Category Sub Type:</span> <span>'.$categoryNamea.'</span> 
              </p>
              <p class="old-price fb-old-price f-fix"> 
    ...
    //// product popup detail
    function watch_collection_popup_detail($id=0) {
        
       $data = $this->getCommonData();
       $rowsring = $this->Davidsternmodel->getWatchCollectionDetail($id);
       
        $data['category_name'] = jewelry_cate_name( $rowsring['category'] );
        $data['rowsring'] = $rowsring;
        //$sales_price = $rowsring['price'];
        $sales_price = ( $rowsring['price1'] > 0 ? $rowsring['price1'] : $rowsring['retail_price'] );
        $retail_price = $sales_price * PRICE_PERCENT;
        $saving_percent = _nf( ( 100 - ( ( $sales_price / $retail_price ) * 100 ) ), 2 );
        $data['buynow_link'] = htmlspecialchars(SITE_URL.'jewelleries/addtoshoppingcart/');
        $data['item_desc'] = get_site_title().' Jewelry can be yours for $'._nf($rowsring['price1'], 2).'.';
        ...
        $ringimg   = SITE_URL.$rowsring['thumb'];
       
       $data['title'] = $ring_title;
       $listings_detail = ''; //$this->collectionPopupDetail( $id, 'popup' );
       //$product_thumbs = $this->get_collection_thumbs( $rowsring, $ring_title );
       $product_thumbs = $this->heart_watch_collection_images( $rowsring, $ring_title );
       
       $ring_detail_bk = '<div id="pop_'.$id.'" class="simplePopup collection_view">';
       $ring_detail_bk .= '<div class="col-sm-5">
                  <div class="product-image product-image-zoom zoomright" id="ringsthumb_view">
                    <div class="set_thumb_img" id="popup_'.$rowsring['productID'].'">                                
                            <div class="" id="show_thumb_view"></div>
                                  '.$product_thumbs['thumbs'].'
                            </div>
                    <div class="left_arrow_view"  style="display:none;"><a href="#javascript" onclick="button_previous(\'popup_'.$rowsring['productID'].'\')"><img src="'.SITE_URL.'img/heart_diamond/left_arrow_view_ic.jpg" alt="" /></a></div>
        <div class="right_arrow_view"  style="display:none;"><a href="#javascript" onclick="button_next(\'popup_'.$rowsring['productID'].'\')"><img src="'.SITE_URL.'img/heart_diamond/right_arrow_view_ic.jpg" alt="" /></a></div>
                </div>
                <div class="more-views"></div>
              </div>';
       $ring_detail_bk .= '<form id="form_'.$rowsring['productID'].'" action="" method="">
           <div class="col-sm-6 pull-right">
          <div class="price-box">
              <div class="product-name"><h1>'.$ring_title.'</h1></div>
              <div class="product-name"><h1>Item Name: '.$rowsring['stock_real_number'].'</h1></div>
             ';
            if($retail_price > 0 ) {
            $ring_detail_bk .= '<p class="old-price"> <span class="retail-label">Retail Price:</span> <span class="price" id="old-price-'.$rowsring['productID'].'">$'._nf($retail_price, 2).'</span> <span class="pnotify"> <a href="#" id="productupdates-button4" onmouseover="new Productupdates();"> <i></i>Get Price Update </a> </span> </p>
            <p class="old-price"> <span class="ourprice-label">Our Price:</span> <span class="new-price" id="product-price-'.$rowsring['productID'].'">$'._nf($sales_price, 2).'</span> <span class="special-price-label" id="old_price">(Savings:'.$saving_percent.'%)</span> <span id="google_discount"></span> <span id="twitter_discount"></span> <span id="facebook_discount"></span> <span id="pinterest_discount"></span> <span id="total_price"></span> 
              <!-- // customm code for shipping free text --> 
              <strong><a class="freeShip" href="#" target="_blank">Ships for free&nbsp;*</a></strong> 
              <!-- // End customm code --> 
            </p>';
          ...
          <div class="product-options-bottom">
            <div class="add-to-cart-1">
                ...
                <input type="hidden" name="3ez_price" value="" />
                <input type="hidden" name="5ez_price" value="" />
                <input type="hidden" name="main_price" value="'.$rowsring['price1'].'" />
                <input type="hidden" name="price" value="'.$rowsring['price1'].'" />
                <input type="hidden" name="vender" value="unique">
                <input type="hidden" name="url" value="'.$ringimg.'">
                <input type="hidden" name="prodname" value="'.$rowsring['productName'].'" />
                <input type="hidden" name="diamnd_count" value="'.$rowsring['diamond_count'].'">
                <input type="hidden" name="ring_shape" value="'.$rowsring['shape'].'" />
                <input type="hidden" name="ring_carat" value="'.$rowsring['carat'].'" />
                <input type="hidden" name="prid" id="prid" value="'.$rowsring['productID'].'" />
                <input type="hidden" name="stock_number" id="stock_number" value="'.$rowsring['stock_real_number'].'" />
                <input type="hidden" name="txt_ringtype" value="'.$rowsring['brand'].'" />
                <input type="hidden" name="txt_ringsize" value="" />
                <input type="hidden" name="txt_metal" value="'.$rowsring['metal'].'" />
                <input type="hidden" name="metals_weight" value="'.$rowsring['weight'].'" />
                
                <input type="hidden" name="vendors_name" value="Yadegar Diamonds" />
                <input type="hidden" name="vendor_number" value="713-777-2026" />
                <input type="hidden" name="table_name" value="dev_watches" />
                <input type="hidden" name="item_title" value="'.$rowsring['productName'].'" />
                <input type="hidden" name="item_url" value="'.SITE_URL.'collection/watch-collection-detail/'.$rowsring['productID'].'" />
                <input type="hidden" name="product_type" value="'.$rowsring['brand'].'" />
                
                <input type="hidden" name="txt_addoption" value="goldsourcejewelry_collection" />
                <input type="hidden" name="center_stone_id" id="center_stone_id" />
                <input type="hidden" name="txt_qty" value="1" />
                          
                <div>
                    <a href="#javascript" onclick="add_to_cart_form(\''.SITE_URL.'jewelleries/addtoshoppingcart/\', \''.$rowsring['productID'].'\')" class="add_to_cart_btn" id="addtoshopping">Add To Cart</a>
                </div>
            </div>
          </div>
          <br clear="all">
    ...
    function view_earing_diamonds_detail($lot='',$add_option='',$setting_id='', $lot2='') {
        ...
        $this->load->view('engagementringstrial/view_earing_diamonds_detail', $data);
    }
        ...
        if( count($cates1) > 0 ) {
            foreach( $cates1 as $rowcate ) {
                $ringresults .= '<div class="engagement-product col-sm-4">
                                    ...
                                    <img class="set_img_size" id="ringbigimage10267" src="'.SITE_URL.'img/no_image_found.jpg" /><br></div></a>
    ...
    function getCollectionRings($category_id=0, $page_limit=9) {
        ...
        if( count($results) > 0 ) {
            foreach( $results as $rows ) {
                $detailPageLink = SITE_URL . 'collection/collection_ring_detail/'.$rows['stock_number'];
				...
				<a href="'.$detailPageLink.'" target="_blank">
                                <div class="ringtile">
                                <div class="setringsbg_bk">'.$trialUserLogo.'</div>
                                <img class="set_img_size" id="ringbigimage10267" src="'.$ringImage.'" /><br></div></a>
