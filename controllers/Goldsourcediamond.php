<?php
class Goldsourcediamond extends CI_Controller {
    private $finish;
    ...
    function hear_cate_link($c_id=0) {
        ...
        if( !empty($cates3['cate_name']) ) {
            $cate_link .= '<li><a href="'.SITE_URL.'goldsourcediamond/heart_collection_cate/'.$cates3['id'].'">'.$cates3['cate_name'].'</a></li> > ';
        }
        if( !empty($cates2['cate_name']) ) {
            $cate_link .= '<li><a href="'.SITE_URL.'goldsourcediamond/heart_collection_cate/'.$cates2['id'].'">'.$cates2['cate_name'].'</a></li> > ';
        }
        if( !empty($cates1['cate_name']) ) {
            $cate_link .= '<li><a href="'.SITE_URL.'goldsourcediamond/heart_collection_cate/'.$cates1['id'].'">'.$cates1['cate_name'].'</a></li>';
        }
    ...
    function get_cate_list($gender='M') {
        ...
        foreach($men_cate as $rowmen) {
            ...
            if( !empty($cate_name) ) {
                $collection_cate .= '<li><a href="'.SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$rowmen['category'].'/">'.$cate_name.'</a>';
            ...
            if( count($get_subcate) > 0 ) {
                ...
                foreach( $get_subcate as $rowm_scate ) {
                    ...
                    $collection_cate .= '<li><a href="'.SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$rowm_scate['subcategory'].'/">'.$scate_name.'</a>';
                }
                $collection_cate .= '</ul>';
            }
    ...
    function get_watch_list($gender='M') {
        ...
        foreach($watch_cate as $watch) {
            ...
            $collection_cate .= '<li><a href="'.SITE_URL.'goldsourcediamond/goldsource-watch-collection-listing/'.$watch_brand.'/"> '.$watch['brand'].' </a></li>';
    ...
    function get_collection_cate() {
        ...
        //echo '<pre>'; print_r($main_listing_category); exit(); 
        ...
        foreach ($main_listing_category as $value) {
              ...
              /*$collection_cate .='<li><a href="#">'.$main_cat_name.'</a><ul>'; 

              $collection_cate .= $this->get_cate_list($value['gender']);

              $collection_cate .='</ul></li>';*/
        }         
     ...
     /*   $collection_cate .= '</ul>
        ...
        $get_all_cats = array(740520120);  
        //740520170, 740520280 740520073, 740520093, 740520100, 740520103, 740520110, 740520118,  740520129, 740520271, 740520211, 740520259, 740520272
        foreach($get_all_cats as $get_all_cats_val){ 
            ...
            foreach($dev_ring_cat_data as $ring_cat_data){
                if( $this->catemodel->count_any_table( array('subcategory' => $ring_cat_data->category_id), 'dev_jewelries') > 0){
                    $ring_cat_list .= '<li><a href="'.SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$ring_cat_data->category_id .'/"> '.$ring_cat_data->category_name.' </a></li>';
                }
            }
    
            $collection_cate .= '
              <li><a href="'.SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$get_all_cats_val.'">'.$dev_main_cat_data['0']->category_name.'</a>
                <ul>
                  '.$ring_cat_list.'
                </ul>
              </li>'; 
        ...
        /*$collection_cate .= '<li><a href="'.SITE_URL.'goldsourcediamond/goldsource-watch-collection-listing/R3VjY2k=/">Watches</a>
                    <ul>
                      '.$this->get_watch_list('F').'
                    </ul>
                  </li>';  */
        ...
        $collection_cate .= '
                <li><a href="'.SITE_URL.'testengagementrings/engagementrings/52">Solitaire Engagement Rings</a></li>
                <li><a href="'.SITE_URL.'testengagementrings/engagement-ring-listings/8">Fancy Engagement Rings</a></li>
                <li><a href="'.SITE_URL.'testengagementrings/engagementrings/40">Halo Engagement Rings</a></li>
                <li><a href="'.SITE_URL.'testengagementrings/engagement-ring-listings/39">Antique Engagement Rings</a></li>
                <li><a href="'.SITE_URL.'testengagementrings/engagementrings/179">Petite Engagement rings</a></li>
                <li><a href="'.SITE_URL.'testengagementrings/engagementrings/9">Semi Mount</a></li>
            ';            
...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
        ...
        if( $data['ring_categoies'] != 'false' ) {
            ...
            header('Location:' . SITE_URL . 'goldsourcediamond/ringlisting/' . $cates_id);
        }
    }
	...
	$data['cate_links'] = $this->hear_cate_link($category_id);
        ...
        $base_link = SITE_URL.'goldsourcediamond/ringlisting/'.$category_id.'/?sort='.$sort_option;
	$config["base_url"]   = $base_link.'&pagelist='.$config["per_page"];
        ...
        $sort_option_link = SITE_URL . 'goldsourcediamond/ringlisting/'.$category_id.'/?pagelist='.$config["per_page"].'&per_page='.$startFrom.'&sort=';
    ...
    function heart_bread_links($cid=0, $main='') {
        ...
        if( $cid > 0 ) {            
            ...
            if( empty($main) ) {
                $cate_link = ' > <li><a href="'.SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$cid.'">'.$cate_name.'</a></li>';
            } else {
    ...
    function goldsource_collection() {
        $data = $this->getCommonData();
...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
    ...
    function heart_diamond_main_listing($start=0, $limit=4, $cols=2) {
        ...
        if( count($results['results']) > 0 ) {
            foreach( $results['results'] as $rowrings ) {
                $ringDetail = SITE_URL . 'goldsourcediamond/jewelry_ring_detail/' . $rowrings['id'];
    ...
    function collection_sort_options($id=0, $sort_value='') {
        ...
        $option_link = SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$id.'/?sort_value=';
        $view_sort_option = '';
    ...
    ///// stern collection page
    function goldsource_collection_listing($id='', $recent='') {
        $data = $this->getCommonData();
        $this->session->unset_userdata('center_stone');
        //$this->load->library('pagination');
        ...
        $base_link = SITE_URL.'goldsourcediamond/goldsource-collection-listing/'.$id.'/?sort_value='.$sort_field;
	    $config["base_url"]   = $base_link.'&pagelist='.$config["per_page"];
        $config['num_tag_open'] = '<li>';
        $config['num_tag_close'] = '</li>';
        $config['cur_tag_open'] = '<li><a class="active" href="#">';
    ...
    ///// stern collection page
    function goldsource_watch_collection_listing($id='', $recent='') {
        ...
        if( isset($_GET['limit']) AND isset($_GET['offset']) ){
           $data['rings_listing_3'] = $this->goldsource_watch_collection_list( $id, $_GET['offset'], $_GET['limit'], 6 );     
        }else{
           $data['rings_listing_3'] = $this->goldsource_watch_collection_list( $id, 0, 50, 6 ); 
    ...
    function get_metal_color_link($ring_style, $metal='', $carat='') {
        ...
        if( $id > 0 ) {
            $collection_link = SITE_URL . 'goldsourcediamond/collection-detail/'.$id;
        } else {
            $collection_link = '#';
        }
    ...
    function set_metal_links($ring_id=0, $ringstyle=0, $metal_type='', $metal_color='') {
        $metal_ic = $metal_ic = array(
                ...
                foreach( $metal_ic as $metalrow ) {
                    $metal_link = SITE_URL . 'goldsourcediamond/collection-detail/'.$ring_id . '/' . $metalrow['metal_type'];
                    
                    if( $metalrow['color'] == $metal_color && !empty($metal_color) ) { 
                        //$this->get_metal_color_link($ringstyle, $metalrow['metal'], $metalrow['carat']);
                        if( $i == 2 ) {
                        $metal_list .= '<li><a href="'.SITE_URL . 'goldsourcediamond/collection-detail/'.$ring_id.'/platinum"><img src="'.SITE_URL.'images/platinum_ic.jpg" /></a></li>';
                        }
...
//                );
    ...
    ///// product detail page :: old product detail page ::
    function heart_collection_detail($product_id=0, $metals_type='') {
        ...
        $metals_link = SITE_URL . 'goldsourcediamond/collection-detail/'.$product_id.'/';
	...
	$data['finished_level'] = $this->finishlevel( $product_id, 'gold', 'options' );
        ...
        $base_link = SITE_URL.'goldsourcediamond/collection-detail/'.$product_id.'/';
    ...
    function collection_detail($product_id=0, $metals_type='') {
        ...
        $rowsring = $this->davidsternmodel->getSternCollectionDetail($product_id); //print_ar($rowsring); exit();
        $jew_metal = set_jew_metal($rowsring['metal'], $rowsring['carat']);
        $metal_type = ( empty($metals_type) ? $jew_metal : $metals_type );
        $priceField = $this->get_price_field($metal_type);
        ...
        $data['rowsring']       = $rowsring;
        $data['heart_title'] = 'Engaged '.$dev_ebaycategories_data['0']->category_name.' '.$dev_ebaycategories_data2['0']->category_name.' '.$rowsring['item_title']; //$this->get_heart_title($rowsring, $metal_type);
        ...
        //$cate = $this->getCateName( $rowsring['catid'] );  
        $ringBoxDesc = $data['category_name']; // . ' ' . $rowsring['stock_real_number'];
        $data['ringtitle'] = $ringBoxDesc. ' Item ID: '. $rowsring['stock_real_number'];
        $data['ringimg']   = SITE_URL.'images/'.$rowsring['image1']; //$this->set_collection_img($rowsring['image1'], $rowsring['item_sku'], $rowsring['different_imglist']);
        $data['setingtype']   = ''; //$cate['sub_cname'];
        $data['maincate_name'] = ''; //$cate['main_cname'];
        $data['subcate_link'] = ''; //$this->product_cate_list_link( $cateName[0] );
        $data['metals_list'] = $this->set_metal_links( $product_id, $rowsring['ring_style'], $metal_type, $rowsring['metal_color'] );
        ...
        $data['more_collection_listings_new'] = $this->heart_diamond_collection_similler_list( $rowsring['category'], $rowsring['subcategory'], 0, 9, 6 ); 
    ...
    function heart_diamond_collection_similler_list($cid=0, $subcid=0,  $start=0, $limit=4, $cols=2, $type='') {
        ...
        if( count($rowrings['results']) > 0 ) {
            foreach( $rowrings['results'] as $rows ) {
               ...
               $detaiLink = SITE_URL.'goldsourcediamond/collection-detail/'.$rows['stock_number'];
               $popupLink = SITE_URL . 'goldsourcediamond/heart_collection_popup_detail/'.$rows['stock_number'] . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
    ...
    function watch_collection_detail($product_id=0, $metals_type='') {
        ...
        $data['more_collection_listings'] = $this->goldsource_watch_collection_list( $watch_brand, 0, 9, 6 );
    ...
    function heart_collection_viewtype_listing($cid=0, $start=0, $limit=4, $cols=2, $type='', $sroting='') {
        ...
        if( count($rowrings['results']) > 0 ) {
            foreach( $rowrings['results'] as $rows ) {
               ...
               $detaiLink = SITE_URL.'goldsourcediamond/collection-detail/'.$rows['stock_number'];
               $popupLink = SITE_URL . 'goldsourcediamond/heart_collection_popup_detail/'.$rows['stock_number'] . '/?keepThis=true&TB_iframe=false&width=900&height=550&modal=true';
               $thumbs = $this->heart_collection_images($rows, ''.SITES_NAME.'');
    ...
    //// Hearts and Arrows Collection jewelry rings
    //$this->heart_diamond_collection_list( 3292598018, 3, 9, 6 ); 
    function goldsource_watch_collection_list($cid=0, $start=0, $limit=4, $cols=2, $type='') {
        ...
        if( count($rowrings['results']) > 0 ) {
            ...
            foreach( $rowrings['results'] as $rows ) {
               ...
               $ringPrice = ( $ring_price > 0 ? $ring_price : 'Please Call '.CONTACT_NO.' for price' );
               $detaiLink = SITE_URL.'goldsourcediamond/watch-collection-detail/'.$rows['productID'];
               $popupLink = SITE_URL . 'goldsourcediamond/heart_collection_popup_detail/'.$rows['productID'] . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
               
               $thumbs = $this->heart_watch_collection_images($rows, SITES_NAME);
               
               $popup_block .= $this->goldsource_watch_collection_popup_detail($rows['productID']);
    ...
    function collection_watch_hover_block($rows=array(), $ringPrice=0, $ringImage='', $popupLink='', $total_img = 1, $listing='', $viewtype='') {
        ...
        if( empty($viewtype) ) {
            $hover_block = '<div class="item_info_view">
                               <div class="item_lable_style"><a href="'.SITE_URL.'goldsourcediamond/watch-collection-detail/'.$rows['productID'].'">
            ...
            $hover_block .= '<div class="collection_hover_bk" id="'.$rows['productID'].'">
                    ...
                    <div class="right_arrow_view"><a href="#javascript" onclick="button_next(\'thumb_'.$rows['productID'].'\'); show_number_count(\''.$block_id.'\', \''.$total_img.'\', \'\')"><img src="'.SITE_URL.'img/heart_diamond/right_arrow_icon.jpg" alt=""></a></div>
                    			...
                    			<form name="'.$form_name.'" id="'.$form_name.'" method="post">
					              ...
					              <input type="hidden" name="vendors_name" value="Engaged" />
                                  ...
                                  <input type="hidden" name="item_url" value="'.SITE_URL.'goldsourcediamond/watch-collection-detail/'.$rows['productID'].'" />
    ...
    function collection_hover_block($rows=array(), $ringPrice=0, $ringImage='', $popupLink='', $total_img = 1, $listing='', $viewtype='') {
        ...
        if( empty($viewtype) ) {
            $hover_block = '<div class="item_info_view">
                               <div class="item_lable_style"><a href="'.SITE_URL.'goldsourcediamond/collection-detail/'.$rows['stock_number'].'">
                    ...
                    <div class="right_arrow_view"><a href="#javascript" onclick="button_next(\'thumb_'.$rows['stock_number'].'\'); show_number_count(\''.$block_id.'\', \''.$total_img.'\', \'\')"><img src="'.SITE_URL.'img/heart_diamond/right_arrow_icon.jpg" alt=""></a></div>
                                ...
                                <form name="'.$form_name.'" id="'.$form_name.'" method="post">
					              ...
					              <input type="hidden" name="metals_weight" value="'.$rows['width'].'" />
                                    ...
                                    <input type="hidden" name="item_url" value="'.SITE_URL.'goldsourcediamond/collection-detail/'.$rows['stock_number'].'" />
                                    <input type="hidden" name="product_type" value="'.$dev_ebaycategories_data2['0']->category_name.'" />
   ...
   function product_cate_list_link($cname='') {
	...
	$data['finished_level'] = $this->finishlevel( $product_id, 'gold', 'options' );
        ...
        $data['extra_headers'] .= '<script language="javascript" src="'.SITE_URL.'js/jquery.popup.js" type="text/javascript"></script>';
        $ringresults = $this->catemodel->getFingerSizeResult();
        $base_link = SITE_URL.'goldsourcediamond/jewelry_ring_detail/'.$product_id.'/';
        $finger_size = '<option value="'.$base_link.'?ring_size=">Select Finger Size</option>';
    ...
    function ringSimilarItems($ring_cateid=0, $prod_id=0, $limit=5, $listing='') {
        ...
        if( count($rowsring) > 0 ) {
            foreach( $rowsring as $rowring ) {
               $detaiLink = SITE_URL . 'goldsourcediamond/jewelry_ring_detail/' . $rowring['id'];
            ...
            //if( getimagesize( $ringImageLink ) ) {
               ...
               $rid = $rowring['id'];
               $popupLink = SITE_URL . 'goldsourcediamond/heart_popup_detail/'.$rowring['id'] . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
    ...
    function recently_purchased_product($category_id=0) {
        ...
        if( count($rowsring) > 0 ) {
            $prod_list .= '<div class="recently_purchased">
                    ...
                    <a href="'.SITE_URL.'goldsourcediamond/goldsource-collection-listing/newarrivals/'.$category_id.'">View All Products</a></div>
            ...
            foreach( $rowsring as $rowring ) {
                ...
                $prod_list .= '<a href="'.SITE_URL.'goldsourcediamond/collection-detail/'.$rowring['stock_number'].'">'.$thumbs['thumbs'].'</a>';
            }
            $prod_list .= '</div></div>';
        }
    ...
    function collectionSimilarLististing($cid=0, $prod_id=0, $limit=5, $type='similar') {
        ...
        if( count($rowsring) > 0 ) {
            foreach( $rowsring as $rowring ) {
               $detaiLink = SITE_URL . 'goldsourcediamond/collection-detail/' . $rowring['stock_number'];
               ...
               $popupLink = SITE_URL . 'goldsourcediamond/heart_collection_popup_detail/'.$rowring['stock_number'] . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
    ...
    function collection_detail_hover_block($rowring=array(), $ring_ourprice=0, $ringImageLink='', $popupLink='', $type='', $total_img = 1) {
        ...
        $collection = '<div class="collection_hover_bk collection_detail_hover" id="'.$block_id.'">
                 ...
                 <form name="'.$form_name.'" id="'.$form_name.'" method="post">
                     ...
                     <input type="hidden" name="item_url" value="'.SITE_URL.'goldsourcediamond/collection-detail/'.$rowring['stock_number'].'" />
    ...
    function popularListings($ring_cateid=0, $prod_id=0, $limit=5, $listing='') {
        ...
        if( count($rowsring) > 0 ) {
            foreach( $rowsring as $rowring ) {
               ...
               $ring_ourprice = $rowring['gold_polished_1300'];
               //$saving_percent = ( 100 - ( ( $ring_ourprice / $retail_price ) * 100 ) );
               //$popupLink = SITE_URL . 'goldsourcediamond/heart_popup_detail/'.$rowring['id'] . '/?keepThis=true&TB_iframe=true&width=800&height=550&modal=false';
    ...
    //if( getimagesize( $ringsImg ) !== FALSE ) {
        ...
        $popupLink = SITE_URL . 'goldsourcediamond/heart_popup_detail/' . $rid . '/?keepThis=true&TB_iframe=true&width=900&height=550&modal=false';
    ...
    function getSubCategoryLink( $cid=0 ) {
        ...
        if( count($ringresults) > 0 ) {
            foreach( $ringresults as $rowcate ) {
                $cateList .= '<li><a href="'.SITE_URL.'goldsourcediamond/heart_collection_cate/'.$rowcate['id'].'" title="'.$rowcate['cate_name'].'">'.$rowcate['cate_name'].'</a></li>';
            }            
        }
    ...
    function category_cols_list_view($cid=0) {
        ...
        if( count($ringresults) > 0 ) {
            foreach( $ringresults as $rowcate ) {
                $detaiLink = SITE_URL.'goldsourcediamond/heart_collection_cate/'.$rowcate['id'];
...
<table id="item-tbl" class="data-table2" width="100%" cellspacing="0" cellpadding="0">
 ...
 $view_iteminfo .= '</tbody></table>';
    ...
    function heart_collection_popup_detail($id=0) {
      ...
      $data_heart_title = 'Engaged '.$dev_ebaycategories_data['0']->category_name.' '.$dev_ebaycategories_data2['0']->category_name.' '.$rowsring['item_title']; 
                  ...
                  <div class="product-image product-image-zoom zoomright" id="ringsthumb_view">
                    <div class="set_thumb_img" id="popup_'.$rowsring['stock_number'].'">                                
                            <div class="" id="show_thumb_view"></div>
                                <a href="'.SITE_URL.'goldsourcediamond/collection-detail/'.$rowsring['stock_number'].'">
       ...
       $ring_detail_bk .= '<form id="form_'.$rowsring['stock_number'].'" action="" method="">
          ...
          <div class="price-box">
              ...
              <p class="old-price fb-old-price f-fix"> 
                  <span class="price-label">Category Type:</span> <span>'.$dev_ebaycategories_data2['0']->category_name.'</span> 
              </p>
              <p class="old-price fb-old-price f-fix"> 
                  <span class="price-label">Category Sub Type:</span> <span>'.$dev_ebaycategories_data['0']->category_name.'</span> 
              </p>
              <p class="old-price fb-old-price f-fix"> 
          ...
          <div class="product-options-bottom">
            <div class="add-to-cart-1">
                ...
                <input type="hidden" name="item_url" value="'.SITE_URL.'goldsourcediamond/collection-detail/'.$rowsring['stock_number'].'" />
                <input type="hidden" name="product_type" value="'.$dev_ebaycategories_data['0']->category_name.'" />
    ...
    //// product popup detail
    function goldsource_watch_collection_popup_detail($id=0) {
       ...
       $ring_detail_bk .= '<form id="form_'.$rowsring['productID'].'" action="" method="">
          ...
          <div class="product-options-bottom">
            <div class="add-to-cart-1">
                ...
                <input type="hidden" name="item_url" value="'.SITE_URL.'goldsourcediamond/watch-collection-detail/'.$rowsring['productID'].'" />
    ...
    function getCollectionRings($category_id=0, $page_limit=9) {
        ...
        if( count($results) > 0 ) {
            foreach( $results as $rows ) {
                $detailPageLink = SITE_URL . 'goldsourcediamond/collection_ring_detail/'.$rows['stock_number'];
