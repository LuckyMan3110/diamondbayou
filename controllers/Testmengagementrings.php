<?php
class Testmengagementrings extends CI_Controller {
    ...
    $data['available_insizes'] = $available_insizes;
        ...
        $output = $this->load->view('engagementringstrial/mengagement_rings_details' , $data , true);
        $this->output($output, $data);
    }
  ...
  function get_financing_notification(){
    ...
    $fname = 'Criscel';
    $lname = 'Abayon';
    $email = "Jewelercart@gmail.com";//"mukesh.swami".time()."29@gmail.com";
