...
if (! function_exists('createsortlink'))
{
	...
	{
	    $link = '';
	    if($orderby == $sortterms.' asc') $link = '<img src="asc.jpg" alt="desc"><a href="'. $baselink . '/' .$sortterms .'%20desc'. $extraquery.'">' . $linktitle . '</a>';
	    elseif ($orderby == $sortterms.' desc')$link = '<img src="desc.jpg" alt="desc"><a href="'. $baselink . '/' .$sortterms .'%20asc'. $extraquery.'">' . $linktitle . '</a>';
	    else 
