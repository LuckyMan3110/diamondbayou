...
class EBaySession
{
	...
	*/
	...
	{
		$this->requestToken = $params['userRequestToken'];
		$this->devID        = $params['developerID'];
		$this->appID        = $params['applicationID'];
		$this->certID       = $params['certificateID'];
		$this->compatLevel  = $params['compatabilityLevel'];
		$this->siteID       = $params['siteToUseID'];
		$this->verb         = $params['callName'];
