                 ...
                 <div class="content">
                 	 <div class="view-left">
                        ...
                        <div class="text-description">
                        	<h4 class="title-description"><?php echo $details['data'][0]['Metal_Desc']; ?></h4>
							...
							<div class="desc-price">
								...
								<br>
									<input type="radio" name="price" value="<?php echo number_format($cuprice,0)?>,normal">
								...
								<input type="radio" name="price" value="<?php $ez3 = $org_price+(($org_price*$ez3value)/100);$fez3=$ez3;$ez3=$cuprice1-$ez3; echo number_format($ez3,0)?>,3EZ">
								...
								<input type="radio" name="price" value="<?php $ez5=$org_price+(($ez5value*$org_price)/100);$fez5=$ez5; $ez5=$cuprice1-$ez5; echo number_format($ez5,0); ?>,5EZ"><?php $ez5s=$ez5/4;  ?>
								5 EZ Pay - $<?php echo number_format($cuprice1,0); ?> Price $<?=number_format($fez5,0)?> payment then 4 EZ payments of $<?=number_format($ez5s,0)?> monthly. 
								<?php } ?>
								
								<!--
								<p class="price"><input type="radio" name="price" value="<?php echo $details['data'][0]['MSRP']?>,normal">$<?php echo $details['data'][0]['MSRP']?></p>
								<?php if($details['data'][0]['ezstatus'] == true){ ?>
								<input type="radio" name="price" value="<?php $ez3 = $details['data'][0]['MSRP']+(($ez3value*$details['data'][0]['MSRP'])/100); echo number_format($ez3,0)?>,3EZ">3EZ = $<?php $ez3s=$ez3/3; echo number_format($ez3s,0);?><br/>
								<input type="radio" name="price" value="<?php $ez5 =  $details['data'][0]['MSRP']+(($ez5value*$details['data'][0]['MSRP'])/100); echo number_format($ez5,0); ?>,5EZ">5EZ = $<?php $ez5s=$ez5/5; echo number_format($ez5s,0); }?><br/>
								<input type="hidden" name="vender" value="quality">
								<input type="hidden" name="url" value="<?php echo $src ?>">
								<input type="hidden" name="prodname" value="<?php echo $details['data'][0]['Description']?>">
								<!--<input type="submit" name="submit" id="submit" value="ADD TO SHOPPING BAG" />-->
...
EZ Pay 5</p>
                            ...
                            <div class="additional"> 
                                ...
                                <p><a href="#"><b class="icon-additional"></b>Additional EZ Information</a></p>
                            </div>
                            
							<input type="hidden" name="prid" value="<?php echo $details['data'][0]['qg_id'];?>">
							<!--<b class="icon-note"></b>
                            <div class="desc-text">
                        ...
                        <? var_dump($details); ?>
                            ...
                            <div id="tabs">
                                ...
                                <!--<div>
									<p><strong><?php //echo $details['data'][0]['Metal_Desc']; ?> <?php //echo $details['data'][0]['Description']; ?> <!--Diamond Engagement Ring 3/8 ct tw Round-cut 10K White Gold </strong></p>-->
                     ...
                     <div class="view-right">
                        ...
                        <div class="other-product">
                            ...
                            <div class="price-product">
                                <span>Price : $<?php echo number_format($cuprice1,0)	?></span><br>
								<?php if($radomprodect['ezstatus'] == true){ ?>
                                3EZ = $<?php $ez3 = ($cuprice1+(($ez3value*$cuprice1)/100))/3; echo number_format($ez3,2); ?><br>
                                5EZ = $<?php $ez5 = ($cuprice1+(($ez5value*$cuprice1)/100))/5; echo number_format($ez5,2); ?><br><?php } ?>
                            </div>
                        </div>
                        <?php } ?>
                        <!--<div class="other-product">
