...
*/
class Stullerfashionmodel extends CI_Model{
    ...
    function getStullerItemRows($viewType='', $filter_id=0, $category='', $page = 0, $rp = 8, $sortname = 'id', $sortorder = 'desc', $query = '', $qtype = 'id', $oid = '') {
        $results = array();
	$qwhere = '';
    ...
    function getStullerItemDetailViaID($product_id=0) {
        $sql = "SELECT * FROM `dev_stuller_fashionjew` WHERE id = '{$product_id}'";
        $result = $this->db->query($sql);
	$results  = $result->result_array();
