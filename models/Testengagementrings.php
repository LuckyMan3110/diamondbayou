...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
	...
	<meta name="description" content="Buy online emerald cut diamond rings, three stone diamond rings, 3 stone diamond ring, antique diamond ring, set engagement ring, tension engagement rings, affordable engagement ring, 3 stone diamond ring, antique diamond ring, set engagement ring, pave diamond rings, '.$data['ringtitle'].'">
	<meta name="keywords" content="emerald cut diamond rings, three stone diamond rings, 3 stone diamond ring, antique diamond ring, set engagement ring, tension engagement rings, affordable engagement ring, 3 stone diamond ring, antique diamond ring, set engagement ring, pave diamond rings, '.$data['ringtitle'].'">
	<meta name="author" content="'.get_site_contact_info('sites_title').'">
	<meta name="publisher" content="'.get_site_contact_info('sites_title').'">
	<meta name="copyright" content="'.get_site_contact_info('sites_title').'">
	<meta http-equiv="Reply-to" content="">
...
//                    </div>';
    ...
    function get_ring_hover_view($rowrings=array(), $style_name='', $rid=0, $ringsImg='', $ringTitle='', $results='', $popupLink='') {
        ...
        <div class="quick_view"><a href=" '.SITE_URL().'testengagementrings/engagement_ring_detail/'.$rid.'" title="'.$ringTitle.'" rel="nofollow">Quick <br> View</a></div>
