			...
			<div class="blue_man">
				<div class="blue_admin_box1">
					<div class="addcountry_box">
						<div class="heading">
							<h1>Manage Bulk Rings import</h1>
						</div>
						<!-- Message Part -->
						<div style="width:100%;">
						...
						<div class="search_box">
							<form name="inventoryForm" action="<?php echo config_item('base_url');?>admin/diamondsimport" method="post" enctype="multipart/form-data">
								<table width="95%" align="center" cellpadding="10" cellspacing="10">
									...
									<tr>
										<td align="right" colspan="2">
											<a href="<?php echo config_item('base_url');?>upload/drtemplate.xlsx" style="color:red;font-weight:bold;">Download Sample Template</a>
										</td>
									</tr>
								</table>
								<div align="left" style="color:#642284;font-size:small;">
									<ul type="square">
										...
										<li>2. download the template xlsx and fill by correct item details.</li>
										<li>3. before entered the price in xlsx be sure price should correct because price is listed on eBay and amazon Same as entered in xlsx.</li>
