	...
	//		$shippingServices  .= "</select>";
			 ...
			 if(isset($details)){
								...
								$ship_phone_number 	= isset($details[0]['ship-phone-number']) ? $details[0]['ship-phone-number'] 	: '';
                                                                $shipped_fedex 		= isset($details[0]['shipped-fedex'])   	? $details[0]['shipped-fedex'] 	: '';
                                                                ...
                                                                $trackingCode =  isset($details[0]['fedex_tracking_code'])   	? $details[0]['fedex_tracking_code']	: '';
                                                                $level =  isset($details[0]['fedex-service'])   	? $details[0]['fedex-service']	: '';
					...
					$ship_postal_code = '';  $ship_country = ''; $ship_phone_number = ''; $shipped_fedex = '';
                                        $shipping_level = '';
                                        $sku='';
			...
			<div>
					...
					<br/>
<div align="center">
<form name="" action="<?php echo config_item('base_url');?>admin/fedex/<?php echo $id; ?>" method="post" enctype="multipart/form-data" >
...
<table align="center" border="0" cellpadding="2">
    <tbody><tr>
        ...
        <?php if(empty($trackingCode)){ ?>
        <input type="submit" name="submit" value="Send to Fedex" style="width:170px;cursor:pointer;font-weight:bold;"></input>        
        <?php } ?>
        </td>
...
<table class="data-display" cellspacing="1"><tbody>
  ...
  <tr class="list-row">
    ...
    <td class="data-display-field" align="left" valign="middle" width="25%"><strong>Shipping Service:</strong>&nbsp;           <select class="commondropdown" name="shipped_fedex" id="shipped_fedex">
        ...
        <td class="data-display-field" align="left" valign="middle" width="25%">
            <strong>Tracking ID:</strong>&nbsp;<br><? echo $trackingCode; ?></a>
        </td>
...
<table class="data-display" cellspacing="1"><tbody>
  <tr class="list-row">
    <td class="data-display-field" valign="top" width="50%">
      ...
      <table class="data-display" cellpadding="0" cellspacing="0" width="100%"><tbody>
                <tr class="list-row">
                    <td class="data-display-field">
                        <strong> 
...
Hidden postage                        <br>
            ...
            <tr class="list-row">
                <td class="data-display-field">
                    ...
                    Thick Envelope/Small Package
                </td>
            </tr>

        <tr class="list-row">
          <td class="data-display-field" valign="top"><strong>Package Weight:</strong>
             <input type="text" value="" name="pweight" id="pweight" />
          </td>
