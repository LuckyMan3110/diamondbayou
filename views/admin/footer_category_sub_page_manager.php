    ...
    <div class="contentpanel"> 
      ...
      <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
          <h1><a href="<?php echo SITE_URL; ?>admin">Footer Sub Pages</a></h1>
                                        ...
                                        <?php $sl = 1;  
                                            if(is_array($get_category_list)){
                                             foreach ($get_category_list as $category) { 
                                                ...
                                                $where_cat_id   =  array('page_id' => $category->page_id);
                                                $sub_cat_name   =  $this->adminmodel->getdata_any_table_where($where_cat_id, 'content_man_page');
                                            ...
                                            <tr class="unread checked">
                                                ...
                                                <td class="hidden-xs">
                                                    <?= isset($sub_cat_name[0]->title)?$sub_cat_name[0]->title:'' ?>
                                                </td>
                                                <td>
                                                    <?= $category->status ?>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="<?= BASE_URL(); ?>footer_category_sub_page_manager/add?edit_page_id=<?= $category->sub_page_id ?>" class="btn btn-sm btn-warning warning_33"><span class="glyphicon glyphicon-pencil"></span> Edit </a>&nbsp;
                                                    <a href="<?= BASE_URL(); ?>footer_category_sub_page_manager?delete_page_id=<?= $category->sub_page_id ?>" class="btn btn-sm btn-success warning_3" onclick="return confirm('Are you want to delete this page?');"><span class="glyphicon glyphicon-trash"></span> Delete </a>
                                                </td>
                                            </tr>
