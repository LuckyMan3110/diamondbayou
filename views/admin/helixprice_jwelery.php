        ...
        <div class="blue_admin_box1">
          <div class="addcountry_box">
            ...
            <div class="search_box">
              <form name="helixprice" action="<?php echo config_item('base_url');?>admin/helixpriceJwelery/<?php echo $action; echo ($action == 'edit') ? '/' .$id : '';?>" method="post">
                  ...
                  <tr>
                    ...
                    <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
                      <dd id="account_name-element">
                        <input type="text" name="pricefrom" value="<?php echo $pricefrom;?>" maxlength="15" class="price" />
                        <?php echo form_error('pricefrom'); ?> </dd></td>
                  </tr>
                  <tr>
                    <td width="20%" align="right">Price To:</td>
                    <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
                      <dd id="account_name-element">
                        <input type="text" name="priceto" value="<?php echo $priceto;?>" maxlength="15" class="price" />
                        <?php echo form_error('priceto'); ?> </dd></td>
                  </tr>
                  <tr>
                    <td width="20%" align="right">Price Rate(%):</td>
                    <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
                      <dd id="account_name-element">
                        <input type="text" name="rate" value="<?php echo $rate;?>" maxlength="10" class="" />
                        <?php echo form_error('rate'); ?> </dd></td>
                  </tr>
                  <tr>
                    <td align="right">&nbsp;</td>
