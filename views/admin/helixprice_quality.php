        ...
        <div class="blue_admin_box1">
          <div class="addcountry_box">
            ...
            <div class="search_box">
              <form name="helixprice" action="<?php echo config_item('base_url');?>admin/helixpriceQuality/<?php echo $action; echo ($action == 'edit') ? '/' .$id : '';?>" method="post">
