...
<div class="blue_man">
   <div class="blue_admin_box1">			
      <div class="addcountry_box">
        <div class="heading">
          <h1>Manage Bulk Idex Diamonds import</h1>
        </div>
            <!-- Message Part -->
            <div style="width:100%;">
...
<form name="inventoryForm" action="<?php echo config_item('base_url');?>admin/ideximport" method="post" enctype="multipart/form-data">
