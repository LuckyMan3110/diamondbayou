  ...
  <div class="contentpanel">
    ...
    <div class="pull-left breadcrumb_admin clear_both">
      <div class="pull-left page_title theme_color">
        <h1>E-Commerce</h1>
        <h2 class="">Watches Bulk Upload</h2>
      </div>
      <div class="pull-right">
        <ol class="breadcrumb">
          <li><a href="<?php echo SITE_URL; ?>admin">Home</a></li>
          <li>Watches Bulk Upload</li>
        </ol>
      </div>
    </div>
    <div class="blue_man">
      <div class="blue_admin_box1">
        <div class="addcountry_box">
          ...
          <div class="search_box">
            <form name="inventoryForm" action="<?php echo config_item('base_url');?>admin/inventory" method="post" enctype="multipart/form-data">
