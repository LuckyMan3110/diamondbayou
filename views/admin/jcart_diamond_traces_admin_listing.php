				...
				<?php }else{ ?>
					...
					<div class="set_cate_options">
						...
						<select onchange="set_option_lists(this.value)" id="get_main_category_value">
							...
							<option value="990199" <?php if($filter_id_no == 990199){ echo 'selected'; } ?> >&nbsp;|-Halo</option>
							<option value="990299" <?php if($filter_id_no == 990299){ echo 'selected'; } ?> >&nbsp;|-Side Stone</option>
							<option value="990399" <?php if($filter_id_no == 990399){ echo 'selected'; } ?> >&nbsp;|-Three Stone</option>
							<option value="990499" <?php if($filter_id_no == 990499){ echo 'selected'; } ?> >&nbsp;|-Vintage</option>
						</select>
						<br>
					</div>
