				...
				<?php }else{ ?>
					...
					function set_option_sub_category_lists(){
						...
						$.ajax({
							type: 'post',
							dataType : 'html',
							url: '<?php echo base_url(); ?>jcart_fashion_jewelry/get_main_overmount_sub_category_list/?get_main_category_value='+get_main_category_value+'&get_filter_id_no='+get_filter_id_no,
					...
					<div class="set_cate_options">
						...
						<select onchange="set_option_sub_category_lists(this.value)" id="get_main_category_value">
							...
							<option value="740520282" <?php if($category_id == '740520282'){ echo 'selected'; } ?> >&nbsp;|-Bracelets</option>
							<option value="740520283" <?php if($category_id == '740520283'){ echo 'selected'; } ?> >&nbsp;|-Earrings</option>
							<option value="740520284" <?php if($category_id == '740520284'){ echo 'selected'; } ?> >&nbsp;|-Engagement Rings</option>
							<option value="740520285" <?php if($category_id == '740520285'){ echo 'selected'; } ?> >&nbsp;|-Necklaces</option>
							<option value="740520286" <?php if($category_id == '740520286'){ echo 'selected'; } ?> >&nbsp;|-Pendants-38967</option>
							<option value="740520287" <?php if($category_id == '740520287'){ echo 'selected'; } ?> >&nbsp;|-Wedding Bands</option>
						</select>
						<?php
