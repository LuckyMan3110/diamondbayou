...
<div class="set_cate_options">
    Select Category: <select onchange="set_option_lists(this.value)">
        ...
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/quality_gold_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520129?pc=tpj&cp=tpj2_2" <?php if($category_id == '740520129'){ echo 'selected'; } ?>>&nbsp;|-Chains</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/quality_gold_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520271?pc=tpj&cp=tpj2_2" <?php if($category_id == '740520271'){ echo 'selected'; } ?>>&nbsp;|-Pendants</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/quality_gold_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520211?pc=tpj&cp=tpj2_2" <?php if($category_id == '740520211'){ echo 'selected'; } ?>>&nbsp;|-Bracelets</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/quality_gold_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520272?pc=tpj&cp=tpj2_2" <?php if($category_id == '740520272'){ echo 'selected'; } ?>>&nbsp;|-Necklaces</option>
    </select>
</div>
