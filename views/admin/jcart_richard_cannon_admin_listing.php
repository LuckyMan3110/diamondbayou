			...
			<div>
				...
				<?php }else{ ?>
					...
					<div class="set_cate_options">
						...
						<select onchange="set_option_lists(this.value)" id="get_main_category_value">
							<option>Select Category</option>
							<option value="990199" <?php if($filter_id_no == 990199){ echo 'selected'; } ?> >&nbsp;|-Anklets</option>
							<option value="990299" <?php if($filter_id_no == 990299){ echo 'selected'; } ?> >&nbsp;|-Bangles</option>
							<option value="990399" <?php if($filter_id_no == 990399){ echo 'selected'; } ?> >&nbsp;|-Bracelets</option>
							<option value="990499" <?php if($filter_id_no == 990499){ echo 'selected'; } ?> >&nbsp;|-Chains</option>
							<option value="990599" <?php if($filter_id_no == 990599){ echo 'selected'; } ?> >&nbsp;|-Charms</option>
							<option value="990699" <?php if($filter_id_no == 990699){ echo 'selected'; } ?> >&nbsp;|-Earrings</option>
							<option value="990799" <?php if($filter_id_no == 990799){ echo 'selected'; } ?> >&nbsp;|-Necklaces</option>
							<option value="990899" <?php if($filter_id_no == 990899){ echo 'selected'; } ?> >&nbsp;|-Pendants</option>
							<option value="990999" <?php if($filter_id_no == 990999){ echo 'selected'; } ?> >&nbsp;|-Rings</option>
							<option value="991099" <?php if($filter_id_no == 991099){ echo 'selected'; } ?> >&nbsp;|-Toe Rings</option>
						</select>
						<br>
					</div>
