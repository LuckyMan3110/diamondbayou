	        		...
	        		<table width="100%"><tr><td valign="top">
												...
												<legend>Small Image</legend>
												 ...
												 <?php 
												    	...
												    	if( $small_img !='')echo '<img width="120" height="120" src="'.config_item('base_url').'images/rings/'.$small_img.'"><br />';
										...
										<td>
												...
												<legend>Carat Image</legend>
												 ...
												 <?php  {
												    	...
												    	if($carat_image !='')echo '<img width="120" height="120" src="'.config_item('base_url').'images/rings/carat'.$carat_image.'"><br />';
												    	else echo '<img src="'.config_item('base_url').'images/rings/noringimage.png"><br />';
