        ...
        <div class="blue_admin_box1">
          <div class="addcountry_box">
            ...
            <div class="search_box">
              <form name="loosediamondshape" action="<?php echo config_item('base_url');?>admin/loosediamondshapes/add" method="post" enctype="multipart/form-data" >
