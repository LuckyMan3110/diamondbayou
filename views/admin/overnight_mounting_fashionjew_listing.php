...
<!--<div class="set_cate_options">
    Select Category: <select onchange="set_option_lists(this.value)">
        <?php ///echo $category_list; ?>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/3291875018" <?php if($category_id == '3291875018'){ echo 'selected'; } ?> >&nbsp;|-Rings</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/3291962018" <?php if($category_id == '3291962018'){ echo 'selected'; } ?>>&nbsp;|-Chains</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/3292498018" <?php if($category_id == '3292498018'){ echo 'selected'; } ?>>&nbsp;|-Pendants</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/3292560018" <?php if($category_id == '3292560018'){ echo 'selected'; } ?>>&nbsp;|-Bracelets</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/3292577018" <?php if($category_id == '3292577018'){ echo 'selected'; } ?>>&nbsp;|-Earrings</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/3709041018" <?php if($category_id == '3709041018'){ echo 'selected'; } ?>>&nbsp;|-Shamballa</option>
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520033" <?php if($category_id == '740520033'){ echo 'selected'; } ?>>&nbsp;|-Cross Pendant</option>
    </select>
</div>-->
