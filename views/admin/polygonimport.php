<div class="inner"> 
  ...
  <div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
      <h1>E-commerce</h1>
      <h2 class="">Polygon Import</h2>
    </div>
    <div class="pull-right">
      <ol class="breadcrumb">
        <li><a href="<?php echo SITE_URL; ?>admin">Home</a></li>
        <li>Polygon Import</li>
      </ol>
    </div>
  </div>
  <div>
<div class="blue_man">
   <div class="blue_admin_box1">			
      <div class="addcountry_box">
        <div class="heading">
          <h1>Manage Bulk polygon diamonds import</h1>
        </div>
            <!-- Message Part -->
            <div style="width:100%;">
...
<form name="inventoryForm" action="<?php echo config_item('base_url');?>admin/polygonimport" method="post" enctype="multipart/form-data">
...
<tr>
	  ...
	  <td width="3%" align="left" valign="top"><dt id="edit-label">&nbsp;</dt><dd id="edit-element">
            <input type="submit" name="submit" id="edit" value="Upload" class="search_but"></dd>&nbsp;</td>
        ...
        <tr>
            ...
            <a href="<?php echo config_item('base_url');?>upload/template.csv" style="color:red;font-weight:bold;">Download Sample Template</a>
            </td>
        </tr>
</table>
