...
if(trim($cert) == 'GIA'){
  $title = $carat.' CT '.$shaper.' '.$color. ' '.$clarity.' DIAMOND ENGAGEMENT RING! '.$cert.'!';
  $certName = 'GIA';
}elseif(trim($cert) == 'EGL U') {
  $title  = $carat.' CT '.strtoupper($shape).' '.$color. ' '.$clarity.' DIAMOND ENGAGEMENT RING! EGL'.' '.$country.'!' ;
  $certName = 'EGL USA';
}else{
  $title = $carat.' CT '.strtoupper($shape).' '.$color. ' '.$clarity.' DIAMOND ENGAGEMENT RING! EGL'.'!';
  $certName = 'EGL';
}
...
<div class="blue_man">
   <div class="blue_admin_box1">			
      <div class="addcountry_box">
        <div class="heading">
          <h1>Add Rapnet Stones on Sears</h1>
        </div>
            <!-- Message Part -->
            <div style="width:100%;">
      ...
      <form name="rapnetForm" action="<?php echo config_item('base_url');?>admin/rapnetdmToSears/<?php echo $page_action.'/'.$id;?>" method="post" enctype="multipart/form-data" >
...
?>
<?php echo $shaper; ?>
        <input type="hidden" name="shape" value="<?php echo $shape;?>" maxlength="15" />        
            </dd>
      </td>
    </tr>  
        <tr>
...
<?php } ?>
     <tr>
      ...
      <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
        ...
        <input type="hidden" name="price" value="<?php echo addslashes($rapnet_price); ?>"  id="price" />
            </dd>
      </td>
    </tr>  
         <tr>
      ...
      <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
        ...
        <input type="hidden" name="price" value="<?php echo addslashes($ourdm_price); ?>"  id="price" />
            </dd>
      </td>
    </tr>  
         <tr>
      ...
      <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
        ...
        <input type="hidden" name="retail_price" value="<?php echo addslashes($retaildm_price); ?>"  id="price" />
            </dd>
      </td>
    </tr>  
         <!--<tr>
   ...
   <?php } ?> 
    ...
    <tr>
      ...
      <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
        ...
        <div style="float:left;"><img src="<?php echo $row['shapeimage']; ?>"  style="width:100px;height:100px;"  border="0" /><?php echo $shapeimg; ?></div>
        <input type="hidden" name="image2" value="<?php echo $row['shapeimage']; ?>" id="image2"  />
