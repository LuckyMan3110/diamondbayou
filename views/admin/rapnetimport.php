...
<div class="blue_man">
   <div class="blue_admin_box1">			
      <div class="addcountry_box">
        <div class="heading">
          <h1>Manage Bulk rapnet stone import</h1>
        </div>

            <div class="search_box">
            
<form name="inventoryForm" action="<?php echo config_item('base_url');?>admin/rapnetimport" method="post" enctype="multipart/form-data">
