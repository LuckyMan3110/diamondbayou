...
//$loose_diamond = ( !empty($details['fancy_color']) ? 'Fancy Loose Diamond!' : $clarity_enhance.'White Loose Diamond!' );
...
<!--         <tr>
      ...
      <td colspan="3"><dt id="account_name-label">&nbsp;</dt>
        <dd id="account_name-element">
        $ <?php echo number_format($retaildm_price,2) ;?>
        <input type="hidden" name="retail_price" value="<?php echo $retaildm_price; ?>"  id="retail_price" />
            </dd>
      </td>
    </tr>  -->
...
<p class="selectbkbg">
 ...
 <script>
     function set_option_sub_category_lists(){
        ...
        $.ajax({
            type: 'post',
            dataType : 'html',
            url: '<?php echo base_url(); ?>engagement_rings_fashion_jewelry/get_main_sub_category_list/?get_main_category_value='+get_main_category_value+'&get_filter_id_no='+get_filter_id_no,
 ...
 <script>
     function set_option_ringsMetal_lists(geVall){
        var product_name            = geVall;
        var ringsMetal              = $('#ringsMetal_'+geVall).val();
        $.ajax({
            type: 'post',
            dataType : 'html',
     ...
     function updateJitemPriceMW(geVall, pName){

        var product_name            = pName;
        var ringsMetal              = $('#ringsMetal_'+geVall).val();
        var ringsMetalPrice         = $('#jitem_ringsMetal_price_'+geVall).val();
        
        $.ajax({
            type: 'post',
            dataType : 'html',
            url: '<?php echo base_url(); ?>engagement_rings_fashion_jewelry/update_prive_retail_by_metal_wise/?product_name='+product_name+'&ringsMetal='+ringsMetal+'&ringsMetalPrice='+ringsMetalPrice,
            success: function (data) {
                // DO WHAT YOU WANT WITH THE RESPONSE
                //var result = data.split('|');
                //$("#price").val(result[0]);
...
<div class="set_cate_options">
    ...
    Select Main Category: <select onchange="set_option_sub_category_lists(this.value)" id="get_main_category_value">
        <option>Select Category</opton>
        
        <!--<option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/52" <?php if($category_id == '52'){ echo 'selected'; } ?> >&nbsp;|-Solitaire Engagement Rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/8" <?php if($category_id == '8'){ echo 'selected'; } ?> >&nbsp;|-Fancy Engagement Rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/40" <?php if($category_id == '40'){ echo 'selected'; } ?> >&nbsp;|-Halo Engagement Rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/39" <?php if($category_id == '39'){ echo 'selected'; } ?> >&nbsp;|-Antique Engagement Rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/179" <?php if($category_id == '179'){ echo 'selected'; } ?> >&nbsp;|-Petite Engagement rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/9" <?php if($category_id == '9'){ echo 'selected'; } ?> >&nbsp;|-Semi Mount Engagement rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/63" <?php if($category_id == '63'){ echo 'selected'; } ?> >&nbsp;|-Half Diamond Wedding Band</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/67" <?php if($category_id == '67'){ echo 'selected'; } ?> >&nbsp;|-Eternity Wedding Bands</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/74" <?php if($category_id == '74'){ echo 'selected'; } ?> >&nbsp;|-Mens Rings</option>
        <option value="<?php echo SITE_URL?>engagement_rings_fashion_jewelry/stuller_engagement_rings_listing/view/engagement_rings/<?php echo $filter_id_no; ?>/57" <?php if($category_id == '57'){ echo 'selected'; } ?> >&nbsp;|-Pendants</option>
    -->
        <option value="52" <?php if($category_id == '52'){ echo 'selected'; } ?> >&nbsp;|-Solitaire Engagement Rings</option>
        <option value="8" <?php if($category_id == '8'){ echo 'selected'; } ?> >&nbsp;|-Fancy Engagement Rings</option>
        <option value="40" <?php if($category_id == '40'){ echo 'selected'; } ?> >&nbsp;|-Halo Engagement Rings</option>
        <option value="39" <?php if($category_id == '39'){ echo 'selected'; } ?> >&nbsp;|-Antique Engagement Rings</option>
        <option value="179" <?php if($category_id == '179'){ echo 'selected'; } ?> >&nbsp;|-Petite Engagement rings</option>
        <option value="9" <?php if($category_id == '9'){ echo 'selected'; } ?> >&nbsp;|-Semi Mount Engagement rings</option>
        <option value="74" <?php if($category_id == '74'){ echo 'selected'; } ?> >&nbsp;|-Mens Rings</option>
        <option value="57" <?php if($category_id == '57'){ echo 'selected'; } ?> >&nbsp;|-Pendants</option>
        <option value="63" <?php if($category_id == '63'){ echo 'selected'; } ?> >&nbsp;|-Half Diamond Wedding Band</option>
        <option value="69" <?php if($category_id == '69'){ echo 'selected'; } ?> >&nbsp;|-Half Diamond  Band Sets</option>
        <option value="67" <?php if($category_id == '67'){ echo 'selected'; } ?> >&nbsp;|-Eternity Wedding Bands</option>
    </select>
    
    <?php
        //set_option_sub_category_lists
    ...
    ?>
     ...
     Select Sub Category: <select onchange="set_option_lists(this.value)" id="show_sub_category_value">
         <option>Select Category</opton>
         <?php if(is_array($where_main_cat) AND !empty($category_id) ){
             foreach($where_main_cat as $main_cat){
                 if( !empty($main_cat->category_name) AND $category_id == $main_cat->parent_id ){
         
         ?>
                <option value="<?= $main_cat->category_id ?>" <?php if($main_cat->category_id == $item_sub_category){ echo 'selected'; } ?>> <?= $main_cat->category_name ?> </opton>   
         <?php 
                 }
            }
         } ?>         
...
<div class="ebayExportResponse"></div>
    ...
    <!--<form name="rapnetstones" method="post" action="<?= SITE_URL() ?>jcartw_fashion_jewelry_admin/jcartw_fashion_jewelry_send_etsy/stuller_items_detail/" enctype="multipart/form-data" id="rapnetstones">
...
<!--<form id="cashlimit_form_sears" action="" method="post" name="cashlimit_form_sears" class="sendform">
Cash Limit:
