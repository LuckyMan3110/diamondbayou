...
<div class="search_box">
    <h1>Send Collection Item To eBay</h1>
     <?php echo $return_msg; ?>
        <form name="itemjewleryform" action="<?php echo SITE_URL; ?>send_stuller_fashionjew_item_toebay/send_stuller_jewelry_toebay/" method="post" enctype="multipart/form-data">
        <dl class="zend_form">
        </dl>
        <table width="80%" border="0" align="center" cellpadding="5" cellspacing="0" class="table_border">
          ...
          <tr>
            ...
            <td colspan="3"><?php echo $rowsring['MerchandisingCategory3']; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="3%" align="left" valign="top"><dt id="edit-label">&nbsp;</dt>
              <dd id="edit-element">
                  ...
                  <input type="hidden" name="ring_title" value="<?php echo $ringtitle; ?>" />
                  <input type="hidden" name="ring_cate_id" value="<?php echo $rowsring['MerchandisingCategory3']; ?>" />
