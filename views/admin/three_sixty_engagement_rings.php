...
<div class="set_cate_options">
    Select Category: <select onchange="set_option_lists(this.value)">
        ...
        <option value="<?= SITE_URL() ?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520120?pc=mpb&cp=mpb1" <?php if($category_id == '740520120'){ echo 'selected'; } ?> >&nbsp;|-Rings</option>
    </select>
</div>
