        ...
        <div class="blue_admin_box1">
          <div class="addcountry_box">
            ...
            <div class="search_box">
              <form name="qualityform" action="<?php echo config_item('base_url');?>admin/uniquesettings/<?php echo $action; echo ($action == 'edit') ? '/' .$id : '';?>" method="post" enctype="multipart/form-data" >
                <dl class="zend_form">
                </dl>
