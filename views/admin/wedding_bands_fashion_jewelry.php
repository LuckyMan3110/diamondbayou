 ...
 <script>
     function set_option_sub_category_lists(){
        ...
        $.ajax({
            type: 'post',
            dataType : 'html',
            url: '<?php echo base_url(); ?>jcart_fashion_jewelry/get_main_sub_category_list/?get_main_category_value='+get_main_category_value+'&get_filter_id_no='+get_filter_id_no,
...
<div class="set_cate_options">
    ...
    Select Main Category: <select onchange="set_option_sub_category_lists(this.value)" id="get_main_category_value">
        ...
        <!--<option value="740520282" <?php if($category_id == '740520282'){ echo 'selected'; } ?> >&nbsp;|-Rings</option>
        <option value="40520283" <?php if($category_id == '740520283'){ echo 'selected'; } ?> >&nbsp;|-CHARM</option>
        <option value="740520285" <?php if($category_id == '740520285'){ echo 'selected'; } ?> >&nbsp;|-EARRINGS</option>
        <option value="740520286" <?php if($category_id == '740520286'){ echo 'selected'; } ?> >&nbsp;|-PENDANT</option>
        <option value="740520287" <?php if($category_id == '740520287'){ echo 'selected'; } ?> >&nbsp;|-NECKLACE</option>
        <option value="740520288" <?php if($category_id == '740520288'){ echo 'selected'; } ?> >&nbsp;|-BRACELET</option>
        <option value="740520289" <?php if($category_id == '740520289'){ echo 'selected'; } ?> >&nbsp;|-PIN</option>
        <option value="740520290" <?php if($category_id == '740520290'){ echo 'selected'; } ?> >&nbsp;|-LOOSE STONES</option>
        <option value="740520291" <?php if($category_id == '740520291'){ echo 'selected'; } ?> >&nbsp;|-CHAIN</option>
        <option value="740520292" <?php if($category_id == '740520292'){ echo 'selected'; } ?> >&nbsp;|-WATCH</option>
        <option value="740520293" <?php if($category_id == '740520293'){ echo 'selected'; } ?> >&nbsp;|-GENTS</option>
        <option value="740520294" <?php if($category_id == '740520294'){ echo 'selected'; } ?> >&nbsp;|-BULK</option>-->
    ...
    ?>
     ...
     Select Sub Category: <select onchange="set_option_lists(this.value)" id="show_sub_category_value">
        ...
        <!--<option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520282" <?php if($category_id == '740520282'){ echo 'selected'; } ?> >&nbsp;|-Rings</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520283" <?php if($category_id == '740520283'){ echo 'selected'; } ?> >&nbsp;|-CHARM</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520285" <?php if($category_id == '740520285'){ echo 'selected'; } ?> >&nbsp;|-EARRINGS</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520286" <?php if($category_id == '740520286'){ echo 'selected'; } ?> >&nbsp;|-PENDANT</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520287" <?php if($category_id == '740520287'){ echo 'selected'; } ?> >&nbsp;|-NECKLACE</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520288" <?php if($category_id == '740520288'){ echo 'selected'; } ?> >&nbsp;|-BRACELET</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520289" <?php if($category_id == '740520289'){ echo 'selected'; } ?> >&nbsp;|-PIN</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520290" <?php if($category_id == '740520290'){ echo 'selected'; } ?> >&nbsp;|-LOOSE STONES</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520291" <?php if($category_id == '740520291'){ echo 'selected'; } ?> >&nbsp;|-CHAIN</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520292" <?php if($category_id == '740520292'){ echo 'selected'; } ?> >&nbsp;|-WATCH</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520293" <?php if($category_id == '740520293'){ echo 'selected'; } ?> >&nbsp;|-GENTS</option>
        <option value="<?php echo SITE_URL?>jcart_fashion_jewelry/stuller_fashionjew_listing/view/jewelercart/<?php echo $filter_id_no; ?>/740520294" <?php if($category_id == '740520294'){ echo 'selected'; } ?> >&nbsp;|-BULK</option>-->
