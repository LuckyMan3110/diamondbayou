		...
		<div id="mainpage_content">
			<div class="header_bk">
				<div class="mainft_wraper">
					<div class="logo_bk"> <a href="http://jewelercart.com/"><img src="<?php echo SITE_WHURL; ?>trial_header_logo.jpg" alt="Free Trial" /></a> </div>
					<div class="contact_bk"> 
						<span class="contact_ic"><img src="<?php echo SITE_WHURL; ?>contact_icft.png" alt="Sales" /> Sales: 404 596 8912</span> 
						<span class="contact_ic"><img src="<?php echo SITE_WHURL; ?>contact_icft.png" alt="Support" />  Support: 404 596 8912</span>
					</div>
					<div class="clear"></div>
				</div>
			</div>
			...
			<div class="footer_ftbk">
				<div class="mainft_wraper"><br>
					...
					<div>"Amazing to see how Jewelercart Manages thousands of<br> diamonds in Ebay"</div><br><br>
					...
					<div class="copy_rights">&copy;2002-2014 Jeweler Cart Diamond Software. All Rights Reserved. eBay and Amazon Inventory and Listing Solution.</div><br><br>
				</div>
			</div>
		</div>
	</body>
