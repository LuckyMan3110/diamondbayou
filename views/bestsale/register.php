...
<!--                    <div class="textLeft" style="width:180px;">Already have an <span>Account?<br /><a href="<?php echo config_item('base_url') ?>account/membersignin">Sign in</a></span></div>-->
                    <div class="signInNowButton" style="width:153px; margin-bottom: 5px;"><a href="javascript:void(0);" onclick="document.register.submit();" ><img src="<?php echo config_item('base_url') ?>img/create-account.jpg" alt="" border="0" /></a></div>
                </div>
            </div>
        </form>
