<link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/global-style-min.css" type="text/css">
<link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/common-style-min.css" type="text/css">
<link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/engagement-rings.css" type="text/css">
<link rel="stylesheet" href="<?php echo SITE_URL; ?>assets/css/engagement-rings-mobile.min.css" type="text/css">
...
<link rel="stylesheet" href="//css.brilliantearth.com/static/css/slick.css">
...
<div class="footer_sectionbg">
	<div class="container">
		...
		<div class="col-sm-2 float-left">
			...
			<ul>
				<li><a href="<?php echo SITE_URL; ?>payment-billing">Payment &amp; Billing</a></li>
				<li><a href="<?php echo SITE_URL; ?>privacy-cookies">Privacy Policy</a></li>
				<li><a href="<?php echo SITE_URL; ?>return-and-exchanges">Return Policy</a></li>
		...
		<div class="col-sm-2 float-left">
			...
			<ul class="footer-comblock">
				...
				<li><a href="<?php echo SITE_URL; ?>shipping-services">Shipping</a></li>
