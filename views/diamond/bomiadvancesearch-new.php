<link href="<?php echo SITE_URL; ?>css/diamond_search_style.css?v=0.4" type="text/css" rel="stylesheet" />
<style type="text/css">
<?php
...
<style>
#con {margin: 28px 0 0 -86px!important;}
</style>
<?php endif; ?>
<script>        
...
$(document).ready(function () {
	...
	setTimeout(get_diamond_shape, 3000);
});
</script>
<style>
...
<div>
			...
			<div class="sliderFilters row-fluid">
				...
				<div class="filterCols col-sm-4">
					<div class="sliderSetRow">
						<div><label>Price</label> <img src="<?php echo UNITED_IMGSV; ?>quest_mark.jpg" alt="quest_mark"> <small>Press Enter After Typing Price.</small> </div>
						<table class="optionList">
							<tr>
								<td colspan="2">
									...
									<div class="maxCt max_price_cols">
				...
				<div class="filterCols col-sm-4">
					<div class="sliderSetRow">
						<div><label>Carat</label> <img src="<?php echo UNITED_IMGSV; ?>quest_mark.jpg" alt="quest_mark"> <small>Press Enter After Typing Carat.</small> </div>
						<div>
							<table class="optionList">
								<tr>
									<td colspan="2">
										<div class="minPr">
											<?php echo '<input type="text" value="0.07" name="caratmin" id="caratmin" class="carat_max" />'; ?>
										</div>
										<div class="maxCt">
											<?php echo '<input type="text" value="15" name="caratmax" id="caratmax" class="carat_max" />'; ?>
										</div>
										<div class="clear"></div>
									</td>
								</tr>
				...
				<div id="advanced_search">
					<div class="viewadvance_options">
												...
												<div class="toggle_box_bk">
													<div class="toggle btn btn-default off polish_slider on_off_size" onclick="show_on_off('polish_slider'); remove_slider_bgclass('polish_slider'); show_diamond_cols('8')" data-toggle="toggle">
														<div class="toggle btn btn-danger on_off_size" data-toggle="toggle">
															<input type="checkbox" checked="" onclick="showhiderow('polish','polishrow', 'polis',0,4,8)" data-toggle="toggle" data-width="40" data-height="20px" data-onstyle="danger">
													...
													<div class="toggle btn btn-danger polish_slider on_off_size hide_block" onclick="show_on_off('polish_slider');  add_slider_bgclass('polish_slider'); hide_diamond_cols('polis',0,4,'hide')" data-toggle="toggle">
														<div class="toggle btn btn-danger on_off_size" data-toggle="toggle">
															<input type="checkbox" checked="" data-toggle="toggle" onclick="showhiderow('polish','polishrow', 'polis',0,4,8)" data-width="40" data-height="20px" data-onstyle="danger">
															<div class="toggle-group">
																<label class="btn btn-danger toggle-on">On</label><label class="btn btn-default active toggle-off">Off</label>
																<span class="toggle-handle btn btn-default"></span>
															</div>
							...
							<div id="symmetryrow" class="filterCols col-sm-4 set_filter_margin hide_block">
								<div>
									<table>
										<tr>
											<td colspan="2">
												<span class="advance_filter_lable">Symmetry</span>
												<?php echo on_off_features('symtry_slider', 'symmet',0,4,9); ?>
											</td>
										</tr>              
										<tr>
											<td colspan="2">
							...
							<div id="depthrow" class="filterCols col-sm-4 set_filter_margin hide_block">
								<div>
									<table>
										<tr>
											<td colspan="2">
												<span class="advance_filter_lable set_filter_label">Depth</span>
												<?php echo on_off_features('depth_vslider','depth',0,100,10); ?>
											</td>
										</tr>
										<tr>
											<td align="left">
												<input type="text" value="<?php echo $min_depth?>" id="depth_minx" class="w50px left_min" >
											</td>
											<td align="right">
												<input type="text" value="<?php echo $max_depth?>" id="depth_maxs" class="w50px right_max" >
											</td>
										</tr>
										<tr>
											<td colspan="2">
							...
							<div id="tablerow" class="filterCols col-sm-4 set_filter_margin hide_block">
								<div>
									<table>
										<tr>
											<td colspan="2">
												<span class="advance_filter_lable set_filter_label">Table</span>
												<?php echo on_off_features('table_vslider','table',0,100,11); ?>
											</td>
										</tr>
										<tr>
											<td align="left">
												<input type="text" value="<?php echo $min_table?>" id="table_mins" class="w50px left_min" >
											</td>
											<td align="right">
												<input type="text" value="<?php echo $max_table?>" id="table_maxs" class="w50px right_max">
											</td>
										</tr>
										<tr>
											<td colspan="2">
							...
							<div id="flurorow" class="filterCols col-sm-4 set_filter_margin hide_block">
								<div>
									<table class="slideUprTable">
										<tr>
											<td colspan="2">
												<span class="advance_filter_lable">Fluorescence</span>
												<?php echo on_off_features('floursence_slider','fluro',0,4,15); ?>
											</td>
										</tr>
										<tr>
											<td colspan="2">
						...
						<div class="advancedOptions hide_block">
							...
							<a href="" onclick="clearsessions()"><span class="cler_filter">Clear Filter</span></a>
						</div>
						<div class="clear"></div>
					</div>
				</div>
	...
	<div class="searchBox row-fluid">
		<div class="col-sm-9 diamondbg_block">
			...
			<form name="diamondList" id="diamondList" method="post">
				<div>
					<td valign="top">
						<table id="searchresult" class="set_diamond_table"></table>
					</td>
				</div>
			</form>
			<div class="clear"></div>
			...
			<div class="compare_section">
				...
				<form name="comprForm" id="comprForm" method="post" action="">
					<div class="rmall_st">
						<label for="remov_all">Remove ALL &nbsp;</label>
	...
	<div class="clear"></div>
	<script src="<?php echo SITE_URL; ?>js/noslider_js_function123767.js?v=0.2"></script>
	<script>
	...
	<div id="ds_details_tip12" class="set_diamond_dtabs">
		<div id="ds_details_content" class="ds_details_content">
			<div>
				...
				<div id="detail_sku" class="ds_detail_item">
					<span class="label">Stock Number: </span><br />
					<span class="value" id="dstkn">1333776403</span>
				</div>
