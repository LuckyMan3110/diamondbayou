...
<div class="floatl pad05 body">
  ...
  <div class="bodymid">
      ...
      <?php $action = ($addoption == '' || $settingsid == '') ? config_item('base_url').'index.php/diamonds/Dlsearch/true' : config_item('base_url').'diamonds/Dlsearch/true/false/'.$addoption.'/false/'.$settingsid;?>
      ...
      <form action="<?php echo $action;?>" method="POST">
		      ...
		      <div>
		            ...
		            <br>
		            <span class="floatl">
		            	Price From <input type="text" name="minprice" id='minprice' value="200<?php // echo round($minprice);?>" class="w100px price" maxlength="9" onchange="checkMinMaxPrice(this,'maxprice',<?php echo $minprice, ",",$maxprice.",'min'";?>)">-to-<input type="text" name="maxprice" id="maxprice" value="<?php echo round($maxprice); ?>" class="w100px price" maxlength="9" onchange="checkMinMaxPrice(this,'minprice',<?php echo $minprice, ",",$maxprice.",'max'";?>)">
		            </span>
		            <span class="floatl">
		            	<span> we have over <b><?php echo (number_format($totaldiamond)); ?> diamonds</b> ranging in price from $200<?php // echo number_format($minprice); ?> to $<?php echo number_format($maxprice); ?></span>
		            </span>
		             <div class="clear"></div>
		      </div>
