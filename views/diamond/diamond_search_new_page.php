        ...
        <div class="inner_container">
            ...
            <ul class="diamond_shapes">
                <?php
                    ...
                    foreach( $shapes_list as $shkey => $keyvalue) {
                        if( $shape_value == $shkey || $shape_value == 'false' ) {
            ...
            <div class="sliderFilters row-fluid">
                <div class="filterCols col-sm-4">
                    <div class="pull-left"><label>Shape</label><img src="<?php echo UNITED_IMGSV; ?>quest_mark.jpg" alt=""></div>
                ...
                foreach($smallShape as $sshap => $shimage) {
                    if( $shape_value == $sshap || $shape_value == 'false' ) {
                    $imgOverIcon = str_replace('_sic', '_sic_ov', $shimage);
                        ...
                        $smalShapeList .= '<li id="'.$sshap.'" '.$active_class.'><a class="'.$keyvalue[0].'" href="#javascript;" onclick="setDiamdShape(\''.$sshap.'\', \''.$shimage.'\', \''.$imgOverIcon.'\')" title="'.view_shape_value($dmShape, $sshap).'"><img src="'.UNITED_IMGSV.$setShapeImage.'" alt="" /></a></li>';
                    }
                }
                   echo $smalShapeList; 
                        ?>
...
<!--                        <table class="setColrTable">
                ...
                <div class="filterCols col-sm-4">
                    <div class="sliderSetRow">
                    <div><label>Carat</label> <img src="<?php echo UNITED_IMGSV; ?>quest_mark.jpg" alt="quest_mark"></div>
                    <div>
                        <table class="optionList">
                        <tr>
