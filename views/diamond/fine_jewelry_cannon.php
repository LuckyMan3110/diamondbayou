	...
	<div class="header-description-wrapper--Lksq6">
		...
		<div style="display:flex;align-items:center;flex-direction:column;max-width:1280px;min-width:960px">
			<div style="display:flex">
				<div data-qa="Earrings" class="buttonContainer--3pdft">
				...
				<div data-qa="Necklaces" class="buttonContainer--3pdft">
				...
				<div data-qa="Bracelets" class="buttonContainer--3pdft">
				...
				<div data-qa="Rings" class="buttonContainer--3pdft">
...
$( document ).ready(function() {
	var dataTable = $('#ring_grid').DataTable({
		...
		"ajax":{
			url :"<?php echo SITE_URL; ?>diamonds/fine_jewelry_cannon_realtime/",
			type: "post",
			'data' : function(data){
				/* Amount */
