...
?>
<input type="hidden" class="category" id="category" value="Bracelets" <?php if($srchShape == 'bracelets'){ echo 'checked="checked"'; } ?>>
<input type="hidden" class="category" id="category" value="Earrings" <?php if($srchShape == 'earrings'){ echo 'checked="checked"'; } ?>>
<input type="hidden" class="category" id="category" value="Necklaces" <?php if($srchShape == 'necklaces'){ echo 'checked="checked"'; } ?>>
<input type="hidden" class="category" id="category" value="Pendants" <?php if($srchShape == 'pendants'){ echo 'checked="checked"'; } ?>>
<input type="hidden" class="category" id="category" value="Wedding Bands" <?php if($srchShape == 'wedding-o-bands'){ echo 'checked="checked"'; } ?>>
<!-- Datatable CSS -->
		...
		<div style="display:flex;align-items:center;flex-direction:column;max-width:1280px;min-width:960px">
			<div style="display:flex">
				...
				<div data-qa="necklaces_filter-fine_jewelry" class="buttonContainer--3pdft">
					...
					<input type="hidden" class="category" id="category" value="Necklaces" <?php if($srchShape == 'necklacesNpendants'){ echo 'checked="checked"'; } ?>>
				</div>
				...
				<div data-qa="rings_filter-fine_jewelry" class="buttonContainer--3pdft">
					...
					<input type="hidden" class="category" id="category" value="Rings" <?php if($srchShape == 'rings'){ echo 'checked="checked"'; } ?>>
				</div>
			</div>
...
$( document ).ready(function() {
	var dataTable = $('#ring_grid').DataTable({
		...
		"ajax":{
			url :"<?php echo SITE_URL; ?>diamonds/fine_jewelry_oneil_realtime/",
			type: "post",
			'data' : function(data){
				/* Amount */
