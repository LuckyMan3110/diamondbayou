				...
				<div class="product-tabs">
					<div class="product-tabs__content">
						<div class="products-list product-tabs__pane is--active">
							<?php /* <div class="product-listing__header">
								<div class="product-listing__text"><strong><?= $totalCount?></strong> Items found for <strong><?php echo $searchField; ?></strong></div>
								<div class="product-listing__sorting">
									<label>Sort</label>
									<select class="selectbox sort_by" id="sort_by">
										<option disabled="">Sort by</option>
										<option value="onlineDate_sortable_date_Descending">Newest Arrivals</option>
										<option value="nowPriceValue_usd_double_Ascending">Price Low to High</option>
										<option value="nowPriceValue_usd_double_Descending">Price High to Low</option>
									</select>
								</div>
								<button type="button" class="product-filters-toggle">Filter By</button>
							</div> */ ?>
