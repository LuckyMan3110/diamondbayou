...
<div class="floatl pad05">
	  	...
	  	<div class="bodymid2">
		  			...
		  			<div class="column floatl">
			  				...
			  				<p>(<small><i>including both diamonds</i></small>)</p>
		  			</div>
		  			<div class="column floatl">
			  				<img src="<?php echo config_item('base_url');?>images/tamal/choose_02.jpg" alt="choose_02">
			  				<div class="floatl">
			  	      				<div class="floatl blurleft"></div>
			  	      				<div class="floatl bluemiddle"><a href="<?php echo $hyperlink;?>" onclick="<?php echo ($hyperlink == '##') ? $onclickfunction : '';?>">Add Side Stones to ring</a></div>
			  	      				<div class="floatl blueright"></div>
			  	      				<div class="clear"></div>
		  	      			</div>
		  	      			<div class="floatl" style="float:none; margin-top:5px; text-align:center; clear:left; padding-left:28px">
		  			...
		  			?>
		  				...
		  				<table width="500px" style="border-collapse: separate;">
                            ...
                            <tr class="brownback">
		  						<td>Cert:</td>
		  						<td><?php echo $sidestone1['Cert']?></td>
		  						<td><?php echo $sidestone2['Cert']?></td>
		  					</tr>
		  					<tr class="brownback">
		  						<td>Color:</td>
