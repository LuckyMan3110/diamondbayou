    ...
    <section class="main_content_bg">
        <div class="container set_col_pading">
            <div class="col-sm-4 result_page_left">
                ...
                $incree = 1;
                $make_dynamic_main_fields	=  $this->diamondmodel->getdata_any_table_distinct_order_where('mall_elady_products', array('product_category'=>'Watches'), 'product_category', 'id');
                ...
                <div class="filter_block_section" style="display:;">
                    ...
                    $make_dynamic_fields	=  $this->diamondmodel->getdata_any_table_distinct_order_where('mall_elady_products', array('product_category'=>$metal_name), 'product_sub_category', 'id');
...
$( document ).ready(function() {
    ...
    var dataTable = $('#diamond_grid').DataTable({
        ...
        "ajax":{
          url :"<?php echo SITE_URL; ?>diamonds/watch_diamond_realtime/",
          type: "post",
          'data' : function(data){
