...
<!--<div class="diamond_inner_tabs">
    ...
    <div class="col-sm-2 inner_tabs_hover set_last_tabs inner_tabs_active">
        Watches<br>&nbsp;
    </div>
    </a>
    <div class="clear"></div>
...
<div class="mainwrap">
        <div class="inner_container">
            ...
            <style>
                .set_drop_downbox { height: 40px; }
                .watches_block{ margin-top: 30px; }
            </style>
            
            
            <div class="text-left watches_block">
                <div class="set_slide_rows set_bottom_line">
                    <div class="col-sm-6">
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Band Color</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Gender</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label set_lablewidth">Case Material</div>
                        <div class="slider_set_view set_box_wdith">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Movement</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Style</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Condition</div>
                        <div class="slider_set_view set_color_field">
                            <ul>
                                <li>New</li>
                                <li>Used</li>
                                <li>Not Specified</li>
                ...
                <div class="col-sm-6 set_col_padding">
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Case Color</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Display</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label set_lablewidth">Band Material</div>
                        <div class="slider_set_view set_box_wdith">
                            <select name="" class="set_drop_downbox">
                                <option value="">Stainless Steel</option>
                            </select>
                    ...
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Brand</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                    ...
                    <div class="sliders_row set_subslider_width">
                        ...
                        <table width="97%" style="margin-top: 20px;">
                            <tr>
                ...
                <div class="col-sm-6">
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label set_lablewidth">Delivery Options</div>
                        <div class="slider_set_view set_box_wdith">
                            <select name="" class="set_drop_downbox">
                ...
                <div class="col-sm-6">
                    <div class="sliders_row set_subslider_width">
                        <div class="slider_label">Show Only</div>
                        <div class="slider_set_view">
                            <select name="" class="set_drop_downbox">
                                <option value="">Returns Accepted</option>
                            </select>
                            <div class="clear"></div>
                        </div>
                        <div class="clear"></div>
            ...
            <div class="shapes_section diamond-shape" style="display:none;">
            ...
            <div class="sliderFilters row-fluid">
                ...
                <div class="filterCols col-sm-12">
                    ...
                    <table width="100%" style="margin-top: 30px;display:none;">
                        <tr>
