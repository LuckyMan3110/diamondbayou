...
<!--<div class="diamond_inner_tabs">
    <a href="<?php echo SITE_URL; ?>diamonds/search/true/0/0/0/0/white-diamond/" style="color:#000;font-size: 14px;">
        <div class="col-sm-2 inner_tabs_hover">
            White <br>Diamond
        </div>
    </a>
    <a href="<?php echo SITE_URL; ?>diamonds/search/true/0/0/0/0/colored-diamond/" style="color:#000;font-size: 14px;">
    <div class="col-sm-2 inner_tabs_hover">
        Colored <br>Diamond
    </div>
    </a>
    <a href="<?php echo SITE_URL; ?>" style="color:#000;font-size: 14px;">
    <div class="col-sm-2 inner_tabs_hover inner_tabs_active">
        Clarity Enhanced <br>Diamond
    </div>
    </a>
    <a href="<?php echo SITE_URL; ?>diamonds/search/true/0/0/0/0/black-hills-gold/" style="color:#000;font-size: 14px;">
    <div class="col-sm-2 inner_tabs_hover">
        Black Hills <br>Gold
    </div>
    </a>
    <a href="<?php echo SITE_URL; ?>diamonds/search/true/0/0/0/0/solitaires-and-halos/" style="color:#000;font-size: 14px;">
    <div class="col-sm-2 inner_tabs_hover">
        Solitaires and <br>Halos
    </div>
    </a>
    <a href="<?php echo SITE_URL; ?>diamonds/search/true/0/0/0/0/watches/" style="color:#000;font-size: 14px;">
    <div class="col-sm-2 inner_tabs_hover set_last_tabs">
        Watches<br>&nbsp;
    </div>
    </a>
    <div class="clear"></div>
...
<div class="mainwrap">
        <div class="inner_container">
                ...
                <ul class="set_diamond_shapes_list">
                    <?php
                        $shape_list = array(
                            ...
                            /*'OM'=>array('nine','heart', 'heart_sic', 'old_mine_sh_ic.jpg', 'Old Mine'),
                            'EP'=>array('nine','heart', 'heart_sic', 'european_sh_ic.jpg', 'European'),
                            'FL'=>array('nine','heart', 'heart_sic', 'flanders_sh_ic.jpg', 'Flanders'),
                            'TR'=>array('nine','heart', 'heart_sic', 'trilliant_sh_ic.jpg', 'Trilliant')*/
                            
                            /*'Round' => 'round_sh_ic.jpg',
                            'Princess' => 'princess_sh_ic.jpg',
                            'Emerald' => 'emerald_sh_ic.jpg',
                            'Oval' => 'oval_sh_ic.jpg',
                            'Marquise' => 'marquise_sh_ic.jpg',
                            'Pear' => 'pear_sh_ic.jpg',
                            'Asscher' => 'asscher_sh_ic.jpg',
                            'Cushion' => 'cushion_sh_ic.jpg',
                            'Old Mine' => 'old_mine_sh_ic.jpg',
                            'European' => 'european_sh_ic.jpg',
                            'Flanders' => 'flanders_sh_ic.jpg',
                            'Radiant' => 'radiant_sh_ic.jpg',
                            'Heart' => 'heart_sh_ic.jpg',
                            'Trilliant' => 'trilliant_sh_ic.jpg'*/
                        );
                        
                        //echo '<pre>'; print_r($shape_list); exit();

                        $shape_view_list = '';
                        foreach ( $shape_list  as $shkey => $keyvalue ) {
                            
                            /*$shape_view_list .= '<li><a href="#"><img src="'.SITE_URL.'assets/site_images/'.$shape_img.'" alt="'.$shape_label.'" />'
                                    . '<br><span>'.$shape_label.'</span></a></li>';*/
                            
                            $diamond_shape = view_shape_value($shapeimg, $shkey);
                            $imgeOverIcon = str_replace('_sic', '_sic_ov', $keyvalue[2]);
                            $active_class = ( $i == 1 ? 'class=""' : '' );
                            
                            $shape_view_list .= '<li id="'.$shkey.'" '.$active_class.' onclick="setDiamdShape(\''.$shkey.'\', \''.$keyvalue[2].'.jpg\', \''.$imgeOverIcon.'.jpg\')">
                                            <div><a href="#javascript"><img src="'.SITE_URL.'assets/site_images/'.$keyvalue[3].'" alt="'.$diamond_shape.'" /></a></div>
            ...
            <div class="sliderFilters row-fluid">
                <div class="filterCols col-sm-12" style="display:none;">
                ...
                <div class="filterCols col-sm-12">
                    
                    <div class="sliderSetRow">
                        <table width="100%">
                            <tr>
                                <td width="20%" style="vertical-align: top;"><label>Carat</label></td>
                    ...
                    <div class="sliderSetRow">
                        ...
                        <table width="100%">
                            <tr>
                                <td width="20%" style="vertical-align: top;"><label>Clarity</label></td>
                                <td width="80%" style="vertical-align: top;"> 
                                
                                    <ul id="clarity_li_list" class="cutslider_lines clarityslide_lines">
                                        <li></li>
                                        <li></li>
                                        <li></li>
                                        <li></li>
                                    ...
                                    <div>
                                        <table id="clarity_table_list" style="width:100%;">
                                        <tr>
                                          <td>I1</td>
                                          <td>SI3</td>
                                          <td>SI2</td>
                ...
                <div class="filterCols col-sm-12">
                    ...
                    <table width="100%" style="margin-top:5px;">
                        <tr>
                            <td width="20%" style="vertical-align: top;"><label>Color</label></td>
                            <td width="80%" style="vertical-align: top;"> 
                            
                                <!--<ul id="color_slide_li_list" class="cutslider_lines colorslide_lines">
                                    <li></li>
                                    <li></li>
                                    <li></li>
                                    <li></li>
                                ...
                                <div id="colrs_slider" style="display:none;"></div>
                    ...
                    <table width="100%" style="margin-top:30px;">
                        <tr>
                            <td width="20%" style="vertical-align: top;"><label>Cut</label></td>
                            <td width="80%" style="vertical-align: top;">
                                <!--<ul class="cutslider_lines" style="display:none;">
                                    <li class="set_cut_margin"></li>
                                    <li></li>
                                    <li></li>
                                </ul>-->
                                <div  style="display:none;" id="cutv_slider"></div>
                            
                                <!--<div class="setSliderBlock">
                                    <table id="cut_table_list" style="width:100%;">
                                        <tr>						   	  				
                                            <td>Good</td>
                                            <td>Very Good</td>
                                            <td>Excellent</td>
                ...
                <div class="filterCols col-sm-12">
                    ...
                    <table width="100%" style="margin-top: 20px;">
                        <tr>
                            <td width="20%" style="vertical-align: top;"><label>Price</label></td>
                            <td width="80%" style="vertical-align: top;"> 
            ...
            <div class="filter_blocs">
                ...
                <div  id="advanced_search">
                    <div class="viewadvance_options" style="display:none;">
      <div id="advancesearch">
          <div id="polishrow" class="filterCols col-sm-4 set_filter_margin hide_block">
          <div>
            <table>
              <tr>
                <td colspan="2">
                    ...
                    <div class="toggle_box_bk">
                        <div class="toggle btn btn-default off polish_slider on_off_size" onclick="show_on_off('polish_slider'); remove_slider_bgclass('polish_slider'); show_diamond_cols('8')" data-toggle="toggle">
                        ...
                        <div class="toggle btn btn-danger polish_slider on_off_size hide_block" onclick="show_on_off('polish_slider');  add_slider_bgclass('polish_slider'); hide_diamond_cols('polis',0,4,'hide')" data-toggle="toggle">
                            <div class="toggle btn btn-danger on_off_size" data-toggle="toggle">
...
<!--                      <td>F</td>-->
        ...
        <div id="symmetryrow" class="filterCols col-sm-4 set_filter_margin hide_block">
          <div>
            <table>
              <tr>
...
<!--                      <td>F</td>-->
        ...
        <div id="depthrow" class="filterCols col-sm-4 set_filter_margin hide_block">
          <div>
            <table>
              <tr>
        ...
        <div id="tablerow" class="filterCols col-sm-4 set_filter_margin hide_block">
          <div>
            <table>
              <tr>
        ...
        <div id="flurorow" class="filterCols col-sm-4 set_filter_margin hide_block">
          <div>
      ...
      <div class="advancedOptions hide_block">
        <div>
...
<div>
    <td valign="top"><table id="searchresult" class="set_diamond_table">
          </table></td>
      </div>
	</form>
    ...
    <div class="col-sm-3">
      <div id="vdiamond_detail"> 
        ...
        <div id="sorting_box">
        <div class="quest_icon"><img src="<?php echo config_item('base_url')?>img/page_img/no-info50x50.png" alt="no-info50x50"/></div>
        <div class="rgHead">Hover over and click diamond details to see further details and shipping information.</div>
        </div>
      </div>
      <div class="clear"></div>
      <div id="defaults_button hide_block">
      <div class="quest_icon"><img src="<?php echo config_item('base_url')?>img/page_img/no-info50x50.png" alt="no-info50x50"/></div>
        <div class="rgHead">Hover over and click diamond details to see further details and shipping information.</div>
        <div class="clear"></div>
      </div>
...
window.onload = getRangeClaritSliderView1('sliders', 'claritymin', 'claritymax', 0, 20);
...
<div id="ds_details_tip12" class="set_diamond_dtabs">
  <div id="ds_details_content" class="ds_details_content">
    <div>
        <h5 class="ds_details_header"><b>DIAMOND DETAILS</b></h5>
    ...
    <div class="ds_detail_shipping_container">
      ...
      <div class="set_contact_info"><?php  echo $contacts_info ?></div>
    </div>
  </div>
</div>
