...
$options_list = array('addpendantsetings3stone','tothreestone');
  ...
  <li class="funnel-step"><div class="funnel-step-container">
  ...
  <li class="funnel-step">
    ...
    <div class="detail_bgview">
        <form name="form1" id="form1" method="post" action="<?php echo htmlspecialchars(SITE_URL.'shbasket_wholesale/addtoshoppingcart'); ?>">
        <div class="mainwrap">
            <div class="leftdetail col-sm-4">
                <div class="diamond_shimg"><img src="<?php echo $view_shapeimage; ?>" alt="<?php echo $diamond_shape; ?> Diamond"></div><br>
                ...
                <div class="labdescription">
                  ...
                  This diamond is certified by <?php echo $row_detail['Cert']; ?>. This 
            ...
            <div class="rightdetail col-sm-8 pull-right">
                ...
                <div class="diamond_left_dt">
                    ...
                    <div class="detail_rows">
                        ...
                        <span>$<?php 
                            //echo  _nf( wire_price($row_detail['price']) ); 
                            echo  _nf( $row_detail['price'] ); 
                        ?></span>
                        <div class="clear"></div>
                    </div>
                </div>
...
<?php
    ...
    if( $addoption == 'addtoring' ) {
       ...
       //$buymore_info = '<div><a href="'.$addring_link.'"><img src="'.SITE_URL.'images/select-diamond.jpg"></a></div>'; 
    }
    echo $buymore_info;
?>
      ...
      <input type="hidden" name="vendors_name" value="Rappnet" />
...
?>
    ...
    if( $totalDiamond > 0 ) {
        foreach( $row_sdiamond as $rowdiamond ) {
            ...
            $detail_link = SITE_URL . 'diamondslist/diamond_detail/'.$rowdiamond['lot'].'/'.$addoption.'/'.$settingsid;
            
            $viewSimilarDiamond .= '<tr>
                        <td><img src="'.$view_shapeimage.'" width="21" alt="'.$diamond_shape.'" />'.$diamond_shape.'</td>
...
<!--                <div class="results_count">1 - 6 of 221 Diamonds</div>-->
<!--                <div class="pagination_links">
    ...
    <div class="moredetail_bgblock daviddt_block">
        <div class="mainwrap">
            <div class="aboutdavid_img"><img src="<?php echo IMGSRC_LINK; ?>about_david_dt.jpg" width="100%" alt="About Your <?php echo SITES_NAME; ?>"></div><br><br>
...
Much is made of a diamond's clarity, but of the Four Cs, it is the easiest to understand, and, according to many experts, generally has the least impact on a diamond's appearance. Clarity simply refers to the tiny, natural imperfections that occur in all but the finest diamonds. 
    ...
    <div class="mainwrap">
        ...
        <div class="shiping_detailbk">
            ...
            <br><br>
            <div class="shipheading">Financing</div>
            <div>
                <?php echo check_empty($finance_row['content'], 'Coming Soon'); ?>
            </div>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <form name="askFriendForm" id="askFriendForm" method="post" action="#">
      <div class="p_content">
        ...
        <div class="formArea">
          ...
          <div class="fieldBlock">
            <input type="hidden" name="details_link" id="details_link" value="<?php echo 'diamondslist/diamond_detail/'.$row_detail['Stock_n'].'/false/';?>">
