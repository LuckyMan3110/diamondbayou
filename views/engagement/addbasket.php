...
<div style="margin:0 auto; width:970px;">
    ...
    <div class="bodymid2"> 
        ...
        <div>
            <div class="floatl  padl10" style="color:#fff;">
                <div class="floatl">
                    <img src="<?php echo config_item('base_url') ?>/images/tamal/expand.jpg" id="expand" alt="expand" onclick="showhide('productdetails', 'true')" style="display:none;">
                ...
                <div id="productdetails" style="display:;">
                    ...
                    <table class="popup" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                            ...
                            <?php if (isset($ringdetails['section'])) { ?>
                                <tr>
                                    ...
                                    <td width="120" class="brownback">Dl collection <?php //echo $ringdetails['section']; ?><br /></td>
        ...
        <div>
            <div class="floatl detailcontainers padl10">
                ...
                <div class="floatlmy padl10 margin10">
                    <ul>
        ...
        <div class="floatl padl10">
            <div class="floatl">
                <b>Note: </b>  Prices and availablity are subject to change without notice  View our product policies for more information.  This setting available only with purchase of a diamond.
            </div>
        </div>
        <div class="clear"></div>
