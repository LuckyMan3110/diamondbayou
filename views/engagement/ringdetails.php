	  	...
	  	<div class="bodymid">
			...
			<div class="floatl detailcontainer">
				...
				<div class="floatl mainring">
					<img src="<?php echo config_item('base_url')?>images/rings<?php echo $details['big_image'] ?>" width="188px" height="169px" id="ringbigimage" alt="ringbigimage">
				</div>
  			...
  			<div class="clear"></div>
				...
				<div>
					<div class="floatl detailcontainers padl10">
						<div class="floatl">
						<img src="<?php echo config_item('base_url')?>/images/tamal/expand.jpg" alt="expand" id="expand" onclick="showhide('productdetails', 'true')">
					...
					<div class="floatl detailcontainers padl10">
						...
						<div class="clear"></div>
						<div class="floatl">
							<img src="<?php echo config_item('base_url')?>/images/tamal/expand.jpg" alt="expand" id="expand1" onclick="showdescription('relatives', 'true','view','expand1','minimize1')">
						...
						<div class="clear"></div>
							<div id="view" class="padt10">
								<div class="floatl width75px textcenter">
									<img src="<?php echo config_item('base_url')?>images/ruman/engagement/bala_01.jpg" alt="bala_01">
									<a href="#"><u>View</u></a>
								</div>
								<div class="floatl width75px textcenter">
