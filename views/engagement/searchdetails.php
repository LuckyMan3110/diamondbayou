...
<div class="floatl pad05">
    <div style="width:100%;float:left;text-align:left;margin-bottom:30px;">
	     ...
	     <img src="<?php echo config_item('base_url');?>images/popup/ideal_tab.gif" alt="ideal_tab" style="margin-top:5px;" onclick="show_div('ideal','loupe','hearts','first');" >
	     <img src="<?php echo config_item('base_url');?>images/popup/heart_tab.gif" alt="heart_tab" style="margin-top:5px;" onclick="show_div('hearts','loupe','ideal','first');" >
	</div>
    ...
    <div style="width:100%;float:left;display:block;text-align:left;" id="first">
	  	...
	  	<div class="bodymid_detail">  
				<div class="topdiv">
	  			...
	  			<div style="margin: 0px 0px 0px 54px;">
			  			...
			  			<div class="floatl width285">
						      ...
						      <div class="dbr"></div>
						      <p style="margin-left:30px;"><strong>Price:</strong> $&nbsp;<?php echo $details['price']?> </p>
						      <br /><br />
						       <form method="POST" action="<?php echo config_item('base_url');?>engagement/search/ring/true">   
						       		<table cellpadding="0" cellspacing="0" border="0" width="101%">
						       			<tbody><tr>
							      	      	<td width="130px">	
							      	      		<div id="adddiamond" class="floatl textleft" style="margin-left: 270px;">  
							      	      			<div class="floatl">
							      	      				
							      	      				<div class="floatl"><a href="<?php echo $nexturl;?>" onclick="<?php echo ($nexturl == '#') ? "$('#add_diamond_list').toggle()" : $onclickfunction ;?>">Add this Diamond</a></div>
