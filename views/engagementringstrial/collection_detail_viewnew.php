...
function ringThumbView(th_url) {
    ...
    $('#show_thumb_view').html('<img src="'+th_url+'" onmouseover="show_magnify_affect(\'show_thumb_view\')" alt="show_magnify_affect" />');
    ...
    <div>
        <ul class="bread_crumb_list">
            ...
            <?php 
                ...
                if( empty($newarr) ) {
                    echo ' > <li><a href="'.SITE_URL.'heartdiamond/heart-collection_listing/newarrivals">New Arrivals</a></li>';
                }
                echo $bread_crumb_link; 
            ?>
<!--            <li><a href="<?php echo SITE_URL.'heartdiamond/heart-collection-listing/'.$rowsring['category']; ?>"><?php echo collection_cate_name($rowsring['category']); ?></a></li>-->
        </ul>
    </div>
...
<!--                            <img src="<?php echo SITE_URL; ?>img/heart_diamond/small_image_icon.jpg" alt="" />-->
                    ...
                    <div class="need_help_bk">
                        <div class="need_help_left col-sm-7">
                            ...
                            <div>Your questions or feedback are always welcome at <?= SITES_NAME ?>. Join in a conversation with one of our Diamond and 
...
<!--                        <span>FINISH-LEVEL</span><br>
               ...
               <br><div id="center_diamond_list"></div><br>                   
                    ...
                    <?php
                        if( $stone_count == 1 || $stone_count == 2 || empty($stone_count) ) {
                            echo '<a href="#javascript" onclick="addcartsubmit(\''.$buynow_link.'\')" class="button_link" id="addtoshopping">Buy Now</a>';
                        } else {
            ...
            <div class="selection_tabs_bk hide_block">
            ...
            <div class="detail_ring_bk hide_block" id="diamond_detail_bk">
...
<!--                            <img src="<?php echo SITE_URL; ?>img/heart_diamond/diamond_shape_view.jpg" alt="" />-->
                            <img src="<?php echo $supported_shape; ?>" alt="supported_shape" />
                        </div><br />
                        <div>
                ...
                <div class="clear"></div><br>
                  <div class="other_link_list">
                      <ul>
                          ...
                          <li><a href="http://<?= SITE_URL ?>/account/account_wishlist/89 39/add/rapnet/">Add to Wishlist</a></li>
...
<!--                          <li><a href="#">ASET</a></li>
            ...
            <div class="detail_ring_bk hide_block" id="ring_detail_bk">
                <div class="detail_bk_left">
                    <div class="detail_inner_bk">
...
<br><br>
Poor cut: Diamonds that are generally so deep and narrow or shallow and wide that they lose most of the light out the sides and bottom. <?= SITES_NAME ?> does not carry diamonds with cut grades of poor.</div><br>
            </div>
...
<?= SITES_NAME ?> only sells diamonds with a color grade of J or higher.</div>
            </div>
            <div class="davidstern_cols1 col-sm-6"><br>
...
<br>
At <?= SITES_NAME ?>, you'll find only the finest diamonds with color graded D-J. Diamonds graded J or better are colorless or near-colorless, with color that is typically undetectable to the unaided eye.</div>
            </div>
                <div class="clear"></div><br><br>
    ...
    <div class="moredetail_bgblock daviddt_block">
        <div class="container"><br><br>
            <div class="davidstern_cols col-sm-6">
                ...
                <div>The <?= SITES_NAME ?> Diamond Price Match Guarantee makes it easy to purchase diamonds with peace of mind. If you find a comparable GIA certified diamond at a lower price, call <?php echo CONTACT_NO; ?>. If the offer meets our qualifications, we'll match the price. There is no comparison when it comes to the value and quality of <?= SITES_NAME ?>.</div>
            </div>
            <div class="davidstern_cols1 col-sm-6">
                <div class="davidHeading">DIAMOND HEART UPGRADE PROGRAM</div>
                <div>As part of our jeweler for life commitment, <?= SITES_NAME ?> is pleased to offer a lifetime diamond upgrade program on all GIA and AGSL certified diamonds. Simply call a Diamond & Jewelry Consultant at <?php echo CONTACT_NO; ?> to learn more about our upgrade program and to select your new diamond*.</div>
            </div>
                <div class="clear"></div><br><br>
