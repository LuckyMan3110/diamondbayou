...
$addring_link = config_item('base_url').'engagement/engagement_ring_settings/'.$rowsring['id'].'/addtoring';
...
$ringtitle = get_site_contact_info('dashboard_title').$rowsring['description'];
