  ...
  <div class="breadtopred">
    ...
    <div class="breadcrumbs">
      <ul class="breadcrumb">
        ...
        <li class="category15"> <a href="<?php echo SITE_URL; ?>testengagementrings/engagementrings" title="Diamond Engagement Rings">Diamond Engagement Rings</a> <span>&gt;</span> </li>
        <li class="current"><?php echo $catename_title; ?></li>
      </ul>
    </div>
  </div>
  <div id="content-area">
    <div id="left-area"> 
      ...
      <div class="leftmenu_block">
          <ul>
              <?php
                $solitair_cate = array(103 => 'Cushion',
                    101 => 'Emerald',
                    54 => 'Heart',
                    53 => 'Interchangeable Heads ',
                    98 => 'Marquise',
                    100 => 'Oval',
                    99 => 'Pear',
                    102 => 'Princess',
                ...
                foreach($solitair_cate as $skey => $sname ) {
                    $solitair_link .= '<li><a href="'.SITE_URL.'testengagementrings/engagement_ring_listings/'.$skey.'" title="'.$sname.'">'.$sname.'</a></li>';
                }
                echo $solitair_link;
              ?>              
          </ul>
      ...
      <?php
           ...
           echo '<div id="acordianMenu" class="leftmenu_block">'.accordian_left_menu('styles', $parent_cateid).'</div>';    // function in custome helper
       ?>
        ...
        <ul id="nav_vert1">
          <li class="bgnone">
            ...
            //echo retail_left_menu(); /// custome helper
              echo accordian_left_menu('styles', $catgory_id);    // function in custome helper
...
function checkEmailss() {
	...
	//]]>
      ...
      <div class="social-networking"> <span>Follow Us:</span> <br>
        ...
        <img src="<?php echo DEMO_RETAIL_IMG; ?>facebook.png" width="48" height="48" alt="facebook" title=""> </a> 
    ...
    function aw_fb_login_a(response){
      ...
      <div class="page-title category-title">
        <div class="cat-header">
          <h2 style="width:95%">Preset Diamond Engagement Rings</h2>
...
jQuery(document).ready(function()
{
	...
	{ 
	  ...
	  if( e.which!=8 && e.which!=0 && (e.which<48 || e.which>57))
	  {
        ...
        <!-- <script>topseller('?p=');</script> -->
        <div class="toolbar" style="margin:5px 0 0; display:none">
          <div class="pager">
            <div class="sort-by">
              <label>Sort By</label>
              <select class="sortby" onchange="topseller1(this.value);">
                <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings.aspx?dir=desc&amp;order=popularity" selected="">Most popular</option>
                <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings.aspx?dir=desc&amp;order=created_at">Newest</option>
                <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings.aspx?dir=asc&amp;order=price">Lowest Price</option>
                <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings.aspx?dir=desc&amp;order=price">Highest Price</option>
              </select>
            </div>
            <div class="narrow-search">
              <div class="price-slider-values">
                ...
                <input type="text" name="price_minimum_b" id="price_minimum_b" value="99" maxlength="">
                <span class="filter-currency">&nbsp;-&nbsp;$</span>
                <input type="text" name="price_maximum_b" id="price_maximum_b" value="255950" maxlength="">
                <input type="button" name="btnGo_b" value="" class="narrow-go" onclick="fncSearchItems_b();">
                <input type="hidden" id="price_slider_url_b" name="price_slider_url_b" value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings.aspx">
                <input type="hidden" id="init_price_minimum_b" name="init_price_minimum_b" value="99">
                <input type="hidden" id="init_price_maximum_b" name="init_price_maximum_b" value="255950">
                <input type="hidden" id="step_value_b" name="step_value_b" value="">
              </div>
              <div class="filter-loader">&nbsp;</div>
            </div>
            <div>
              <div class="prev-next"> <span class="prev">« Prev</span>
                <select onchange="topseller1(this.value);">
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-1.aspx" selected="">Page 1 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-2.aspx">Page 2 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-3.aspx">Page 3 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-4.aspx">Page 4 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-5.aspx">Page 5 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-6.aspx">Page 6 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-7.aspx">Page 7 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-8.aspx">Page 8 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-9.aspx">Page 9 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-10.aspx">Page 10 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-11.aspx">Page 11 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-12.aspx">Page 12 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-13.aspx">Page 13 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-14.aspx">Page 14 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-15.aspx">Page 15 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-16.aspx">Page 16 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-17.aspx">Page 17 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-18.aspx">Page 18 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-19.aspx">Page 19 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-20.aspx">Page 20 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-21.aspx">Page 21 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-22.aspx">Page 22 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-23.aspx">Page 23 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-24.aspx">Page 24 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-25.aspx">Page 25 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-26.aspx">Page 26 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-27.aspx">Page 27 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-28.aspx">Page 28 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-29.aspx">Page 29 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-30.aspx">Page 30 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-31.aspx">Page 31 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-32.aspx">Page 32 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-33.aspx">Page 33 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-34.aspx">Page 34 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-35.aspx">Page 35 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-36.aspx">Page 36 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-37.aspx">Page 37 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-38.aspx">Page 38 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-39.aspx">Page 39 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-40.aspx">Page 40 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-41.aspx">Page 41 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-42.aspx">Page 42 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-43.aspx">Page 43 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-44.aspx">Page 44 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-45.aspx">Page 45 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-46.aspx">Page 46 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-47.aspx">Page 47 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-48.aspx">Page 48 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-49.aspx">Page 49 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-50.aspx">Page 50 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-51.aspx">Page 51 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-52.aspx">Page 52 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-53.aspx">Page 53 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-54.aspx">Page 54 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-55.aspx">Page 55 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-56.aspx">Page 56 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-57.aspx">Page 57 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-58.aspx">Page 58 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-59.aspx">Page 59 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-60.aspx">Page 60 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-61.aspx">Page 61 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-62.aspx">Page 62 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-63.aspx">Page 63 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-64.aspx">Page 64 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-65.aspx">Page 65 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-66.aspx">Page 66 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-67.aspx">Page 67 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-68.aspx">Page 68 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-69.aspx">Page 69 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-70.aspx">Page 70 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-71.aspx">Page 71 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-72.aspx">Page 72 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-73.aspx">Page 73 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-74.aspx">Page 74 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-75.aspx">Page 75 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-76.aspx">Page 76 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-77.aspx">Page 77 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-78.aspx">Page 78 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-79.aspx">Page 79 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-80.aspx">Page 80 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-81.aspx">Page 81 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-82.aspx">Page 82 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-83.aspx">Page 83 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-84.aspx">Page 84 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-85.aspx">Page 85 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-86.aspx">Page 86 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-87.aspx">Page 87 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-88.aspx">Page 88 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-89.aspx">Page 89 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-90.aspx">Page 90 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-91.aspx">Page 91 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-92.aspx">Page 92 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-93.aspx">Page 93 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-94.aspx">Page 94 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-95.aspx">Page 95 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-96.aspx">Page 96 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-97.aspx">Page 97 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-98.aspx">Page 98 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-99.aspx">Page 99 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-100.aspx">Page 100 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-101.aspx">Page 101 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-102.aspx">Page 102 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-103.aspx">Page 103 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-104.aspx">Page 104 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-105.aspx">Page 105 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-106.aspx">Page 106 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-107.aspx">Page 107 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-108.aspx">Page 108 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-109.aspx">Page 109 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-110.aspx">Page 110 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-111.aspx">Page 111 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-112.aspx">Page 112 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-113.aspx">Page 113 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-114.aspx">Page 114 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-115.aspx">Page 115 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-116.aspx">Page 116 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-117.aspx">Page 117 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-118.aspx">Page 118 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-119.aspx">Page 119 of 120</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-120.aspx">Page 120 of 120</option>
                </select>
                <span class="next"><a id="bottomNextId" rel="next" href="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-2.aspx">Next »</a></span> </div>
              <div class="limiter">
                <label>View</label>
                <select onchange="setPageLimit(this.value, this);">
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-1.aspx?limit=28" selected="selected">28</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-1.aspx?limit=56">56</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-1.aspx?limit=84">84</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-1.aspx?limit=112">112</option>
                  <option value="<?php echo SITE_URL; ?>diamond-engagement-rings/wholesale-preset-gold-diamond-engagement-rings-1.aspx?limit=140">140</option>
                </select>
              </div>
            </div>
          </div>
