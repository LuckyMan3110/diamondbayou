...
$cuts = isset($rowsring['cut'])?$rowsring['cut']:'';
$colors = isset($rowsring['color'])?$rowsring['color']:'';
$claritys = isset($rowsring['clarity'])?$rowsring['clarity']:'';
$Certs = isset($rowsring['Cert'])?$rowsring['Cert']:'';
$carats = isset($rowsring['carat'])?$rowsring['carat']:'';
$diamond_shaped = isset($diamond_shape)?$diamond_shape:'';
$diamond_desc = 'This fair-cut '.$cuts.', '.$colors.'-color and '.$claritys.'-clarity diamond comes accompanied by a diamond grading report from the '.$Certs.'. <br>Have a question regarding this item? Our specialists are available to assist you.';
$diamondTitle = _nf($carats, 2) . '-Carat ' .$diamond_shaped . ' Diamond';
	...
	if(isset($_GET['carat'])){
		...
		if(empty($rowsring['additional_stones'])){
			...
			if(empty($ch_stone1)){
				...
				$res_qry = $this->db->query($req_sql);
				$get_dev_index_info = $res_qry->result();
				if(isset($get_dev_index_info) && !empty($get_dev_index_info)){
...
if(isset($_GET['carat'])){
	...
	$get_carat_value_d_i_NEW  =  str_replace(' CT.','',$rowsring['stone_weight']) +str_replace(' CT.','', $get_carat_value_d_i);
					...
					<div class="node" style="cursor: pointer;">
						<div class="node-skin">
							...
							<div class="cont">
								...
								<div class="data" data-acsb-clickable="true" data-acsb-navigable="true" tabindex="0" data-acsb-now-navigable="true" role="button"><span class="cyobar_title"><?= $maincate_name; ?></span><span style="padding-left: 4px;">-</span> $<?=_nf($retail_price,0)?></div>
								<div class="action">
				...
				<div class="col-lg-10 col-md-12 ir218-explanation" id="ir309-explanation" data-acsb-main="true" role="main">
					...
					<div class="view-with--shapes ">
						<p class="view-with__title title_shape">
							<span>View with Diamond Shape: </span><?php echo $shape_type;?>
						</p>
					...
					<form name="form1_detail" id="form1_detail" method="post" action="">
						...
						<div class="form-group mb5 ir309-choose-setting">
							<a class="btn btn-lg btn-block btn-success add_cyoring add_button" href="#javascript" rel="nofollow" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping">CHOOSE THIS SETTING</a>
						</div>
					</form>
								...
								<div class="panel">
									...
									if($rowsring['additional_stones'] == ''){
										...
										if(count($supplied_stones) > 1){
											...
											$additional_stones_ex = explode('/', $supplied_stones[0]);
											$additional_stones_first_item   = explode('-', $additional_stones_ex['0']);
											$additional_stones_secound_item = explode('x', isset($additional_stones_ex['1'])?$additional_stones_first_item['1']:'');
											
											if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'R' OR $additional_stones_ex['1'] == 'RD')){
												$shape_type = "Round";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'A' OR $additional_stones_ex['1'] == 'AS')){
												$shape_type = "Asscher";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'EC')){
												$shape_type = "Emerald";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'PR')){
												$shape_type = "Princes";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'H')){
												$shape_type = "Heart";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'c' OR $additional_stones_ex['1'] == 'cu' OR $additional_stones_ex['1'] == 'C' OR $additional_stones_ex['1'] == 'CU')){
												$shape_type = "Cushion";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'ma' OR $additional_stones_ex['1'] == 'MA')){
												$shape_type = "Marquise";
											}else if(isset($additional_stones_ex['1']) && ($additional_stones_ex['1'] == 'pe' OR $additional_stones_ex['1'] == 'PE')){
												$shape_type = "Pear";
											}else{
												$shape_type =$rowsring['supplied_stones'];
											}
										...
										<div class="ir218-collapse-body">
											<div class="break-visible">
												...
												<dl>
													...
													<dd><?php echo $shape_type;?></dd>
												</dl>
												<dl>
													<dt>Side Diamond Carats:</dt>
													<dd><?php echo $rowsring['stone_weight']; ?></dd>
												</dl>
												<dl>
													<dt>Measurement:</dt>
													<dd><?php echo $get_Meas_value; ?></dd>
												</dl>
												<dl>
													<dt>Metal:</dt>
													<dd>
												...
												<dl>
													...
													<dd><?php echo $req_tot;?></dd>
												</dl>
												<dl>
													<dt>Setting Price:</dt>
													<dd>$<?php echo _nf($retail_price, 0); ?></dd>
												</dl>
											</div>
											<div class="fore3">
													...
													<div class="col-sm-12">
														<div class="accent-gemstones">
															<dl>
																...
																<dd><?php echo $rowsring['style_group']; ?></dd>
															</dl>
															<dl>
																<dt class="position-relative">Approx. Weight</dt>
																<dd><?php echo $rowsring['metal_weight']; ?></dd>
															</dl>
															<dl>
															...
															<dl>
																...
																<dd><?php echo $rowsring['supplied_stones']; ?></dd>
															</dl>
															<dl>
