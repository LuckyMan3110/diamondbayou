...
<div class="diamondViewDetail container uniqueRingDetail">
<?php
    ...
    <?php
        ...
        if($row_cate['parent_cid'] == 63 OR $row_cate['parent_cid'] == 69 OR $row_cate['parent_cid'] == 67 OR $row_cate['parent_cid'] == 57 OR $row_cate['parent_cid'] == 71 OR $row_cate['parent_cid'] == 73){
            ...
            if(isset($_GET['carat'])){
                ...
                //echo '<pre>'; print_r($get_dev_index_info); echo '</pre>'; exit();
                $get_uid_find_dia   = $get_dev_index_info['0']->uid;
                $get_diamond_price  = $get_dev_index_info['0']->price;
                $get_diamond_price  = $get_diamond_price * 1.10;
                $get_Meas_value     = $get_dev_index_info['0']->Meas;
...
/*if(isset($_GET['carat'])){
   $diamond_carat_value = _nf( $rowsring['stone_weight'] + $_GET['carat'] , 2);
}else{
   $diamond_carat_value = _nf( $rowsring['stone_weight'] + $get_carat_value_d_i , 2);
}    
    */
...
<style>
    ...
    <div>
        <ul class="bread_crumb_list">
            ...
            <?php
                //echo '<pre>'; print_r($row_cate); 
                echo unique_section_bread_crumb($row_cate); //// ringsection helper
            ?>
        </ul>
    </div>
            ...
            <form name="form1_detail" id="form1_detail" method="post" action="">
                <div class="detail_right col-sm-6">
                    <div class="cut_diamond">
                        ...
                        ?> Color <?php echo $get_color; ?> Clarity <?php 
                               echo $get_clarity;
                                ?> <?php echo $get_cert_no; ?> by <?php echo $get_lab; ?> Diamond Engagement Ring"
                        <span class="sub-text"> in (<?php
                            if(isset($_GET['carat'])){
                                echo $rowsring['stone_weight'] + $_GET['carat'];
                            }else{
                                echo $rowsring['stone_weight'] + $get_carat_value_d_i;
...
<!--                    <div class="learn_about"><a href="#">Learn About Diamond ></a></div>-->
                  ...
                  <div class="learn_about">
                      <!--    <div class="further_dtcols">
                        ...
                        <div class="further_dtcols">
                            ...
                            <span><strike>$ <?php 
                            echo _nf($retail_price+$get_diamond_price, 2); 
                            ?></strike> <span>save <?php echo $saving_percent; ?>%</span></span>
                        </div>    
                        <div class="further_dtcols">
                    ...
                    <div class="prices_label" id="price_label">$<?php echo _nf($rowsring['priceRetail']+$get_diamond_price, 2) ; ?></div><br>
                    ...
                    <div class="further_dtcols metalsection ringsize set_ezpay">
                        ...
                        <select name="ez_payments" class="form-control">
                            <option value="0">Full Price - $<?php echo _nf($rowsring['priceRetail']+$get_diamond_price, 2) ; ?></option>
                            <option value="<?php echo $first_ez_value; ?>"> <?php echo $first_ez_value; ?>ez - $<?php echo ($full_price/$first_ez_value); ?></option>
                            <option value="<?php echo $second_ez_value; ?>"> <?php echo $second_ez_value; ?>ez - $<?php echo ($full_price/$second_ez_value); ?></option>
                        </select> 
                ...
                <div class="metal_list_box">
                    <div class="set_metal_label">Metal &ndash; <b>
                    ...
                    <ul class="set_metals_list">
                        <li>
                            <a href="<?php echo SITE_URL; ?>testengagementrings/engagement_ring_detail/<?php echo $rowsring['ring_id'];?>/1/14KP/">
                                <img src="<?php echo SITE_URL; ?>img/heart_diamond/metal_icons_2.jpg" alt="metal_icons_2" />
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SITE_URL; ?>testengagementrings/engagement_ring_detail/<?php echo $rowsring['ring_id'];?>/1/18KP/">
                                <img src="<?php echo SITE_URL; ?>img/heart_diamond/metal_icons_5.jpg" alt="metal_icons_5" />
                            </a>
                        </li>
                        <li>
                            <a href="<?php echo SITE_URL; ?>testengagementrings/engagement_ring_detail/<?php echo $rowsring['ring_id'];?>/1/PLAT/">
                ...
                <div class="metal_list_box">
                    <ul class="set_diamond_carat">
                        <?php
                            ...
                            $diamond_carat_list = ''; //print_ar($rowsring);
                            
                            //print_ar($diamond_carats); exit();
                            
                            echo $ring_metal_type = $rowsring['matalType'];
                            if($ring_metal_type == ''){
                              ...
                              //  
                                ...
                                for($i=1; $i <= 4; $i++) {
                                    ...
                                    $diamond_carat_list .= '<li class="'.$active_carat.'">
                                                <a href="'.SITE_URL.'testengagementrings/engagement_ring_detail/'.$rowsring['ring_id'].'/1/'.$ring_metal_type.'/?carat='.$carat_number.'">
...
if(isset($_GET['carat'])){ ?>
    ...
    <?php if($rowsring['additional_stones'] == ''){ ?>
        <a href="#javascript" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" class="button_link" id="addtoshopping">Buy Now</a>
    <?php }else{ ?>
