...
<script>
        ...
        $(document).ready(function(){
            ...
            //$( "#show_thumb_view" ).hover(function() {
                //$('#ex1').zoom();
                $('.sp').zoom();
...
$options_list = array('addpendantsetings3stone','tothreestone');
    ...
    <div>
        <ul class="bread_crumb_list">
            ...
            <li><a href="<?php echo SITE_URL; ?>hdering_collections/heart_collection_listing/Ring"><?= SITES_NAME ?> collection</a></li>
            <?php 
                echo $cate_name;
...
//                echo $bread_crumb_link; 
    ...
    <div id="image-viewer-details-and-purchase" class="clearfix">
      ...
      <div class="left-half">
        ...
        <div class="right_arrow_view"><a href="#javascript" onclick="button_next('<?php echo $rowsring['pid'];?>')"><img src="<?php echo SITE_URL; ?>img/heart_diamond/right_arrow_icon.jpg" alt="right_arrow_icon" /></a></div>
                        </div>
        ...
        <section class="title-area">
          ...
          <section id="special-attention-message">
              <div class="countdown-message available-to-sell-messaging active-available-to-sell-message" data-skus=""> <strong><i class="free-shipping-icon"><img src="<?php echo SITE_URL; ?>collection_detail/free_shipping_icon.jpg" alt="free_shipping_icon" /></i> Free FedEx &reg; Shipping</strong><br>
                        ...
                        for($i=1; $i <= 4; $i++) {
                            ...
                            $diamond_carat_list .= '<li class="'.$active_carat.'">
                                        <a href="'.$diamond_carats['diamond_lot'.$i].'">
                                            <img src="'.SITE_URL.'img/heart_diamond/diamond_carat_'.$i.'.jpg" alt="heart_diamond" />
                                        </a>
                                    </li>';
                        }
          ...
          <div class="price-and-purchase"> 
            ...
            <div>
                ...
                <input type="hidden" name="vendors_name" value="<?= SITES_NAME ?> and Diamonds Collection" />
          ...
          <div class="">
            ...
            <div class="contact_right_cols">
              <div class="link-wrapper"> 
                  <div>
                      <a href="#">
                       <i class="set_icon_space"><img src="<?php echo SITE_URL; ?>collection_detail/live_chat_icon.jpg" alt="" /></i><span>Live Chat</span> 
                      </a> 
                  </div>
                  <div>
                      <a href="tel:<?php echo CONTACT_NO; ?>">
                        <i class="set_icon_space"><img src="<?php echo SITE_URL; ?>collection_detail/phone_contact_icon.jpg" alt="" /></i>
                        <span><?php echo CONTACT_NO; ?></span>
                      </a>
                  </div>                   
                  <div>
                      <a href="mailto:<?php echo SITE_EMAIL; ?>">
                        <i class="set_icon_space"><img src="<?php echo SITE_URL; ?>collection_detail/email_contact_icon.jpg" alt="" /></i><span>Email Us</span>
                      </a> 
                  </div>
              </div>
            </div>
