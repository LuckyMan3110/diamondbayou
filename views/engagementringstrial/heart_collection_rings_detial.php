...
<script language="javascript" src="<?php echo SITE_URL; ?>js/common_function.js" type="text/javascript"></script>
    <div class="mainwrap"><br>
        ...
        <ul class="bread_crumb_list">
            ...
            <li><a href="<?php echo SITE_URL; ?>heartdiamond/heart_collection">Heart &amp; Diamond collection</a></li>
        ...
        <form name="askFriendForm" id="askFriendForm" method="post" action="#">
          <div class="p_content">
            ...
            <div class="formArea">
              ...
              <div class="fieldBlock">
              	<input type="hidden" name="details_link" id="details_link" value="<?php echo 'heartdiamond/collection_ring_detail/'.$rowsring['stock_number'];?>">
