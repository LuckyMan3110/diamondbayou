				...
				<div id="id-carousel-thumb" class="jCarouselLiteDemo-body" style="position: relative;" data-shape="Round">
					<div class="position-relative ir309-product-images">
						<div id="thumb-a1" class="top_lg" data-toggle="zoom-all">
							<?php if($rowsring['is_carol'] == 1){ ?>
								<img class="img-responsive" src="<?= SITE_URL .$rowsring['image1'] ?>" style="margin-left: auto; margin-right:auto; margin-bottom:20px;" alt="<?= $ringtitle; ?>">
							<?php }else{ ?>
								<img class="img-responsive" src="<?= $rowsring['image1'] ?>" style="margin-left: auto; margin-right:auto; margin-bottom:20px;" alt="<?= $ringtitle; ?>">
							<?php } ?>
						</div>
					</div>
				</div>
						...
						<div class="jCarouselLite" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; height: 476px;" data-acsb-overflower="true">
							<ul class="clearfix nav" id="product_thumb_images" style="margin: 0px; padding: 0px; position: relative; list-style: none; z-index: 1; height: 476px; top: 0px; display: inherit;">
								...
								if($rowsring['is_carol'] == 1){
									if(file_exists($rowsring['image1'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$rowsring['image1'].'\')"><a data-img="'. SITE_URL .$rowsring['image1'].'" class="ring_imges"><img src="'. SITE_URL .$rowsring['image1'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(file_exists($rowsring['image2'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$rowsring['image2'].'\')"><a data-img="'. SITE_URL .$rowsring['image2'].'" class="ring_imges"><img src="'. SITE_URL .$rowsring['image2'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(file_exists($rowsring['image3'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$rowsring['image3'].'\')"><a data-img="'. SITE_URL .$rowsring['image3'].'" class="ring_imges"><img src="'. SITE_URL .$rowsring['image3'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(file_exists($rowsring['image4'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$rowsring['image4'].'\')"><a data-img="'. SITE_URL .$rowsring['image4'].'" class="ring_imges"><img src="'. SITE_URL .$rowsring['image4'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(file_exists($rowsring['image5'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$rowsring['image5'].'\')"><a data-img="'. SITE_URL .$rowsring['image5'].'" class="ring_imges"><img src="'. SITE_URL .$rowsring['image5'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(file_exists($rowsring['image6'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$rowsring['image6'].'\')"><a data-img="'. SITE_URL .$rowsring['image6'].'" class="ring_imges"><img src="'. SITE_URL .$rowsring['image6'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
								}else{
									if(!empty($rowsring['image1'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''.$rowsring['image1'].'\')"><a data-img="'.$rowsring['image1'].'" class="ring_imges"><img src="'.$rowsring['image1'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(!empty($rowsring['image2'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. $rowsring['image2'].'\')"><a data-img="'. $rowsring['image2'].'" class="ring_imges"><img src="'. $rowsring['image2'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(!empty($rowsring['image3'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. $rowsring['image3'].'\')"><a data-img="'.$rowsring['image3'].'" class="ring_imges"><img src="'.$rowsring['image3'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(!empty($rowsring['image4'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. $rowsring['image4'].'\')"><a data-img="'. $rowsring['image4'].'" class="ring_imges"><img src="'. $rowsring['image4'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(!empty($rowsring['image5'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. $rowsring['image5'].'\')"><a data-img="'.$rowsring['image5'].'" class="ring_imges"><img src="'. $rowsring['image5'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
									if(!empty($rowsring['image6'])){
										echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. $rowsring['image6'].'\')"><a data-img="'. $rowsring['image6'].'" class="ring_imges"><img src="'. $rowsring['image6'].'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
									}
								}
								?>
							</ul>
			...
			<div class="row">
				<div class="col-lg-10 col-md-12 ir218-explanation" id="ir309-explanation" data-acsb-main="true" role="main">
					...
					<p class="normal-statement mb20 mt5 ir309-description" data-acsb-overflower="true">
						<?php echo str_replace("Godstonediamonds","Jewelercart",get_site_contact_info('dashboard_title')).' '.$rowsring['description'].' '.$rowsring['subcategory'].' '.$rowsring['category']; ?>
					</p>
					<p class="mt0">
						<b>SKU:</b> <?php echo $rowsring['item_sku']; ?>
					</p>
					...
					<form name="form1_detail" id="form1_detail" method="post" action="">
						...
						$suport_shape = '';
						if(!empty($rowsring['shape']) && $rowsring['shape'] == "Square"){
							$suport_shape = 'Princess';
						}else{
							$suport_shape = $rowsring['shape'];
						}
                        ?>
