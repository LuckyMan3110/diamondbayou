...
<script type="text/javascript" async="" src="<?php echo DEMO_RETAIL_IMG; ?>Dynamic.aspx"></script><script type="text/javascript" async="" src="<?php echo DEMO_RETAIL_IMG; ?>Static.aspx"></script><script type="text/javascript" async="" src="<?php echo DEMO_RETAIL_IMG; ?>AltSealInfo.aspx"></script><script type="text/javascript" async="" src="<?php echo DEMO_RETAIL_IMG; ?>ii.aspx"></script><script type="text/javascript" async="" src="<?php echo DEMO_RETAIL_IMG; ?>rollover.core.js"></script><script src="<?php echo DEMO_RETAIL_IMG; ?>cb=gapi.loaded_0" async=""></script><script type="text/javascript" async="" src="<?php echo DEMO_RETAIL_IMG; ?>dc.js"></script><script async="" src="<?php echo DEMO_RETAIL_IMG; ?>fbevents.js"></script><script type="text/javascript">
...
<link rel="stylesheet" type="text/css" href="<?php echo DEMO_RETAIL_CSS; ?>style(1).css" media="all">
...
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>jquery.noconflict.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>prototype.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>ccard.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>validation.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>builder.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>effects.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>dragdrop.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>controls.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>slider.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>js1.1.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>form.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>menu.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>translate.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>cookies.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>scriptaculous.js"></script>
<script type="text/javascript" src="<?php echo DEMO_RETAIL_JS; ?>sound.js"></script>
...
jQuery(document).ready(function(){
  ...
  <div id="fb-root" class=" fb_reset">
    <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
      <div>
        <iframe name="fb_xdm_frame_http" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" id="fb_xdm_frame_http" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="<?php echo DEMO_RETAIL_IMG; ?>xd_arbiter.html" style="border: none;"></iframe>
        <iframe name="fb_xdm_frame_https" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" id="fb_xdm_frame_https" aria-hidden="true" title="Facebook Cross Domain Communication Frame" tabindex="-1" src="<?php echo DEMO_RETAIL_IMG; ?>xd_arbiter(1).html" style="border: none;"></iframe>
      </div>
    </div>
    <div style="position: absolute; top: -10000px; height: 0px; width: 0px;">
      <div></div>
  ...
  <div class="product-view quick-view-popup">
    <div class="product-essential-1">
      <form action="#" method="post" id="product_addtocart_form" enctype="multipart/form-data" target="_top">
        ...
        <div class="column3">
          <div class="price-box">
            <p class="old-price fb-old-price f-fix"> <span class="price-label"><strong>Item Code:</strong></span> <span><?php echo $rowsring['item_id']; ?></span> <span class="print_product_details"><a href="<?php echo SITE_URL.'davidsternrings/stern_popup_detail/'.$rowsring['id']; ?>" target="_blank" title="Print this Product" rel="nofollow"><img src="<?php echo DEMO_RETAIL_IMG; ?>print.png" border="0" alt="Print"></a></span> </p>
            <p class="old-price"> <span class="retail-label">Retail Price:</span> <span class="price" id="old-price-<?php echo $rowsring['id']; ?>">$<?php echo _nf($retail_price, 2); ?></span> <span class="pnotify"> <a href="#" id="productupdates-button4" onmouseover=""> <i></i>Get Price Update </a> </span> </p>
            <p class="old-price"> <span class="ourprice-label">Our Price:</span> <span class="new-price" id="product-price-<?php echo $rowsring['id']; ?>">
...
//]]>
 ...
 //alert(color);
 //alert(productId) ;
 jQuery( "#tab1" ).empty().append('<img src="'+BASE_URL+'images/loading-infinite.gif" alit="loading-infinite" style="padding: 214px 81px;">' );	
