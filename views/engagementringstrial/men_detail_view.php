...
<?php $sales_price = $rowsring['product_price_off'];?>
<div class="content">
    ...
    <div class="row">
        ...
        <div class="collection-detail-accordion">
            ...
            <div class="accordion-wrapper standard">
                <div id="accordion-product-details" class="product-details-nav-product-details accordion-item accordion-item-mutually-exclusive accordion-item-default accordion-item-standard accordion-item-medium accordion-item-small _open">
                        ...
                        <div class="tz-gallery-collection">    
							<?php echo '<a class="lightbox" id="light_a" href="'.$rowsring['product_main_img'].'"><img id="light_img" alt="diamonds-img" class="" src="'.$rowsring['product_main_img'].'" style="margin: 0px 0px;width:100%;" /></a><br>';?>
			...
			<?php }?>
			<?php }?>
			<?php if(!empty($rowsring['video_url'])){?>
								<a id="video" href="javascript:void(0);" video-url="<?php echo $rowsring['video_url'];?>">
								<img src="<?php echo base_url().'collection_images/video-btn.png';?>" style="width:55px;height:55px;">
								</a>
							<?php }?>
                        </div>        
                    ...
                    <div class="accordion-drawer" id="product-details">
                        <div class="product-detail">
                            ...
                            <?php if( !empty($rowsring['product_details']) ){ ?>
                             <h3>Description</h3>
                             <?php echo $rowsring['product_details']; ?>
                            <?php } ?>
                                    ...
                                    <div id="setting-information-table">
                                      <div class="detail-table">
                                        <div class="row detail even first">
                                          <div data-unique-id="stock-number-column-0" class="column-0 "> <span> Sku </span> </div>
                                          <div data-unique-id="stock-number-column-1" class="column-1 "> <span> <?php echo $rowsring['product_sku']; ?> </span> </div>
                                        </div>
                                        <?php if($rowsring['product_category'] != ''){ ?>
                                        <div class="row detail">
                                          <div data-unique-id="stock-number-column-0" class="column-0 "> <span> Category </span> </div>
                                          <div data-unique-id="stock-number-column-1" class="column-1 "> <span> <?php echo $rowsring['product_category']; ?> </span> </div>
                                        </div>
                                        <?php } ?>
                                        
                                       <?php if($rowsring['gold_color'] != ''){ 
											$get_m_colors = explode('||',$rowsring['gold_color']);
										?>
                                        <div class="row detail">
                                          <div data-unique-id="stock-number-column-0" class="column-0 "> <span> Metal Color </span> </div>
                                          <div data-unique-id="stock-number-column-1" class="column-1 ">
											<?php if(!empty($get_m_colors)){?>
												<span> 
													<select class="form-control" id="g_color1">
														<option value="">Select Gold Color</option>
														<?php foreach($get_m_colors as $get_m_color1){
																if(!empty($get_m_color1)){?>
																	<option value="<?php echo $get_m_color1;?>"><?php echo $get_m_color1;?></option>
														<?php 
																}
														}?>
													</select>
											...
											<?php }else{?>
												<span> 
													<select class="form-control" id="g_color1">
														<option value="">Select Gold Color</option>
														<option value="<?php echo $rowsring['gold_color'];?>"><?php echo $rowsring['gold_color'];?></option>
													</select>
												</span>
											<?php }?>
											</div>
                                        ...
                                        <?php } ?>
                                         <?php if($rowsring['item_chart'] != ''){ 
                                            $rs_strins = explode('<td class="data">',$rowsring['item_chart']);
                                            $rs_strins_lab = explode('<th class="label">',$rowsring['item_chart']);
                                             if(!empty($rs_strins)){
                                                 $i1 = 0;
