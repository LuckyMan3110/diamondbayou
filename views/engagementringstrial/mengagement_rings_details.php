...
function commentsThisPost() {
 ...
 function setListingPage(option_value) {
  ...
  function addfinancesubmit(pr_price,pr_id,pr_name){
  	var urlink = base_url+'/testmengagementrings/getfinancecall';
    ...
    <div class="mainwrap"><br>
        ...
        <div class="uper_detail_block">
           ...
           <div class="leftbtn_block">
                ...
                <div class="imaglogo"><a href="javascript:void(0);" id="addfinancing" onclick="addfinancesubmit('<?php echo $rowsring['priceRetail']; ?>','<?php echo $rowsring['ring_id']; ?>','<?php echo $rowsring['style_group']; ?>');" ><img src="<?php echo SITE_URL; ?>demo_retail/images/logo-getfinancing.png" width="250"></a></div>
            </div>
           </div>
