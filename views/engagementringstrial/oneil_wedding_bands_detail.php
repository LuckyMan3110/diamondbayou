...
<div class="container container1260 container-cyo">
	<ol class="breadcrumb ir218-breadcrumb" role="navigation" data-acsb-bc="true" aria-label="Breadcrumbs">
		<li><a href="<?= SITE_URL ?>diamonds/engagement-rings" class="google-event-tracker"><span>Wedding Bands</span></a></li>
		<li class="active"><?= substr($ringtitle,0,32); ?></li>
	</ol>
</div>
					...
					<div class="node" style="cursor: pointer;">
						<div class="node-skin">
							...
							<div class="cont">
								...
								<div class="data" data-acsb-clickable="true" data-acsb-navigable="true" tabindex="0" data-acsb-now-navigable="true" role="button"><span class="cyobar_title"><?= substr($ringtitle,0,32); ?></span><span style="padding-left: 4px;">-</span> <span id="top_price">$<?=_nf($sales_price,0)?></span></div>
								<div class="action">
									<a href="<?= SITE_URL ?>diamonds/wedding-bands/oneil" class="td-u bar-action" data-acsb-clickable="true" data-acsb-navigable="true" data-acsb-now-navigable="true">Change</a>
								</div>
							</div>
				...
				<div id="id-carousel-thumb" class="jCarouselLiteDemo-body" style="position: relative;" data-shape="Round">
					<div class="position-relative ir309-product-images">
						<div id="thumb-a1" class="top_lg" data-toggle="zoom-all">
							<img class="img-responsive" src="<?= SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image1']) ?>" style="margin-left: auto; margin-right:auto; margin-bottom:20px;" alt="<?= $ringtitle; ?>">
						</div>
					</div>
				</div>
					...
					<div class="carousel nonCircular" data-acsb-overflower="true">
						...
						<div class="jCarouselLite" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; height: 476px;" data-acsb-overflower="true">
							<ul class="clearfix nav" id="product_thumb_images" style="margin: 0px; padding: 0px; position: relative; list-style: none; z-index: 1; height: 476px; top: 0px; display: inherit;">
								<?php
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image1']))){
									echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image1']).'\')"><a data-img="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image1']).'" class="ring_imges"><img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image1']).'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image2']))){
									echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image2']).'\')"><a data-img="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image2']).'" class="ring_imges"><img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image2']).'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image3']))){
									echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image3']).'\')"><a data-img="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image3']).'" class="ring_imges"><img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image3']).'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image4']))){
									echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image4']).'\')"><a data-img="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image4']).'" class="ring_imges"><img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image4']).'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image5']))){
									echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image5']).'\')"><a data-img="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image5']).'" class="ring_imges"><img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image5']).'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image6']))){
									echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image6']).'\')"><a data-img="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image6']).'" class="ring_imges"><img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image6']).'" width="64" height="64" alt="'.$rowsring['stock_real_number'].'"></a></li>';
								}
								?>
							</ul>
						</div>
				...
				<div class="col-lg-10 col-md-12 ir218-explanation" id="ir309-explanation" data-acsb-main="true" role="main">
					...
					<div class="view-with--caratSize" id="collapse-preview-diamond">
						<p class="view-with__title title_slider_carat" id="image_text_var">
							<span class="carat-text">View with Carat Size: </span><?= isset($rowsring['carat_weight'])?$rowsring['carat_weight']:''; ?>
						</p>
					</div>
					...
					<p class="mt0 setting-only-price">
						$<?=_nf($sales_price,0)?><small>(Setting Only)</small>
					</p>
					...
					<div class="variation-filters">
						<div class="col-md-12">
							<label class="col-md-6">VARIATION</label>
							<select id="variation" name="variation" class="col-md-6" onchange="variationProduct(this.value);">
						...
						<div class="col-md-12">
							<label class="col-md-6">METAL TYPE</label>
							<select id="metal_type" name="metal_type" class="col-md-6" onchange="metalTypeProduct(this.value);">
						...
						<div class="col-md-12">
							<label class="col-md-6">METAL COLOR</label>
							<select id="metal_color" name="metal_color" class="col-md-6" onchange="metalColorProduct(this.value);">
						...
						<div class="col-md-12">
							<label class="col-md-6">FINISH LEVEL</label>
							<select id="finish_level" name="finish_level" class="col-md-6" onchange="finishLevelProduct(this.value);">
						...
						<div class="col-md-12">
							<label class="col-md-6">DIAMOND QUALITY</label>
							<select id="diamond_quality" name="diamond_quality" class="col-md-6" onchange="diamondQualityProduct(this.value);">
					...
					<form name="form1_detail" id="form1_detail" method="post" action="">
						...
						<input type="hidden" name="txt_ringsize" value="<?php if(isset($_GET['ring_size'])){ echo $_GET['ring_size']; }else{ isset($set_ring_size)?$set_ring_size:''; }?>" />
						...
						if( $stone_count == 1 || $stone_count == 2 || empty($stone_count) ) {
							echo '<a class="btn btn-lg btn-block btn-success add_cyoring add_button" href="#javascript" rel="nofollow" onclick="addcartsubmit(\''.$buynow_link.'\')" id="addtoshopping">ADD TO SHOPPING BAG</a>';
						} else {
							echo '<a class="btn btn-lg btn-block btn-success add_cyoring add_button">Please Call ' . CONTACT_NO . ' for pricing</a>';
						}
						?>
						</div>
					</form>
									...
									<div class="collapse" id="JS-Diamond-details" style="height: 0px;">
										<div class="ir218-collapse-body">
											<div class="break-visible">
												...
												<dl>
													<dt>Stock Number:</dt>
													<dd><?php $nms = explode("#",$rowsring['name']); echo $nms[0]; ?></dd>
												</dl>
												<?php if($rowsring['category_type'] != ''){ ?>
													<dl>
														<dt>Category Type </dt>
														<dd> <?php echo $rowsring['category_type']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['shape'] != ''){ ?>
													<dl>
														<dt>Shape </dt>
														<dd> <?php $rowsring['shape']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['style'] != ''){ ?>
													<dl>
														<dt>Style </dt>
														<dd> <?php echo $rowsring['style']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['carat_weight'] != ''){ ?>
													<dl>
														<dt>Carat </dt>
														<dd> <?php echo $rowsring['carat_weight']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['metal'] != ''){ ?>
													<dl>
														<dt>Metal </dt>
														<dd> <?php echo $rowsring['metal']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['category'] != ''){ ?>
													<dl>
														<dt>Category </dt>
														<dd> <?php echo $rowsring['category']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['productSKU'] != ''){ ?>
													<dl>
														<dt>Product SKU </dt>
														<dd> <?php echo $rowsring['productSKU']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['metal_type'] != ''){ ?>
													<dl>
														<dt>Metal Type </dt>
														<dd> <?php echo $rowsring['metal_type']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['metal_color'] != ''){ ?>
													<dl>
														<dt>Metal Color </dt>
														<dd> <?php echo $rowsring['metal_color']; ?></dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['ring_size'] != ''){ ?>
													<dl>
														<dt>Size </dt>
														<dd> <?php echo $rowsring['ring_size']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['width'] != ''){ ?>
													<dl>
														<dt>Width </dt>
														<dd> <?php echo $rowsring['width']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['chain_type'] != ''){ ?>
													<dl>
														<dt>Chain Type </dt>
														<dd> <?php echo $rowsring['chain_type']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['clasp_type'] != ''){ ?>
													<dl>
														<dt>Clasp Type </dt>
														<dd> <?php echo $rowsring['clasp_type']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['RhodiumPolish'] != ''){ ?>
													<dl>
														<dt>Polish </dt>
														<dd> <?php echo $rowsring['RhodiumPolish']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['clarity'] != ''){ ?>
													<dl>
														<dt>Clarity </dt>
														<dd> <?php echo $rowsring['clarity']; ?> </dd>
													</dl>
												<?php } ?>
												<?php if($rowsring['setting_type'] != ''){ ?>
													<dl>
														<dt>Setting Type </dt>
														<dd> <?php echo $rowsring['setting_type']; ?> </dd>
													</dl>
												<?php } ?>
											...
											<div class="break-visible">
												<dl>
													...
													<dd><?php echo $rowsring['description']; ?></dd>
												</dl>
												<?php $nms = explode("/",$rowsring['RhodiumPolish']); ?>
												<dl>
													<dt>APPROXIMATE POLISHED DWT: <?php echo !empty($nms[0])?$nms[0]:'14KT'; ?></dt>
													<dd><?php echo !empty($nms[1])?$nms[1]:''; ?></dd>
												</dl>
												<dl>
													<dt>STONE BREAKDOWN:</dt>
													<dd>
														...
														<?php $parts = explode(") (",$rowsring['head_dimensions']);?>
														<p style="margin:5px;" class="diamond_provide_textheanding">
														<?= isset($parts[0])?str_replace("("," ",$parts[0]):''; ?>
														</p>
														<p style="margin: 5px;" class="diamond_provide_textheanding">
														<?= isset($parts[1])?str_replace("("," ",$parts[1]):''; ?>
														</p>
														<p style="margin:5px;" class="diamond_provide_textheanding">
														<?= isset($parts[2])?str_replace("("," ",$parts[2]):''; ?>
														</p>
													</dd>
												</dl>
												<dl>
													<dt>TOTAL WEIGHT OF DIAMONDS:</dt>
													<dd><?= isset($rowsring['carat_weight'])?$rowsring['carat_weight']:''; ?> <?= isset($rowsring['stone_shape'])?$rowsring['stone_shape']:''; ?></dd>
												</dl>
											</div>
											<div class="">
			...
			<div class="indented-slickbox col-md-12" id="customer-reviews-slidebox">
				...
				<div class="position-relative mb-30 ir309-review-slicks">
					<div class="cr-leading">
						...
						<div class="ir218-snippet-stars ir298-snippet-stars" data-acsb-possible-star="true"> <span class="ir218-stars" style="background-position:left -200.0px;" aria-hidden="true" data-acsb-hidden="true" data-acsb-force-hidden="true"></dd>
						</div>
