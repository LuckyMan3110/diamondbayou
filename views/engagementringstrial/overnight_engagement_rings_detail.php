...
$ringtitle = strtoupper(get_site_contact_info('dashboard_title')).$rowsring['description'];
$itemNumbers = isset($rowsring['item_number'])?$rowsring['item_number']:'';
$categorys = isset($rowsring['category'])?$rowsring['category']:'';
$sub_categorys = isset($rowsring['sub_category'])?$rowsring['sub_category']:'';
$metals = isset($rowsring['metal'])?$rowsring['metal']:'';
$colors = isset($rowsring['color'])?$rowsring['color']:'';
$finishd = isset($rowsring['finish'])?$rowsring['finish']:'';
$diamondQuality = isset($rowsring['diamond_quality'])?$rowsring['diamond_quality']:'';
?>
...
<div class="container container1260 container-cyo">
	<ol class="breadcrumb ir218-breadcrumb" role="navigation" data-acsb-bc="true" aria-label="Breadcrumbs">
		<li><a href="<?= SITE_URL ?>diamonds/engagement-rings" class="google-event-tracker"><span>Engagement Rings</span></a></li>
					...
					<div class="node" style="cursor: pointer;">
						<div class="node-skin">
							...
							<div class="cont">
								...
								<div class="data" data-acsb-clickable="true" data-acsb-navigable="true" tabindex="0" data-acsb-now-navigable="true" role="button"><span class="cyobar_title"><?= substr($ringtitle,0,32); ?></span><span style="padding-left: 4px;">-</span> <span id="top_price">$<?=_nf($our_price,0)?></span></div>
								<div class="action">
									<a href="<?= SITE_URL ?>diamonds/engagement-rings" class="td-u bar-action" data-acsb-clickable="true" data-acsb-navigable="true" data-acsb-now-navigable="true">Change</a>
								</div>
							</div>
										...
										foreach($gallery_imgs as $gallery_img1){
											if (strpos($gallery_img1, '.jpg') !== false) {
												if(file_exists($image_path.str_replace("THUMBNAIL/","",$gallery_img1))){
													echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. SITE_URL .$image_path.str_replace("THUMBNAIL/","",$gallery_img1) .'\')"><a data-img="'. SITE_URL .$image_path.str_replace("THUMBNAIL/","",$gallery_img1) .'" class="ring_imges"><img src="'. SITE_URL .$image_path.str_replace("THUMBNAIL/","",$gallery_img1) .'" width="64" height="64" alt="'.$rowsring['description'].'"></a></li>';
												}
											}
										}
									}
				...
				<div class="col-lg-10 col-md-12 ir218-explanation" id="ir309-explanation" data-acsb-main="true" role="main">
					...
					<div class="view-with--caratSize" id="collapse-preview-diamond">
						<p class="view-with__title title_slider_carat" id="image_text_var">
							<span class="carat-text">View with Carat Size: </span><?php echo $rowsring['diamond_weight'];?>
						</p>
					</div>
					...
					<p class="mt0 setting-only-price">
						$<?=_nf($our_price,0)?><small>(Setting Only)</small>
					</p>
					...
					function sort_item(){
						...
						$.ajax({
							...
							success:function(res){
								...
								if(res.price !="0"){
									$('.setting-only-price').html('$'+res.price+'<small>(Setting Only)</small>');
									var wirePrice1 =  parseFloat(res.price)*'0.03';
									var wirePrice =  parseFloat(res.price)-parseFloat(wirePrice1);
									$('#wire_price').text('$'+wirePrice);
					...
					<div class="variation-filters">
					    <div class="col-md-12">
							...
							<select id="variation" name="variation" class="col-md-6" onchange="variationProduct(this.value);">
								<?php echo $optionVariation = getVariants('variation',preg_replace('/\s+/', '', $itemNumbers),$categorys,$sub_categorys); ?>
							</select>
						</div>
						<div class="clear"></div><br>
						<div class="col-md-12">
							<label class="col-md-6">RING SIZE</label>
							<select id="ring_size" name="ring_size" class="col-md-6" onchange="ringsizeProduct(this.value);">
						...
						<div class="col-md-12">
							...
							<select id="metal_type" name="metal_type" class="col-md-6" onchange="metalTypeProduct(this.value);">
								<?php echo $optionMetaltype = getMetalVariants('metal_type',preg_replace('/\s+/', '', $itemNumbers),$categorys,$sub_categorys,$metals); ?>
							</select>
						</div>
						<div class="clear"></div><br>
						<script>
						...
						<div class="col-md-12">
							...
							<select id="metal_color" name="metal_color" class="col-md-6" onchange="metalColorProduct(this.value);">
								<?php echo $optionMetalcolor = getMetalCVariants('metal_color',preg_replace('/\s+/', '', $itemNumbers),$categorys,$sub_categorys,$colors); ?>
							</select>
						</div>
						<div class="clear"></div><br>
						<script>
						...
						<div class="col-md-12">
							...
							<select id="finish_level" name="finish_level" class="col-md-6" onchange="finishLevelProduct(this.value);">
								<?php echo $optionFinishlevel = getFinishVariants('finish_level',preg_replace('/\s+/', '', $itemNumbers),$categorys,$sub_categorys,$finishd); ?>
							</select>
						</div>
						<div class="clear"></div><br>
						<script>
						...
						<div class="col-md-12">
							...
							<select id="diamond_quality" name="diamond_quality" class="col-md-6" onchange="diamondQualityProduct(this.value);">
								<?php echo $optionDiamondquality = getDQualityVariants('diamond_quality',preg_replace('/\s+/', '', $itemNumbers),$categorys,$sub_categorys,$diamondQuality); ?>
							</select>
						</div>
					</div>
									...
									<div class="collapse" id="JS-Diamond-details" style="height: 0px;">
										<div class="ir218-collapse-body">
											<div class="break-visible">
												...
												<dl>
													<dt>APPROXIMATE POLISHED DWT:</dt>
													<dd><?= isset($rowsring['metal_weights'])?$rowsring['metal_weights']:''; ?></dd>
												</dl>
												<dl>
												...
												<dl>
													...
													<dd><?php echo $rowsring['diamond_weight'];?>  <?php echo $rowsring['stone_shape']; ?></dd>
												</dl>
											</div>
											<div class="">
