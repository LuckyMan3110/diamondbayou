    ...
    <div class="mainwrap container"><br>
        <div>
            <ul class="bread_crumb_list">
                ...
                <li><a href="<?php echo SITE_URL; ?>"><?php echo get_site_contact_info('dashboard_title'); ?> Collections</a></li> >
                <?php echo $bread_crumb_link; ?>
            </ul>
        </div>
        <div class="back_link"> < Browse <?php echo get_site_contact_info('dashboard_title'); ?> and Diamond Collection</div><br><br>
        <div class="uper_detail_block">
            ...
            <div class="uperdt_right col-sm-5">
               <div class="uperHeading">The <?php echo get_site_contact_info('dashboard_title'); ?> and Diamond Collection</div>
               ...
               <div class="further_dtcols">
                <span>ITEM CODE</span>
                <span><?php echo $rowsring['style']; ?></span>
            </div>    
            <div class="further_dtcols">
                <span>Metal</span>
            ...
            <div class="further_dtcols">
                ...
                <span><?php echo $rowsring['average_weight']; ?></span>
            </div>
               ...
               <hr class="horizontal_line" />
            <?php if( strpos($ringtitle, 'Ring') !== false ) {  // $quality_cate_name
                    ?>
            ...
            <?php } ?>
               ...
               <div class="clear"></div><br><br>
                ...
                <div class="leftbtn_block">
                    <div class=""><a href="#javascript" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping"><img src="<?php echo config_item('base_url') ?>images/buy-now.jpg" alt="Buy Now"/></a><br /></div>
                </div>
                ...
                <?php
                    ...
                    if( !empty($rowsring['item_length']) && $rowsring['item_length'] != 'null' ) {
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['item_length'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
...
//                    }
                    if( !empty($rowsring['product_type']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['product_type'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
                    if( !empty($rowsring['jewelry_type']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['jewelry_type'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
                    if( !empty($rowsring['material_primary']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['material_primary'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
                    if( !empty($rowsring['material_primary_color']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            <span>Primary Material Color</span>
                                            <span>'.$rowsring['material_primary_color'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
                    if( !empty($rowsring['material_purity']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['material_purity'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
                    if( !empty($rowsring['length_of_item']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            <span>Length of Item</span>
                                            <span>'.$rowsring['length_of_item'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
