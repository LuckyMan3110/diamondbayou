...
<script language="javascript" src="<?php echo SITE_URL; ?>js/common_function.js" type="text/javascript"></script>
    <div class="mainwrap container"><br>
        <div class="back_link"> < Browse The <?php echo SITES_NAME; ?></div><br><br>
        <div class="uper_detail_block">
            ...
            <div class="uperdt_right col-sm-6 pull-right">
               <div class="uperHeading">The <?php echo SITES_NAME; ?></div>
               ...
               <div class="further_dtcols">
                <span>ITEM CODE</span>
                <span><?php echo $rowsring['item_id']; ?></span>
            </div>    
            <div class="further_dtcols">
                <span>Metal</span>
           ...
           ?>
            ...
            <?php } ?>
               ...
               <div class="detail_botom_text">
                   ...
                   <span>
                       <select name="finish_level" id="finish_level" onchange="finishLevelPrices()">
                           <?php echo $finished_level; ?>
                       </select>
                   </span>
                   <span id="loding_finish" style="display:none;"><img width="33px" height="33px" src="<?php echo IMGSRC_LINK; ?>loading_pleasewait.gif" alt="loading_pleasewait"></span>
                   <span>Qty</span>
               ...
               <div class="clear"></div><br><br>
                ...
                <input type="hidden" name="prodname" value="<?php echo $rowsring['categories_name']; ?>">
...
<!--                <input type="hidden" name="txt_metal" value="" />-->
                <input type="hidden" name="txt_addoption" value="sterncolectionjewelry" />
                <input type="hidden" name="unique_pagelink" value="<?php echo $quality_link; ?>" />
                <input type="hidden" name="vendors_name" value="Stern Collection Ring Jewelry" />
               <!--  <div class="leftbtn_block">
                    <div><a href="#javascript" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping"><img src="<?php echo config_item('base_url') ?>images/buy-now.jpg" /></a><br /></div>
            <div class="imaglogo"><img src="<?php echo SITE_URL; ?>demo_retail/images/logo-getfinancing.png" width="250"></div>
                </div>   -->   

<div class="leftbtn_block">
                       <div class=""><a href="#javascript" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping">
            <img src="<?php echo config_item('base_url') ?>images/buy-now.jpg" alt="buy-now"/></a><br /></div> 
<div class="imaglogo">
<a href="javascript:void(0);" id="addfinancing" onclick="addfinancesubmit('<?php echo $ringtitle; ?>','<?php echo $buynow_link; ?>');" >
<img src="<?php echo SITE_URL; ?>demo_retail/images/logo-getfinancing.png" width="250" alt="logo-getfinancing">
</a>
</div>
</div>
...
<script>
    ...
    //// print page
                ...
                <?php
                    ...
                    if( !empty($rowsring['stone_breakdown']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['stone_breakdown'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
                    if( !empty($rowsring['diamond_quality']) ) { 
                        $itemInformation .= '<div class="item_rows">
                                            ...
                                            <span>'.$rowsring['diamond_quality'].'</span>
                                            <div class="clear"></div>
                                        </div>';
                    }
            ...
            <div class="popular_rings">
                    <div class="pprings_heading">Popular <?php echo $rowsring['categories_name']; ?> <a href="#">See More</a></div><br>
            ...
            <div class="clear"></div>
            <div class="popular_rings">
                    <div class="pprings_heading">More <?php echo $rowsring['categories_name']; ?> <a href="#">See More</a></div><br>
        ...
        <form name="askFriendForm" id="askFriendForm" method="post" action="#">
          <div class="p_content">
            ...
            <div class="formArea">
              ...
              <div class="fieldBlock">
              	<input type="hidden" name="details_link" id="details_link" value="<?php echo 'davidsternrings/jewelry_ring_detail/'.$rowsring['id'];?>">
