...
$(".slideUpbox").click(function () {
  ...
  <div class="breadtopred">
    ...
    <div class="breadcrumbs">
      <ul class="breadcrumb">
        <li class="home"> <a href="<?php echo SITE_URL; ?>" title="<?php echo SITES_NAME; ?>">Home</a> <span>&gt;</span> </li>
        <?php echo $cate_name['category_link']; ?>
      </ul>
    </div>
  </div>
  <div id="content-area">
     ...
     window.location = option_value;
      ...
      <div class="page-title category-title">
        <div class="cat-header">
          <h2 style="width:95%"><?php echo $cate_name['category_name']; ?></h2>
...
<!--              <div class="price-sort-by">
                  <div class="pricebk_left">Price ($):</div>
                  <div class="pricebk_right">
                      <b>Min.</b><input size="5" type="text" id="prmin" value="99">
                      <b>Max.</b><input size="5" type="text" id="prmax" value="255950">
                  </div>
                  <div class="clear"></div>
              </div>-->
            </div>
            <div>
              <div class="price-sort-by1">
                ...
                <select name="metal_color" onchange="setListingPage(this.value)">
                    <?php echo $metal_colors; ?>
                </select>
            </div>
              </div>
            </div>
...
<!-- END: buySAFE Seal --> 
<input type="hidden" name="liting_class" id="liting_class" value="davidsternrings" />