  ...
  <div class="product-view quick-view-popup">
    <div class="product-essential-1">
      <form action="#" method="post" id="product_addtocart_form" enctype="multipart/form-data" target="_top">
        ...
        <div class="column3">
          <div class="price-box">
            <p class="old-price fb-old-price f-fix"> <span class="price-label"><strong>Item Code:</strong></span> <span><?php echo $rowsring['Sku']; ?></span> <span class="print_product_details"><a href="<?php echo SITE_URL.'qualitygoldrings/quality_ring_detail/'.$rowsring['stuller_id']; ?>" target="_blank" title="Print this Product" rel="nofollow"><img src="<?php echo DEMO_RETAIL_IMG; ?>print.png" border="0" alt="Print"></a></span> </p>
...
//]]>
 ...
 //alert(color);
 //alert(productId) ;
 jQuery( "#tab1" ).empty().append('<img src="'+BASE_URL+'images/loading-infinite.gif" alt="infinite" style="padding: 214px 81px;">' );	
