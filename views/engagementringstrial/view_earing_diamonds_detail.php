...
<link rel="stylesheet" href="<?php echo SITE_URL; ?>css/wh_styles.css" />
<link rel="stylesheet" href="<?php echo SITE_URL; ?>css/heart_diamond.css" />
<link rel="stylesheet" href="<?php echo SITE_URL; ?>css/home_style.css" />
<script>
///// tabs section
...
<div id="diamond_dtails">
    ...
    <div class="pric_bk"><span><?php echo $bothdm_price; ?></span>&nbsp;&nbsp; <a href="#javascript" onclick="selectThisDiamond('<?php echo $row_detail['lot']; ?>', '<?php echo $diamond_price; ?>')"><img src="<?php echo SITE_URL?>img/david_home/diamond_search/add_center_stone.jpg" alt="Add This Diamond" /></a> </div>
...
<div id="summ_bk" class="summr_bk"> <span class="summr_label">Summary</span> <span class="summr_links"> <a href=""><img src="<?php echo SITE_URL; ?>img/icons/mail_ic.jpg" alt="Send Email" /></a> <a href=""><img src="<?php echo SITE_URL; ?>img/icons/print_ic.jpg" alt="Print Form" /></a> </span>
  <div class="clear"></div>
</div>
...
<div class=""> <a href="<?php echo $moredt_link; ?>"><img src="<?php echo $view_shapeimage ?>" alt="<?php echo $diamond_shape ?>" width="215" /></a><br>
	<!--<img src="<?php echo SITE_URL; ?>img/icons/dmview_icon.jpg" alt="Diamond Shape" />-->
