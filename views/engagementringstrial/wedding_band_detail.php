...
$ringtitle = !empty($rowsring['description'])?get_site_contact_info('dashboard_title').$rowsring['description']:get_site_contact_info('dashboard_title').$rowsring['name'];
...
<div class="container container1260 container-cyo">
	<ol class="breadcrumb ir218-breadcrumb" role="navigation" data-acsb-bc="true" aria-label="Breadcrumbs">
		<li><a href="<?= SITE_URL ?>diamonds/engagement-rings" class="google-event-tracker"><span>Wedding Band</span></a></li>
					...
					<div class="node" style="cursor: pointer;">
						<div class="node-skin">
							...
							<div class="cont">
								...
								<div class="data" data-acsb-clickable="true" data-acsb-navigable="true" tabindex="0" data-acsb-now-navigable="true" role="button"><span class="cyobar_title"><?= substr($ringtitle,0,32); ?></span><span style="padding-left: 4px;">-</span> $<?=_nf($our_price,0)?></div>
								<div class="action">
							...
							<div class="pho" data-acsb-clickable="true" data-acsb-navigable="true" tabindex="0" data-acsb-now-navigable="true" role="button" data-acsb-textual-ops="scroll">
								<span class="acsb-sr-only" data-acsb-sr-only="true" data-acsb-force-visible="true" aria-label=" Scroll Page " aria-hidden="false" data-acsb-hidden="false"></span><span class="modal-product-superposition">
									<img alt="top setting" src="<?php echo str_replace("xlarge","standard",$ringimg); ?>" class="img-responsive cyobar_diamond_img mbm-multiply">
								</span>
							</div>
						</div>
					</div>
...
<div class="container container1260 container-cyo">
	<div class="row be-detail-v2 pb-xs-30 ir309-detail ir218-detail">
		...
		#product_thumb_images{overflow:scroll;scrollbar-width:none;-ms-overflow-style:none}
		#product_thumb_images::-webkit-scrollbar{width:0px}
		#product_thumb_images::-webkit-scrollbar-track{box-shadow:inset 0 0 0px grey;border-radius:0px}
		#product_thumb_images::-webkit-scrollbar-thumb{background:#8e1010;border-radius:0px}
		#product_thumb_images::-webkit-scrollbar-thumb:hover{background:#b30000}
		#product_thumb_images::-webkit-scrollbar{width:0px}
		#product_thumb_images::-webkit-scrollbar{display:none}
		</style>
				...
				<div id="id-carousel-thumb" class="jCarouselLiteDemo-body" style="position: relative;" data-shape="Round">
					<div class="position-relative ir309-product-images">
						<div id="thumb-a1" class="top_lg" data-toggle="zoom-all">
							<img class="img-responsive" src="<?php echo str_replace("xlarge","standard",$ringimg); ?>" style="margin-left: auto; margin-right:auto; margin-bottom:20px;" alt="<?= $ringtitle; ?>">
						</div>
					</div>
				</div>
					...
					<div class="carousel nonCircular" data-acsb-overflower="true">
						...
						<div class="jCarouselLite" style="visibility: visible; overflow: hidden; position: relative; z-index: 2; left: 0px; height: 476px;" data-acsb-overflower="true">
							<ul class="clearfix nav" id="product_thumb_images" style="margin: 0px; padding: 0px; position: relative; list-style: none; z-index: 1; height: 476px; top: 0px; display: inherit;">
								<?php
								$gallery_imged = explode(";",$rowsring['image']);
								if(!empty($gallery_imged)){
									foreach($gallery_imged as $gallery_img1){
										if($gallery_img1 != ''){
											if($gallery_img1 != ''){
												$gallery_img1 = str_replace("xlarge","standard",$gallery_img1);
												echo '<li style="overflow: hidden; float: none; width: 58px; height: 58px;" onclick="chang_img(\''. $gallery_img1 .'\')" onmouseover="chang_img(\''. $gallery_img1 .'\')"><a data-img="'. $gallery_img1 .'" class="ring_imges"><img src="'. $gallery_img1 .'" width="64" height="64" alt="'.$rowsring['description'].'"></a></li>';
											}
										}
									}
								}
			...
			<div class="row">
				<div class="col-lg-10 col-md-12 ir218-explanation" id="ir309-explanation" data-acsb-main="true" role="main">
					...
					<p class="normal-statement mb20 mt5 ir309-description" data-acsb-overflower="true">
						<?php echo $rowsring['descriptionNdetails']; ?>
					</p>
					<p class="mt0">
						<b>SKU:</b> <?php echo $rowsring['item_number']; ?>
					</p>
					...
					<?php
					$ringsape = '';
					if(!empty($rowsring['stone_shape']) && $rowsring['stone_shape'] == "Square"){
						$ringsape = 'Princess';
					}else{
						$ringsape = $rowsring['stone_shape'];
					}
					?>
					<form name="form1_detail" id="form1_detail" method="post" action="">
						<input type="hidden" name="txt_rstyle" id="txt_rstyle" value="<?= !empty($rowsring['stone_shape'])?$rowsring['stone_shape']:''; ?>">
						...
						<input type="hidden" name="ring_shape" value="<?= $ringsape; ?>">
						<input type="hidden" name="ring_carat" value="<?php echo $rowsring['side_carats_temp']?>">
						<input type="hidden" name="prid" id="prid" value="<?php echo $rowsring['id'];?>">
						<input type="hidden" name="stock_number" id="stock_number" value="<?php echo $rowsring['item_number'];?>">
						...
						<input type="hidden" name="txt_ringsize" value="<?php echo $rowsring['ring_size'];?>" />
						...
						<input type="hidden" name="table_name" value="dev_engagement_rings" />
						...
						<input type="hidden" name="product_type" value="Wedding bands" />
						...
						<div class="form-group mb5 ir309-choose-setting">
							<a class="btn btn-lg btn-block btn-success add_cyoring add_button" href="#javascript" rel="nofollow" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping">ADD TO SHOPPING BAG</a>
						</div>
					</form>
									...
									<div class="collapse" id="JS-Diamond-details" style="height: 0px;">
										<div class="ir218-collapse-body">
											<div class="break-visible">
												...
												<dl>
													<dt>Carat Weight:</dt>
													<dd><?php echo $rowsring['side_stone_weight'];?></dd>
												</dl>
												<dl>
												...
												<dl>
													...
													<dd><?php echo $rowsring['diamond_weight'];?></dd>
												</dl>
												<dl>
													<dt>Center Stone Dimension:</dt>
													<dd><?php echo $rowsring['ring_size'];?></dd>
												</dl>
												<dl>
													<dt>Crown Type:</dt>
													<dd>Non-Changeable</dd>
												</dl>
												<dl>
													<dt>Side Stone Quality:</dt>
													<dd><?php echo $rowsring['diamond_quality'];?></dd>
												</dl>
												<dl>
													<dt>Metal Type:</dt>
												...
												<dl>
													<dt>Band Price:</dt>
													<dd>$<?php echo _nf($priceRetail, 0); ?></dd>
												</dl>
												<dl>
													<dt>Band Carat Weight:</dt>
													<dd><?php echo $rowsring['side_stone_weight'];?></dd>
												</dl>
											</div>
											<div class="">
