...
<div  class="pad10">
   ...
   <h1 style="color:#FFFFFF;" class="hr pageheader">Product Details ( Price : $<?php echo $products['SalePriceProduct']?>) </h1>
   

   <div class="pad10">
     <h3 class="newtileheader"><? echo($products["Name"]) ?><?php //echo isset($details['collection']) ? $details['collection'] : '';?></h3><br />
	        ...
	        <table class="popup"  width="100%"> 
             <tr >
	        	<td colspan="2" width="100%" >
                 ...
                 <img src="<? echo(config_item('base_url').'images/leaderimages/'.$products['ProductID'].".jpg"); ?>" alt="content_img5" width="400px" />
		        ...
		        <td colspan="2" align="right"><br> 
		        										<div>
															<div class="floatr w100px">
																	...
																	<div class="floatr bluemiddle"><a  onclick=" addtocart('addtoproduct',<?php echo $products['ProductID']?>,false,false,5124,<?php echo $products['SalePriceProduct']?>,4)" href="#">add to basket</a></div>
  ...
  <div  class="pad10">
   ...
   <div class="pad10">
     <h3  class="newtileheader"> Regina D Collection<?php //echo isset($details['collection']) ? $details['collection'] : '';?></h3><br />
      <table>
	        <tr>
		         <td valign="top">
