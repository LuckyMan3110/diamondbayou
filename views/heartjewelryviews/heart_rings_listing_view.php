...
function ringsThumbView(th_url, id1, id2) {
	...
	$('a#'+id1).html('<img src="'+th_url+'" alt="th_url" width="175" height="159" onmousemove="jscMagnify(this,event)" onmouseout="jscMagnifyHide()" alt="" />');
        
        $('ul#' + id1 + ' li#' + id2 + ' a img').attr("src", base_url + 'img/heart_diamond/active_dot_cicle.jpg');
}

</script>
<div class="container heart_ring_listings">
    <br>
    <div>
    ...
    <div class="ring_listing_row">
     ...
     ?>
        ...
        <div class="bottom_content">
            <div class="content_head">About Princess Diamond Engagement Rings</div>
