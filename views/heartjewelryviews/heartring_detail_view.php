...
function ringThumbView(th_url) {
	...
	$('#ringsthumb_view').html('<img src="'+th_url+'" width="400" onmousemove="jscMagnify(this,event)" onmouseout="jscMagnifyHide()" alt="" />')
}
    ...
    <div class="mainwrap"><br>
        <div>
            <ul class="bread_crumb_list">
                ...
                <li><a href="<?php echo SITE_URL; ?>heartjewelrylistings/heart_collection">Heart and Diamond Collections</a></li> >
                <?php echo $cate_links; ?>
            </ul>
        </div>
...
<!--                <input type="hidden" name="txt_metal" value="" />-->
                ...
                <div class="leftbtn_block">
                    <div><a href="#javascript" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping"><img src="<?php echo config_item('base_url') ?>images/buy-now.jpg" alt="buy-now"/></a><br /></div>
                </div>            
    ...
    //// print page
            ...
            <div class="tabsdata">
                <div id="product_details">
                    <div class="details_tab_left col-sm-6">
                       <?php                       
                            echo $item_desc;
                       ?>
                    </div>
