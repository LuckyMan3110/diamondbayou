                 ...
                 <div class="content">
                 	 <div class="view-left">
                     	<div class="img-description">
                     		<div id="bigPic">
                                <img src="<?php echo $this->config->item('base_url');?>images/prod01.jpg" alt="" />
                        ...
                        <div class="text-description">
                        	<h4 class="title-description">Diamond Engagement Ring 3/8 ct tw Round-cut 10K White Gold </h4>
                            <p class="date-description">Stock number: 940231311</p>
                            ...
                            <div class="payment">
                                ...
                                <p style="margin-top: -25px;"><a href="#">I have a Kay Credit  Account</a>|<a href="#">Apply for Kay Credit </a></p>
                            </div>
