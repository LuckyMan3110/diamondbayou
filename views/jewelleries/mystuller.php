...
<tr><td style="color:#FFFFFF"><strong>Cyjewelers American Collection</strong></td></tr>
...
</tr></table></td><td align="right"><table>
...
?>
<tr><td colspan="4"><a href="<?php echo config_item('base_url') ?>jewelleries/getmystullerfur/<?php echo $journalName; ?>/"><?php 
...
<div class="jtitle" style="color:White"><?php echo $records['result'][$i]['Description'];?></div>
         <div class="panel-1">
            <!--   <a href="javascript:;" onclick="showdetail(<?php //echo $records['result'][$i]['stock_number']; ?>)" class="" style="width: 325px;">-->
			 <?php
if(trim($records['result'][$i]['Videos'])!=""){
