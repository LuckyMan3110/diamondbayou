...
<p><?php if(isset($status)) echo $status?></p>
  ...
  <form id="form4" name="form4" method="post" action="<?php echo config_item('base_url') ?>admin/ezpay">
    <label for="ez3">3EZ : </label><input type="text" name="ez3" width="20px" value="<?php echo $ez3value ?>">
	<label for="ez5">5EZ : </label><input type="text" name="ez5" width="20px" value="<?php echo $ez5value ?>">
    <input type="submit" name="submit" id="submit" value="Submit" />
  </form>
  <p>&nbsp;</p>
</div>
