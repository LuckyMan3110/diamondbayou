...
<div class="col-md-3">
<img src="<? echo config_item('base_url') ?>images/img-bracelets1.png" class="img-responsive" alt="" />
</div>
<div class="col-md-8">
<h2>Bracelet</h2>
<p>Make a style statement with a bangle, cuff, tennis, bead, charm or I.D. bracelet. With designs ranging from simple to spectacular you'll find precious metal, diamond and gemstone looks for both him and her.</p>
<button class="btn btn-lg btn-default btn-design">BROWSE Bracelets</button>
</div>
</div>
...
<div class="row">
  ...
  <div class="col-md-12">
    ...
    <a href="<?php echo config_item('base_url') ?>jewelleries/getstullerfur/<?php echo $journalName; ?>/<?php echo $this->uri->segment(3);?>/"><img src="<?php echo config_item('base_url') ?>images/Bracelet-view/<?php echo $thumbimg ?>" alt="" width="110" height="110"/></a>
    ...
    <?php } ?>
     ...
     <div class="col-md-3">	
								...
								?>
    <a href="<?php echo config_item('base_url') ?>jewelleries/getmystullerfurwithsub/<?php echo $journalName; ?>/<?php echo $this->uri->segment(3);?>/"><img src="<?php echo config_item('base_url') ?>images/Bracelet-view/<?php echo $thumbimg ?>" alt="" width="110" height="110"/></a>
