...
<tr style="color:#FFFFFF">
	<td colspan="4"><a href="<?php echo config_item('base_url') ?>jewelleries/getstuller/WeddingBands/">Wedding Bands</a></td>
...
<div class="jtitle" style="color:White"><?php echo $records['result'][$i]['Description'];?></div>
         <div class="panel-1">
		  ...
		  <div class="jprice" style="color:White">$ <?php echo $records['result'][$i]['Price'];?></div>
