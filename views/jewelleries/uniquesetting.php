...
?>
<div class="panels-1">
<div class="jtitle"><?php echo $records['result'][$i]['name'];?></div>
         <div class="panel-1">
			 ...
			 ?>
                 <img src="<?php echo $src;?>" alt="<?php echo $records['result'][$i]['name'];?>" class="first" style="height:210px;width:325px;">
              </a>
          </div>
		  <div class="jprice">$ 200</div>
		  <div class="jdetail"><a href="javascript:;">View Detail</a></div>
    </div>
<?php
}
}
