...
?>
      ...
      <div class="engagement">
        ...
        <div class="dmPendantSection threstonBuild"> 
          ...
          <!--<img src="<?php echo $image180;?>" alt="Build Your Own Three-Stone Ring">-->
          ...
          <div class="pendant_detail">
          	<div>
                The total diamond carat weight of your earrings is <?php echo $row_detail['carat']; ?>.<br><br>
                
               <div><?php echo $diam_desc; ?>
               <div class="clear"></div>
                Stock #: <?php echo $row_detail['Stock_n']; ?> </div><br>
                ...
                <div><span class="green_text"><?php echo $rowdt_ring['description']; ?></span><span class="price_sectionbk">$<?php echo _nf($ring_mtprice); ?></span>
                <div class="clear"></div> 
                Stock #: <?php echo $rowdt_ring['stock_number']; ?> </div><br>
            </div>
                	<div class="subtotal_price">Subtotal : <span>$<?php echo _nf( floatval($total_ringprice) );?></span></div><br><br>
                    
                    <div class="descBox"><a href="<?php echo SITE_URL.'account/account_wishlist/'.$setting_id;?>" class="btnLinkStyle">Add To Wishlist</a></div>
            ...
            <div class="tabs_heading">Shipping Information</div>
             ...
             <div id="vtabsBlock" class="tabBox"><br><br><br>
                 <div class="tabs_row">Need it Faster?</div>
                  <div class="tabs_row"> Do you need this <span class="green_text1"><?php echo get_site_title(); ?></span> Item before Saturday, February 28 and <br><a href="#">Click Here</a> to send a special request of this item and than <br>call <?php echo get_site_title('contact_info'); ?>.
