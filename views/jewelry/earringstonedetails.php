	  	...
	  	<div class="bodymid">
		  			...
		  			<div class="column floatl">
			  				...
			  				<div class="floatl">
			  	      				...
			  	      				<div class="floatl bluemiddle"><a href="<?php echo config_item('base_url')?>jewelry/earringdetailsview/<?php echo $addoption;?>/<?php echo $settingsid;?>/<?php echo $sidestone1['lot'];?>/<?=$sidestone2['lot']?>">select this pair</a></div>
