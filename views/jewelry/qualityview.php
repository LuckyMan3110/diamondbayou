        	...
        	<div id="containt">
                 ...
                 <div class="content">
                 	<div class="engagement-left">
                        ...
                        <ul class="carat">
                        	<li><strong>Metal</strong></li><?php echo $metallink ?>
                        </ul>
                        </form>
                    ...
                    <div class="engagement-right">
                        ...
                        <div class="engagement-product">
                            ...
                            <div class="image-engagement"><a href="#"><img src="<?php echo $src;?>" alt="<?php echo $records['result'][$i]['result'][$i]['Metal_Desc'];?>" width="155" hight="144"></a></div>  
                            <div class="price-product">
                            	<p class="ring-engagement"><?php echo $cataname?> - <?php echo $records['result'][$i]['qg_id']; ?></p>
                                <span>Price : <?php echo number_format($records['result'][$i]['MSRP'],2);?></span><br>
								<?php if($records['result'][$i]['ezstatus'] == true){ ?>
                                3EZ : <?php $ez3 = $records['result'][$i]['MSRP']+(($ez3value*$records['result'][$i]['MSRP'])/100); echo number_format($ez3,2); ?><br>
                                5EZ : <?php $ez5 =  $records['result'][$i]['MSRP']+(($ez5value*$records['result'][$i]['MSRP'])/100); echo number_format($ez5,2); ?><br><?php } ?>
