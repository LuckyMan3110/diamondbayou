...
function ringThumbView(th_url) {
	...
	$('#ringsthumb').html('<img src="'+th_url+'" width="300" onmousemove="jscMagnify(this,event)" onmouseout="jscMagnifyHide()" alt="url" />')
}
...
<div id="" class="row-fluid ringsDetail">
  ...
  <div class="col-sm-9">
	...
	$ringDescription = get_site_title().' stunning '.$details['parent_cate'].' '.$sbparent_style.' Style '.$details['category_name'].' diamond ';
	...
	{
		$addtoRingBtn = '';	
		/*$uniqueRingsDesc = get_site_title().' stunning '.$details['parent_cate'].' '.$sbparent_style.' Style '.$details['category_name'].' diamond ring can be yours for <span id="viewDyPrice">$'.$netRingPrice.'</span>.';*/
	...
	$image_url = $details['ImageLink_500'];
    ?>
      <form id="form1" name="form1" method="post" action="">
            ...
            <div class="whHead"> <span class="dwar-icon"></span> <?php echo $details['Description']; ?> </div>
              ...
              <div class="textList">
                ...
                <span><?php echo $details['Item']; ?></span> </div>
              <div class="textList">
                <label>Product Status:&nbsp;&nbsp;</label>
                <span><?php echo $details['Status']; ?></span> </div>
<!--              <div class="textList">
                <?php
                if($netRingPrice > 0) {
...
<!--                <div class="textList">
                ...
                <div class="textList"> <br />
                  ...
                  <div> <a href="#javascript" onclick="addcartsubmit('<?php echo $buynow_link; ?>')" id="addtoshopping"><img src="<?php echo config_item('base_url') ?>images/buy-now.jpg" /></a><br />
                    ...
                    <input type="hidden" name="vendors_name" value="Quality Gold Jewelry" />
                  </div>
                  <div class="clear"></div>
                  <br />
              ...
              <br>
                ...
                <div class="col-sm-2">
                   <div class="linkBlock">
                            ...
                            <div class="textList"> <a href="<?php echo SITE_URL.'account/account_wishlist/'.$ring_id.'/add/qualityrings/'.get_var('quality'); ?>"><span class="addic"></span>&nbsp;&nbsp;Add To wish List</a> </div>
                          </div> 
                </div>
              </div>
                ...
                <div class="list-wrap">
                  <div id="featured2">
                    ...
                    <div class="col-sm-6">
                      ...
                      <div class="tabsRow">
                        <div class="metaLeft">Item: <span class="sizeBlock"><?php echo $details['Item']; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="metaLeft">Item Type: <span class="sizeBlock"><?php echo $details['Item_Type']; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="metaLeft">Status: <span class="sizeBlock"><?php echo $details['Status']; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="metaLeft">Weight: <span class="sizeBlock"><?php echo $details['Weight']; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="metaLeft">CT Weight: <span class="sizeBlock"><?php echo $details['CT_Weight']; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="metaLeft">Metal Description: <span class="sizeBlock"><?php echo $details['Metal_Desc']; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="metaLeft">Metal Price: <span class="sizeBlock"><?php echo $details['Metal_Price']; ?></span> </div>
                      </div>
                      <?php
                      $viewSettings = '';
                    if( !empty($details['ProductLine']) ) {
                      $viewSettings .= '<div class="tabsRow">
                        <div class="metaLeft">Product Line: <span class="sizeBlock">'.$details['ProductLine'].'</span> </div>
                      </div>';
                    }
                      ...
                      ?>
                       <?php echo $viewSupliedStone; ?>
                      <div class="tabsRow">
                        <div class="metaLeft">Diamond Shapes: <span class="sizeBlock"><?php echo $suport_shape; ?></span> </div>
                      </div>
                      <div class="tabsRow">
                        <div class="ctdm_shapes"><?php echo $view_ctshape; ?></div>
                      </div>
                      <!--<div class="tabsRow">
