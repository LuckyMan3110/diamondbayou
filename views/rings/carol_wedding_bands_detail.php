...
<div class="content">
	<div>
		<ul class="bread_crumb_list">
			...
			<li><a href="<?php echo SITE_URL; ?>diamonds/fine-jewelry"><?php echo $rowsring['category']; ?></a></li>
		</ul>
	</div>
	<div class="row">
                        ...
                        <div class="tz-gallery-collection">
							...
							if($rowsring['is_carol'] == 1){
								...
								if(file_exists(''.$rowsring['image2'].'')){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .''.$rowsring['image2'].'\')"> <img src="'. SITE_URL .''.$rowsring['image2'].'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(''.$rowsring['image3'].'')){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .''.$rowsring['image3'].'\')"> <img src="'. SITE_URL .''.$rowsring['image3'].'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(''.$rowsring['image4'].'')){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .''.$rowsring['image4'].'\')"> <img src="'. SITE_URL .''.$rowsring['image4'].'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(''.$rowsring['image5'].'')){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .''.$rowsring['image5'].'\')"> <img src="'. SITE_URL .''.$rowsring['image5'].'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(''.$rowsring['image6'].'')){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .''.$rowsring['image6'].'\')"> <img src="'. SITE_URL .''.$rowsring['image6'].'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								...
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image2']))){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image2']).'\')"> <img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image2']).'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image3']))){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image3']).'\')"> <img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image3']).'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image4']))){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image4']).'\')"> <img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image4']).'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image5']))){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image5']).'\')"> <img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image5']).'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
								if(file_exists(str_replace("THUMBNAIL/","",$rowsring['image6']))){
									$make_html	.= '<a href="javascript:void(0);" onclick="ch_imgs1(\''. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image6']).'\')"> <img src="'. SITE_URL .str_replace("THUMBNAIL/","",$rowsring['image6']).'" style="width:55px;height:55px;display: inherit;" alt="'.$rowsring['stock_real_number'].'" /></a>';
								}
							}else{
        ...
        <div class="collection-purchase-column">
            <div id="card-details-and-purchase" class="clearfix">
                  ...
                  <div class="small-only title-area">
                    ...
                    <div class="title-area"> 
                      <div class="product-title medium-and-large-only">
                       ...
                       <div class="price-with-button force-wrap" data-smart-wrap="true">
                            <div class="price-display">
                                ...
                                <!--<span style="display:none;" class="price-message" style="text-transform: uppercase;">( <span id="show_real_price_msg" style="color:#F52237;"><?php echo $cate_name; ?> Price </span> )</span> -->
                            </div>
                        </div>
                      ...
                      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
                       ...
                       <div class="further_dtcols metalsection ringsize">
                        ...
                        //echo $rowsring['category'].'<br>'; // 740520259
                        //echo $rowsring['subcategory']; //740520261
                    ...
                    <?php
                       $comment_text = str_replace('|',' ',$rowsring['comment']);
                    ?>
