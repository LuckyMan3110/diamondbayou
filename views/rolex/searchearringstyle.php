			...
			<div class="commonheader">1. Select Diamond Shape</div>
	   		<div>
			   		<div class="floatl smallbox txtcenter">
			   				<label for="B"><img src="<?php echo config_item('base_url');?>images/tamal/jewelry/sel_shape_r.jpg" alt="platinum_01"></label> <br>
			   		...
			   		<div class="floatl smallbox txtcenter">
			   				<label for="PR"><img src="<?php echo config_item('base_url');?>images/tamal/jewelry/sel_shape_p.jpg" alt="platinum_01"></label> <br>
			   		...
			   		<div class="floatl smallbox txtcenter">
			   				<label for="E"><img src="<?php echo config_item('base_url');?>images/tamal/jewelry/sel_shape_as.jpg" alt="platinum_01"></label> <br>
