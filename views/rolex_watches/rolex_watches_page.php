...
<div class="main_container">
    ...
    <div class="main_content">
        <div class="main_left col-sm-3">
            ...
            <div class="left_content_area">
                <div class="left_content_list">
                    <ul>
                        <li><a href="<?php echo SITE_URL; ?>rolexrings/rolex_listing_view/">Rolex Watches</a></li>
                        <?php echo $rolex_categories; ?>
                    </ul>
                </div>
            </div>
        ...
        <div class="main_right col-sm-9">
            <div class="left_box_heading">Rolex Watches</div>
            <div class="sort_by_bk">
                <div>
                    Sort By:
                    <select name="cmb_sort">
                ...
                <div>
                    <ul class="list_box_icon">
                        <li><a href="<?php echo SITE_URL; ?>rolexrings/rolex_listing_view/0/10">10</a></li>
                        <li><a href="<?php echo SITE_URL; ?>rolexrings/rolex_listing_view/0/20">20</a></li>
                        <li><a href="<?php echo SITE_URL; ?>rolexrings/rolex_listing_view/0/30">30</a></li>
                    </ul>
                </div>
            </div>
            <div class="clear"></div>
            <div class="rolex_page_content">
...
<!-- END: buySAFE Seal --> 
<input type="hidden" name="liting_class" id="liting_class" value="rolexrings" />
