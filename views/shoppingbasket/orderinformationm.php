...
<?php $this->load->helper('form');  ?>
  ...
  <div class="bread-crumb">
    ...
    <div>
      ...
      <?php echo form_open(config_item('base_url').'shoppingbasketm/orderinformation')?>
      <div>
            ...
            <br><br>
          	...
          	<div class="order_summbk">
				...
				foreach ($mycartitems as $myCartIndex => $item){
					...
					$item_name = ($itemName1 == 'ZKORDIAMONDS' ? 'Yadegar Diamonds' : $item['name']);
				...
				case 'addtoring':
					...
					//$itemPriceQty = ( ( floatval($dprice)*$item['quantity'] ) + $ringset_price );
							...
							$addtoringview .= '<div class="imgleft_cols col-sm-2">
							                <img src="'.$setting_imgurl.'" alt="Ring" />
				...
				case 'toearring':
					...
					$pendant_imgurl = config_item('base_url').$setttings['small_image'];
						...
						$tosolitairview .= '<div class="imgleft_cols col-sm-2">
                    						<img src="'.$pendant_imgurl.'" alt="Ring" />
                    						<div class="viewDt"><a href="'.$item['item_url'].'">View Detail</a></div>
                    						</div>
										<div class="detail_rightbk col-sm-10">
											<div class="checkout_cols">
		...
		case 'addjewelry':
					...
					$adjewelryView .= '<div class="row-fluid">';
						$adjewelryView .= '<div class="imgleft_cols col-sm-2"><img src="'.$imgUrljw.'" alt="'.$lotdm_shape.'" /></div>
											<div class="detail_rightbk col-sm-10">
												<div class="checkout_cols">
											<div class="shiping_row">
												<span>'.$itemName.'</span>
