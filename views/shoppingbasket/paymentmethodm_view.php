...
function toggle_option(){
	console.log('toogle_option called');
...
function addfinancesubmit(){
	...
	$(".get_finance_checkbox").each(function(){
            if ($(this).prop('checked')==true){ 
                ...
                var price    = $(this).attr('data-1') ;
                var name     = $(this).attr('data-2') ;
		var product_name = $(this).attr('data-3') ;
		product_name = product_name.replace(/ /g, "_");
		finance_data += name+'#PRICE#'+price+'#PRICE#'+product_name+',';
	    }
  ...
  <form id="breadCrumbForm" name="breadCrumbForm" action="<?php echo SITE_URL; ?>shoppingbasket/orderinformation" method="post">
    ...
    <div class="">
      ...
      <div class="pad10">
	    ...
	    <div id="finance_show" class="hide"><div class="imaglogo"><a href="javascript:void(0);" id="addfinancing" onclick="addfinancesubmit();" ><img src="<?php echo SITE_URL; ?>demo_retail/images/logo-getfinancing.png" width="250"></a></div></div>
            </div>
            <br><br>
					...
					$total_ringpr = $stone1_price + $stone2_price + $seting_price;
							...
							$toearingview .= '<div class="imgleft_cols col-sm-2"><img src="'.$vimage_urlink.'" width="112" alt="Ring" /></div>
										...
										<div class="shiping_row">
												...
												<span><input type="checkbox" name="get_finance_checkbox" class="get_finance_checkbox" data-1="'.$item['totalprice'].'" data-2="'.$item_price.'" ></span>
											</div>
										</div>
											</div>
											<div class="clear"></div><br>
		...
		case 'addjewelry':
					...
					$wirePrice = wire_price($jewelryTotalPrice);
							...
							$adjewelryView .= '<div class="imgleft_cols col-sm-2"><img src="'.$item['image_url'].'" width="112" alt="'.$lotdm_shape.'" /></div>
											<div class="detail_rightbk col-sm-10">
												<div class="checkout_cols">
											<div class="shiping_row">
												<span>'.$itemName.'</span>
		...
		case 'addunique':
					...
					$unRingPrice = $item['price'] * $item['quantity'];
							...
							$addUniqueView .= '<div class="imgleft_cols col-sm-2"><img src="'.$item['image_url'].'" width="112" alt="'.$lotdm_shape.'" /><div style="font-size:12px;background-color:rey;padding-top:20px;" class="shiping_row finance_row hide">
												...
												<span><input type="checkbox" name="get_finance_checkbox" '.$checked_finance.' class="get_finance_checkbox" data-1="'.$item['totalprice'].'" data-2="'.$item_name.'" data-3="'.$itemName.'"></span></center>
											</div></div>
											<div class="detail_rightbk col-sm-10">
												<div class="checkout_cols">
											<div class="shiping_row">
