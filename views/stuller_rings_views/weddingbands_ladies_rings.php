    ...
    <div id="containerContent">
      <div id="containerContent_Inner">
        <ul id="viewingbar">
          ...
          <li class="lastNaviItem"> <span>Ladies Wedding Bands</span> </li>
        </ul>
        <div id="main">
          <div class="row">
            <div id="navContent" class="navContent col-md-12">
              <div>
                <div id="content">
                 <!-- <h1 class="pull-left set_top_margin"> Ladies Bands </h1>-->
                  <div id="catalog">
                    <div>
                        ...
                        <div id="top-filtering-area" class="filterTable form-horizontal clear">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="price_orderby" name="price_orderby" onchange="set_dropdown_link(this.value)">
                                  <option value="<?php echo SITE_URL; ?>store/wedding_bands_ladies">All</option>
                                  <option value="<?php echo SITE_URL; ?>store/wedding_bands_ladies?sort_value=ASC&field=price" <?php if( isset($_GET['sort_value']) AND $_GET['sort_value'] == 'ASC' AND $_GET['field'] == 'price'){ echo 'selected'; } ?> >Price: Low to High</option>
                                  <option value="<?php echo SITE_URL; ?>store/wedding_bands_ladies/?sort_value=DESC&field=price" <?php if( isset($_GET['sort_value']) AND $_GET['sort_value'] == 'DESC' AND $_GET['field'] == 'price'){ echo 'selected'; } ?>>Price: High to Low</option>
                                </select>
                            </div>   
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="sortby" name="sortby" onchange="set_dropdown_link(this.value)">
                                  <option value="<?php echo SITE_URL; ?>store/wedding_bands_ladies">All</option>
                                  <option value="<?php echo SITE_URL; ?>store/wedding_bands_ladies?sort_value=DESC&field=id" <?php if( isset($_GET['sort_value']) AND $_GET['sort_value'] == 'DESC' AND $_GET['field'] == 'id'){ echo 'selected'; } ?>>Newest</option>
                                  <option value="<?php echo SITE_URL; ?>store/wedding_bands_ladies/?sort_value=ASC&field=id" <?php if( isset($_GET['sort_value']) AND $_GET['sort_value'] == 'ASC' AND $_GET['field'] == 'id'){ echo 'selected'; } ?>>Oldest</option>
                                </select>
                            </div> 
                          ...
                          <div id="pageSizeSection" class="floatRight">
                            ...
                            <div class="floatRight rightMargin10 hidden-xs" class="set_line_font">|</div>
